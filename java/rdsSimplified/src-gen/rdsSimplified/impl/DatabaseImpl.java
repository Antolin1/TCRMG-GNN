 ...
 * </p>
 * <ul>
 *   <li>{@link rdsSimplified.impl.DatabaseImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DatabaseImpl extends MinimalEObjectImpl.Container implements Database {
	...
	protected EClass eStaticClass() {
		return RdsSimplifiedPackage.Literals.DATABASE;
	}
	...
	public EList<Element> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<Element>(Element.class, this,
					RdsSimplifiedPackage.DATABASE__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case RdsSimplifiedPackage.DATABASE__ELEMENTS:
