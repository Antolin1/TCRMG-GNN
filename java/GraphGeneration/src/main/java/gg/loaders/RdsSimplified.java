...
public class RdsSimplified {
	private static ResourceSet rds = null;
	...
	public static ResourceSet initRDS() {
		if (rds != null) {
			return rds;
		}
		
		ResourceSet rs = new ResourceSetImpl();
		readResource(rs, "/models/rdsSimplified.ecore");

		return rs;
	}

	private static Resource readResource(ResourceSet rs, String name) {
		URL url = RdsSimplified.class.getResource(name);
		if (url == null)
