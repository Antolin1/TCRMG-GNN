 ...
 * </p>
 * <ul>
 *   <li>{@link yakinduSimplified.impl.VertexImpl#getIncomingTransitions <em>Incoming Transitions</em>}</li>
 *   <li>{@link yakinduSimplified.impl.VertexImpl#getOutgoingTransitions <em>Outgoing Transitions</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class VertexImpl extends MinimalEObjectImpl.Container implements Vertex {
	...
	protected EClass eStaticClass() {
		return YakinduSimplifiedPackage.Literals.VERTEX;
	}
	...
	public EList<Transition> getIncomingTransitions() {
		if (incomingTransitions == null) {
			incomingTransitions = new EObjectWithInverseResolvingEList<Transition>(Transition.class, this,
					YakinduSimplifiedPackage.VERTEX__INCOMING_TRANSITIONS, YakinduSimplifiedPackage.TRANSITION__TARGET);
		}
	...
	public EList<Transition> getOutgoingTransitions() {
		if (outgoingTransitions == null) {
			outgoingTransitions = new EObjectContainmentWithInverseEList<Transition>(Transition.class, this,
					YakinduSimplifiedPackage.VERTEX__OUTGOING_TRANSITIONS, YakinduSimplifiedPackage.TRANSITION__SOURCE);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case YakinduSimplifiedPackage.VERTEX__INCOMING_TRANSITIONS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getIncomingTransitions()).basicAdd(otherEnd,
					msgs);
		case YakinduSimplifiedPackage.VERTEX__OUTGOING_TRANSITIONS:
