/**
 */
package yakinduSimplified.util;
 ...
 * <!-- end-user-doc -->
 * @see yakinduSimplified.YakinduSimplifiedPackage
 * @generated
 */
public class YakinduSimplifiedSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static YakinduSimplifiedPackage modelPackage;
	 ...
	 * @generated
	 */
	public YakinduSimplifiedSwitch() {
		if (modelPackage == null) {
			modelPackage = YakinduSimplifiedPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case YakinduSimplifiedPackage.PSEUDOSTATE: {
		...
		case YakinduSimplifiedPackage.VERTEX: {
		...
		case YakinduSimplifiedPackage.STATECHART: {
			...
			if (result == null)
				result = caseCompositeElement(statechart);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case YakinduSimplifiedPackage.COMPOSITE_ELEMENT: {
		...
		case YakinduSimplifiedPackage.ENTRY: {
			...
			if (result == null)
				result = casePseudostate(entry);
			if (result == null)
				result = caseVertex(entry);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case YakinduSimplifiedPackage.SYNCHRONIZATION: {
			...
			if (result == null)
				result = casePseudostate(synchronization);
			if (result == null)
				result = caseVertex(synchronization);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case YakinduSimplifiedPackage.REGULAR_STATE: {
			RegularState regularState = (RegularState) theEObject;
			T result = caseRegularState(regularState);
			if (result == null)
				result = caseVertex(regularState);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case YakinduSimplifiedPackage.STATE: {
			...
			if (result == null)
				result = caseRegularState(state);
			if (result == null)
				result = caseCompositeElement(state);
			if (result == null)
		...
		case YakinduSimplifiedPackage.CHOICE: {
			...
			if (result == null)
				result = casePseudostate(choice);
			if (result == null)
				result = caseVertex(choice);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case YakinduSimplifiedPackage.EXIT: {
			...
			if (result == null)
				result = casePseudostate(exit);
			if (result == null)
				result = caseVertex(exit);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case YakinduSimplifiedPackage.FINAL_STATE: {
			...
			if (result == null)
				result = caseRegularState(finalState);
			if (result == null)
