...
one sig util'language {
	...
	util'root : one type'ETypedElement'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClassifier'class + type'EStructuralFeature'class))))))))),
	util'contains : (type'ETypedElement'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClassifier'class + type'EStructuralFeature'class)))))))))) lone->set (type'ETypedElement'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClassifier'class + type'EStructuralFeature'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'ETypedElement'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClassifier'class + type'EStructuralFeature'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'ETypedElement'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClassifier'class + type'EStructuralFeature'class))))))))) { child = util'language.util'root or (some parent: type'ETypedElement'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClassifier'class + type'EStructuralFeature'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'ETypedElement'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClassifier'class + type'EStructuralFeature'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
