...
one sig util'language {
	...
	util'root : one type'ETypedElement'class + (type'EDataType'class + (type'ENamedElement'class + (type'EPackage'class + (type'EReference'class + (type'EClass'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EAttribute'class + type'EStructuralFeature'class))))))))),
	util'contains : (type'ETypedElement'class + (type'EDataType'class + (type'ENamedElement'class + (type'EPackage'class + (type'EReference'class + (type'EClass'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EAttribute'class + type'EStructuralFeature'class)))))))))) lone->set (type'ETypedElement'class + (type'EDataType'class + (type'ENamedElement'class + (type'EPackage'class + (type'EReference'class + (type'EClass'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EAttribute'class + type'EStructuralFeature'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'ETypedElement'class + (type'EDataType'class + (type'ENamedElement'class + (type'EPackage'class + (type'EReference'class + (type'EClass'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EAttribute'class + type'EStructuralFeature'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'ETypedElement'class + (type'EDataType'class + (type'ENamedElement'class + (type'EPackage'class + (type'EReference'class + (type'EClass'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EAttribute'class + type'EStructuralFeature'class))))))))) { child = util'language.util'root || (some parent: type'ETypedElement'class + (type'EDataType'class + (type'ENamedElement'class + (type'EPackage'class + (type'EReference'class + (type'EClass'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EAttribute'class + type'EStructuralFeature'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'ETypedElement'class + (type'EDataType'class + (type'ENamedElement'class + (type'EPackage'class + (type'EReference'class + (type'EClass'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EAttribute'class + type'EStructuralFeature'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
