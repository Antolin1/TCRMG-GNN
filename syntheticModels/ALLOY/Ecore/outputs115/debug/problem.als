...
one sig util'language {
	...
	util'root : one type'EClassifier'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EClass'class + (type'EEnum'class + type'ETypedElement'class))))))))),
	util'contains : (type'EClassifier'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EClass'class + (type'EEnum'class + type'ETypedElement'class)))))))))) lone->set (type'EClassifier'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EClass'class + (type'EEnum'class + type'ETypedElement'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EClassifier'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EClass'class + (type'EEnum'class + type'ETypedElement'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EClassifier'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EClass'class + (type'EEnum'class + type'ETypedElement'class))))))))) { child = util'language.util'root or (some parent: type'EClassifier'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EClass'class + (type'EEnum'class + type'ETypedElement'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EClassifier'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EClass'class + (type'EEnum'class + type'ETypedElement'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
