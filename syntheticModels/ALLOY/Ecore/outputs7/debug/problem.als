...
one sig util'language {
	...
	util'root : one type'EClassifier'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EClass'class + type'ENamedElement'class))))))))),
	util'contains : (type'EClassifier'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EClass'class + type'ENamedElement'class)))))))))) lone->set (type'EClassifier'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EClass'class + type'ENamedElement'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EClassifier'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EClass'class + type'ENamedElement'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EClassifier'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EClass'class + type'ENamedElement'class))))))))) { child = util'language.util'root or (some parent: type'EClassifier'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EClass'class + type'ENamedElement'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EClassifier'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EClass'class + type'ENamedElement'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
