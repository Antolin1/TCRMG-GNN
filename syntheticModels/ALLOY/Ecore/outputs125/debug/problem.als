...
one sig util'language {
	...
	util'root : one type'EDataType'class + (type'EEnum'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EPackage'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClassifier'class + type'ENamedElement'class))))))))),
	util'contains : (type'EDataType'class + (type'EEnum'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EPackage'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClassifier'class + type'ENamedElement'class)))))))))) lone->set (type'EDataType'class + (type'EEnum'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EPackage'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClassifier'class + type'ENamedElement'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EDataType'class + (type'EEnum'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EPackage'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClassifier'class + type'ENamedElement'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EDataType'class + (type'EEnum'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EPackage'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClassifier'class + type'ENamedElement'class))))))))) { child = util'language.util'root or (some parent: type'EDataType'class + (type'EEnum'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EPackage'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClassifier'class + type'ENamedElement'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EDataType'class + (type'EEnum'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EPackage'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClassifier'class + type'ENamedElement'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
