...
one sig util'language {
	...
	util'root : one type'EClassifier'class + (type'EDataType'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EEnum'class + (type'ETypedElement'class + (type'EClass'class + type'EPackage'class))))))))),
	util'contains : (type'EClassifier'class + (type'EDataType'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EEnum'class + (type'ETypedElement'class + (type'EClass'class + type'EPackage'class)))))))))) lone->set (type'EClassifier'class + (type'EDataType'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EEnum'class + (type'ETypedElement'class + (type'EClass'class + type'EPackage'class))))))))))
}
