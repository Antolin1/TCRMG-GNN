...
one sig util'language {
	...
	util'root : one type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'ENamedElement'class + (type'EDataType'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EClassifier'class + type'EAttribute'class))))))))),
	util'contains : (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'ENamedElement'class + (type'EDataType'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EClassifier'class + type'EAttribute'class)))))))))) lone->set (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'ENamedElement'class + (type'EDataType'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EClassifier'class + type'EAttribute'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'ENamedElement'class + (type'EDataType'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EClassifier'class + type'EAttribute'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'ENamedElement'class + (type'EDataType'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EClassifier'class + type'EAttribute'class))))))))) { child = util'language.util'root or (some parent: type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'ENamedElement'class + (type'EDataType'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EClassifier'class + type'EAttribute'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'ENamedElement'class + (type'EDataType'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EClassifier'class + type'EAttribute'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
