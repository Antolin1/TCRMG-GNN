...
one sig util'language {
	...
	util'root : one type'ETypedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EDataType'class + (type'ENamedElement'class + (type'EReference'class + (type'EEnum'class + (type'EStructuralFeature'class + type'EClassifier'class))))))))),
	util'contains : (type'ETypedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EDataType'class + (type'ENamedElement'class + (type'EReference'class + (type'EEnum'class + (type'EStructuralFeature'class + type'EClassifier'class)))))))))) lone->set (type'ETypedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EDataType'class + (type'ENamedElement'class + (type'EReference'class + (type'EEnum'class + (type'EStructuralFeature'class + type'EClassifier'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'ETypedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EDataType'class + (type'ENamedElement'class + (type'EReference'class + (type'EEnum'class + (type'EStructuralFeature'class + type'EClassifier'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'ETypedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EDataType'class + (type'ENamedElement'class + (type'EReference'class + (type'EEnum'class + (type'EStructuralFeature'class + type'EClassifier'class))))))))) { child = util'language.util'root || (some parent: type'ETypedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EDataType'class + (type'ENamedElement'class + (type'EReference'class + (type'EEnum'class + (type'EStructuralFeature'class + type'EClassifier'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'ETypedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EDataType'class + (type'ENamedElement'class + (type'EReference'class + (type'EEnum'class + (type'EStructuralFeature'class + type'EClassifier'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
