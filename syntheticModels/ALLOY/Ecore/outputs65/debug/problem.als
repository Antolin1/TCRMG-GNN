...
one sig util'language {
	...
	util'root : one type'EStructuralFeature'class + (type'EEnum'class + (type'EPackage'class + (type'ENamedElement'class + (type'EClass'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EClassifier'class + (type'EReference'class + type'EDataType'class))))))))),
	util'contains : (type'EStructuralFeature'class + (type'EEnum'class + (type'EPackage'class + (type'ENamedElement'class + (type'EClass'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EClassifier'class + (type'EReference'class + type'EDataType'class)))))))))) lone->set (type'EStructuralFeature'class + (type'EEnum'class + (type'EPackage'class + (type'ENamedElement'class + (type'EClass'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EClassifier'class + (type'EReference'class + type'EDataType'class))))))))))
}
