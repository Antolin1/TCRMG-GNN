...
one sig util'language {
	...
	util'root : one type'EAttribute'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EClass'class + (type'ENamedElement'class + (type'EReference'class + (type'EDataType'class + (type'EEnum'class + type'EClassifier'class))))))))),
	util'contains : (type'EAttribute'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EClass'class + (type'ENamedElement'class + (type'EReference'class + (type'EDataType'class + (type'EEnum'class + type'EClassifier'class)))))))))) lone->set (type'EAttribute'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EClass'class + (type'ENamedElement'class + (type'EReference'class + (type'EDataType'class + (type'EEnum'class + type'EClassifier'class))))))))))
}
