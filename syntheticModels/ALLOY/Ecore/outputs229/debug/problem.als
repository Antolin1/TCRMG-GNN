...
one sig util'language {
	...
	util'root : one type'ENamedElement'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EClass'class + (type'EEnum'class + (type'EPackage'class + (type'EClassifier'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EDataType'class + type'EStructuralFeature'class))))))))),
	util'contains : (type'ENamedElement'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EClass'class + (type'EEnum'class + (type'EPackage'class + (type'EClassifier'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EDataType'class + type'EStructuralFeature'class)))))))))) lone->set (type'ENamedElement'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EClass'class + (type'EEnum'class + (type'EPackage'class + (type'EClassifier'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EDataType'class + type'EStructuralFeature'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'ENamedElement'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EClass'class + (type'EEnum'class + (type'EPackage'class + (type'EClassifier'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EDataType'class + type'EStructuralFeature'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'ENamedElement'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EClass'class + (type'EEnum'class + (type'EPackage'class + (type'EClassifier'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EDataType'class + type'EStructuralFeature'class))))))))) { child = util'language.util'root || (some parent: type'ENamedElement'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EClass'class + (type'EEnum'class + (type'EPackage'class + (type'EClassifier'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EDataType'class + type'EStructuralFeature'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'ENamedElement'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EClass'class + (type'EEnum'class + (type'EPackage'class + (type'EClassifier'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EDataType'class + type'EStructuralFeature'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
