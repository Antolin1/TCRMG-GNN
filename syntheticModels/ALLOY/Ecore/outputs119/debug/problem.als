...
one sig util'language {
	...
	util'root : one type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + (type'EReference'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnum'class + (type'EClass'class + (type'EEnumLiteral'class + type'ETypedElement'class))))))))),
	util'contains : (type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + (type'EReference'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnum'class + (type'EClass'class + (type'EEnumLiteral'class + type'ETypedElement'class)))))))))) lone->set (type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + (type'EReference'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnum'class + (type'EClass'class + (type'EEnumLiteral'class + type'ETypedElement'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + (type'EReference'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnum'class + (type'EClass'class + (type'EEnumLiteral'class + type'ETypedElement'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + (type'EReference'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnum'class + (type'EClass'class + (type'EEnumLiteral'class + type'ETypedElement'class))))))))) { child = util'language.util'root || (some parent: type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + (type'EReference'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnum'class + (type'EClass'class + (type'EEnumLiteral'class + type'ETypedElement'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + (type'EReference'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnum'class + (type'EClass'class + (type'EEnumLiteral'class + type'ETypedElement'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
