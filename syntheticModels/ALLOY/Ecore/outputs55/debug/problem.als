...
one sig util'language {
	...
	util'root : one type'EClass'class + (type'EAttribute'class + (type'EEnum'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EPackage'class + (type'EClassifier'class + (type'ETypedElement'class + type'EReference'class))))))))),
	util'contains : (type'EClass'class + (type'EAttribute'class + (type'EEnum'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EPackage'class + (type'EClassifier'class + (type'ETypedElement'class + type'EReference'class)))))))))) lone->set (type'EClass'class + (type'EAttribute'class + (type'EEnum'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EPackage'class + (type'EClassifier'class + (type'ETypedElement'class + type'EReference'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EClass'class + (type'EAttribute'class + (type'EEnum'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EPackage'class + (type'EClassifier'class + (type'ETypedElement'class + type'EReference'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EClass'class + (type'EAttribute'class + (type'EEnum'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EPackage'class + (type'EClassifier'class + (type'ETypedElement'class + type'EReference'class))))))))) { child = util'language.util'root or (some parent: type'EClass'class + (type'EAttribute'class + (type'EEnum'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EPackage'class + (type'EClassifier'class + (type'ETypedElement'class + type'EReference'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EClass'class + (type'EAttribute'class + (type'EEnum'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EPackage'class + (type'EClassifier'class + (type'ETypedElement'class + type'EReference'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
