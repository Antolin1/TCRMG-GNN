...
one sig util'language {
	...
	util'root : one type'EAttribute'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClassifier'class + (type'EClass'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EEnum'class + type'ENamedElement'class))))))))),
	util'contains : (type'EAttribute'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClassifier'class + (type'EClass'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EEnum'class + type'ENamedElement'class)))))))))) lone->set (type'EAttribute'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClassifier'class + (type'EClass'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EEnum'class + type'ENamedElement'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EAttribute'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClassifier'class + (type'EClass'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EEnum'class + type'ENamedElement'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EAttribute'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClassifier'class + (type'EClass'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EEnum'class + type'ENamedElement'class))))))))) { child = util'language.util'root || (some parent: type'EAttribute'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClassifier'class + (type'EClass'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EEnum'class + type'ENamedElement'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EAttribute'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClassifier'class + (type'EClass'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EEnum'class + type'ENamedElement'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
