...
one sig util'language {
	...
	util'root : one type'EClassifier'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'ENamedElement'class + (type'EReference'class + (type'EPackage'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'ETypedElement'class + type'EDataType'class))))))))),
	util'contains : (type'EClassifier'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'ENamedElement'class + (type'EReference'class + (type'EPackage'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'ETypedElement'class + type'EDataType'class)))))))))) lone->set (type'EClassifier'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'ENamedElement'class + (type'EReference'class + (type'EPackage'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'ETypedElement'class + type'EDataType'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EClassifier'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'ENamedElement'class + (type'EReference'class + (type'EPackage'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'ETypedElement'class + type'EDataType'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EClassifier'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'ENamedElement'class + (type'EReference'class + (type'EPackage'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'ETypedElement'class + type'EDataType'class))))))))) { child = util'language.util'root or (some parent: type'EClassifier'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'ENamedElement'class + (type'EReference'class + (type'EPackage'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'ETypedElement'class + type'EDataType'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EClassifier'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'ENamedElement'class + (type'EReference'class + (type'EPackage'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'ETypedElement'class + type'EDataType'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
