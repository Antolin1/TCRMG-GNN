...
one sig util'language {
	...
	util'root : one type'EEnum'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EAttribute'class + (type'EClass'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EReference'class + type'ETypedElement'class))))))))),
	util'contains : (type'EEnum'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EAttribute'class + (type'EClass'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EReference'class + type'ETypedElement'class)))))))))) lone->set (type'EEnum'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EAttribute'class + (type'EClass'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EReference'class + type'ETypedElement'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EEnum'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EAttribute'class + (type'EClass'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EReference'class + type'ETypedElement'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EEnum'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EAttribute'class + (type'EClass'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EReference'class + type'ETypedElement'class))))))))) { child = util'language.util'root or (some parent: type'EEnum'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EAttribute'class + (type'EClass'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EReference'class + type'ETypedElement'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EEnum'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EAttribute'class + (type'EClass'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EReference'class + type'ETypedElement'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
