...
one sig util'language {
	...
	util'root : one type'EDataType'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'ENamedElement'class + (type'EEnum'class + (type'ETypedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EReference'class + type'EClass'class))))))))),
	util'contains : (type'EDataType'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'ENamedElement'class + (type'EEnum'class + (type'ETypedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EReference'class + type'EClass'class)))))))))) lone->set (type'EDataType'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'ENamedElement'class + (type'EEnum'class + (type'ETypedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EReference'class + type'EClass'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EDataType'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'ENamedElement'class + (type'EEnum'class + (type'ETypedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EReference'class + type'EClass'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EDataType'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'ENamedElement'class + (type'EEnum'class + (type'ETypedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EReference'class + type'EClass'class))))))))) { child = util'language.util'root || (some parent: type'EDataType'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'ENamedElement'class + (type'EEnum'class + (type'ETypedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EReference'class + type'EClass'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EDataType'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'ENamedElement'class + (type'EEnum'class + (type'ETypedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EReference'class + type'EClass'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
