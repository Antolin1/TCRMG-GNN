...
one sig util'language {
	...
	util'root : one type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + (type'EDataType'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EClass'class + (type'EClassifier'class + (type'EStructuralFeature'class + type'EPackage'class))))))))),
	util'contains : (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + (type'EDataType'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EClass'class + (type'EClassifier'class + (type'EStructuralFeature'class + type'EPackage'class)))))))))) lone->set (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + (type'EDataType'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EClass'class + (type'EClassifier'class + (type'EStructuralFeature'class + type'EPackage'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + (type'EDataType'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EClass'class + (type'EClassifier'class + (type'EStructuralFeature'class + type'EPackage'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + (type'EDataType'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EClass'class + (type'EClassifier'class + (type'EStructuralFeature'class + type'EPackage'class))))))))) { child = util'language.util'root || (some parent: type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + (type'EDataType'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EClass'class + (type'EClassifier'class + (type'EStructuralFeature'class + type'EPackage'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + (type'EDataType'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EClass'class + (type'EClassifier'class + (type'EStructuralFeature'class + type'EPackage'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
