...
one sig util'language {
	...
	util'root : one type'EDataType'class + (type'EEnumLiteral'class + (type'EClass'class + (type'ETypedElement'class + (type'EReference'class + (type'EAttribute'class + (type'ENamedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EClassifier'class + type'EStructuralFeature'class))))))))),
	util'contains : (type'EDataType'class + (type'EEnumLiteral'class + (type'EClass'class + (type'ETypedElement'class + (type'EReference'class + (type'EAttribute'class + (type'ENamedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EClassifier'class + type'EStructuralFeature'class)))))))))) lone->set (type'EDataType'class + (type'EEnumLiteral'class + (type'EClass'class + (type'ETypedElement'class + (type'EReference'class + (type'EAttribute'class + (type'ENamedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EClassifier'class + type'EStructuralFeature'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EDataType'class + (type'EEnumLiteral'class + (type'EClass'class + (type'ETypedElement'class + (type'EReference'class + (type'EAttribute'class + (type'ENamedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EClassifier'class + type'EStructuralFeature'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EDataType'class + (type'EEnumLiteral'class + (type'EClass'class + (type'ETypedElement'class + (type'EReference'class + (type'EAttribute'class + (type'ENamedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EClassifier'class + type'EStructuralFeature'class))))))))) { child = util'language.util'root or (some parent: type'EDataType'class + (type'EEnumLiteral'class + (type'EClass'class + (type'ETypedElement'class + (type'EReference'class + (type'EAttribute'class + (type'ENamedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EClassifier'class + type'EStructuralFeature'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EDataType'class + (type'EEnumLiteral'class + (type'EClass'class + (type'ETypedElement'class + (type'EReference'class + (type'EAttribute'class + (type'ENamedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EClassifier'class + type'EStructuralFeature'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
