...
one sig util'language {
	...
	util'root : one type'EEnumLiteral'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'ETypedElement'class + (type'EClass'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EReference'class + type'EAttribute'class))))))))),
	util'contains : (type'EEnumLiteral'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'ETypedElement'class + (type'EClass'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EReference'class + type'EAttribute'class)))))))))) lone->set (type'EEnumLiteral'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'ETypedElement'class + (type'EClass'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EReference'class + type'EAttribute'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EEnumLiteral'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'ETypedElement'class + (type'EClass'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EReference'class + type'EAttribute'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EEnumLiteral'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'ETypedElement'class + (type'EClass'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EReference'class + type'EAttribute'class))))))))) { child = util'language.util'root || (some parent: type'EEnumLiteral'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'ETypedElement'class + (type'EClass'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EReference'class + type'EAttribute'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EEnumLiteral'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'ETypedElement'class + (type'EClass'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EReference'class + type'EAttribute'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
