...
one sig util'language {
	...
	util'root : one type'EPackage'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EClassifier'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EReference'class + (type'EDataType'class + type'EAttribute'class))))))))),
	util'contains : (type'EPackage'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EClassifier'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EReference'class + (type'EDataType'class + type'EAttribute'class)))))))))) lone->set (type'EPackage'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EClassifier'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EReference'class + (type'EDataType'class + type'EAttribute'class))))))))))
}
