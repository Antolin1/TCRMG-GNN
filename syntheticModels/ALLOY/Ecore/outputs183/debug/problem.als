...
one sig util'language {
	...
	util'root : one type'EReference'class + (type'EClassifier'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EClass'class + type'EAttribute'class))))))))),
	util'contains : (type'EReference'class + (type'EClassifier'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EClass'class + type'EAttribute'class)))))))))) lone->set (type'EReference'class + (type'EClassifier'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EClass'class + type'EAttribute'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EReference'class + (type'EClassifier'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EClass'class + type'EAttribute'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EReference'class + (type'EClassifier'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EClass'class + type'EAttribute'class))))))))) { child = util'language.util'root or (some parent: type'EReference'class + (type'EClassifier'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EClass'class + type'EAttribute'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EReference'class + (type'EClassifier'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EClass'class + type'EAttribute'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
