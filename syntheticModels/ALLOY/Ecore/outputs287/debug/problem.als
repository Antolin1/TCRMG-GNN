...
one sig util'language {
	...
	util'root : one type'EClassifier'class + (type'EEnum'class + (type'EDataType'class + (type'ETypedElement'class + (type'EReference'class + (type'EClass'class + (type'EPackage'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ENamedElement'class + type'EStructuralFeature'class))))))))),
	util'contains : (type'EClassifier'class + (type'EEnum'class + (type'EDataType'class + (type'ETypedElement'class + (type'EReference'class + (type'EClass'class + (type'EPackage'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ENamedElement'class + type'EStructuralFeature'class)))))))))) lone->set (type'EClassifier'class + (type'EEnum'class + (type'EDataType'class + (type'ETypedElement'class + (type'EReference'class + (type'EClass'class + (type'EPackage'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ENamedElement'class + type'EStructuralFeature'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EClassifier'class + (type'EEnum'class + (type'EDataType'class + (type'ETypedElement'class + (type'EReference'class + (type'EClass'class + (type'EPackage'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ENamedElement'class + type'EStructuralFeature'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EClassifier'class + (type'EEnum'class + (type'EDataType'class + (type'ETypedElement'class + (type'EReference'class + (type'EClass'class + (type'EPackage'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ENamedElement'class + type'EStructuralFeature'class))))))))) { child = util'language.util'root || (some parent: type'EClassifier'class + (type'EEnum'class + (type'EDataType'class + (type'ETypedElement'class + (type'EReference'class + (type'EClass'class + (type'EPackage'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ENamedElement'class + type'EStructuralFeature'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EClassifier'class + (type'EEnum'class + (type'EDataType'class + (type'ETypedElement'class + (type'EReference'class + (type'EClass'class + (type'EPackage'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ENamedElement'class + type'EStructuralFeature'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
