...
one sig util'language {
	...
	util'root : one type'ETypedElement'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EPackage'class + (type'EEnum'class + (type'EReference'class + (type'EDataType'class + type'ENamedElement'class))))))))),
	util'contains : (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EPackage'class + (type'EEnum'class + (type'EReference'class + (type'EDataType'class + type'ENamedElement'class)))))))))) lone->set (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EPackage'class + (type'EEnum'class + (type'EReference'class + (type'EDataType'class + type'ENamedElement'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'ETypedElement'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EPackage'class + (type'EEnum'class + (type'EReference'class + (type'EDataType'class + type'ENamedElement'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'ETypedElement'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EPackage'class + (type'EEnum'class + (type'EReference'class + (type'EDataType'class + type'ENamedElement'class))))))))) { child = util'language.util'root or (some parent: type'ETypedElement'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EPackage'class + (type'EEnum'class + (type'EReference'class + (type'EDataType'class + type'ENamedElement'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'ETypedElement'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EPackage'class + (type'EEnum'class + (type'EReference'class + (type'EDataType'class + type'ENamedElement'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
