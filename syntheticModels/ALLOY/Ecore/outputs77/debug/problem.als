...
one sig util'language {
	...
	util'root : one type'EReference'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClass'class + (type'EPackage'class + type'ETypedElement'class))))))))),
	util'contains : (type'EReference'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClass'class + (type'EPackage'class + type'ETypedElement'class)))))))))) lone->set (type'EReference'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClass'class + (type'EPackage'class + type'ETypedElement'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EReference'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClass'class + (type'EPackage'class + type'ETypedElement'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EReference'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClass'class + (type'EPackage'class + type'ETypedElement'class))))))))) { child = util'language.util'root or (some parent: type'EReference'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClass'class + (type'EPackage'class + type'ETypedElement'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EReference'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClass'class + (type'EPackage'class + type'ETypedElement'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
