...
one sig util'language {
	...
	util'root : one type'ENamedElement'class + (type'EClass'class + (type'ETypedElement'class + (type'EDataType'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EPackage'class + (type'EReference'class + (type'EStructuralFeature'class + type'EAttribute'class))))))))),
	util'contains : (type'ENamedElement'class + (type'EClass'class + (type'ETypedElement'class + (type'EDataType'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EPackage'class + (type'EReference'class + (type'EStructuralFeature'class + type'EAttribute'class)))))))))) lone->set (type'ENamedElement'class + (type'EClass'class + (type'ETypedElement'class + (type'EDataType'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EPackage'class + (type'EReference'class + (type'EStructuralFeature'class + type'EAttribute'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'ENamedElement'class + (type'EClass'class + (type'ETypedElement'class + (type'EDataType'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EPackage'class + (type'EReference'class + (type'EStructuralFeature'class + type'EAttribute'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'ENamedElement'class + (type'EClass'class + (type'ETypedElement'class + (type'EDataType'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EPackage'class + (type'EReference'class + (type'EStructuralFeature'class + type'EAttribute'class))))))))) { child = util'language.util'root or (some parent: type'ENamedElement'class + (type'EClass'class + (type'ETypedElement'class + (type'EDataType'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EPackage'class + (type'EReference'class + (type'EStructuralFeature'class + type'EAttribute'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'ENamedElement'class + (type'EClass'class + (type'ETypedElement'class + (type'EDataType'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EPackage'class + (type'EReference'class + (type'EStructuralFeature'class + type'EAttribute'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
