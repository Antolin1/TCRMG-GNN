...
one sig util'language {
	...
	util'root : one type'EAttribute'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'EClass'class + (type'ETypedElement'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EEnum'class + (type'EStructuralFeature'class + type'EEnumLiteral'class))))))))),
	util'contains : (type'EAttribute'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'EClass'class + (type'ETypedElement'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EEnum'class + (type'EStructuralFeature'class + type'EEnumLiteral'class)))))))))) lone->set (type'EAttribute'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'EClass'class + (type'ETypedElement'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EEnum'class + (type'EStructuralFeature'class + type'EEnumLiteral'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EAttribute'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'EClass'class + (type'ETypedElement'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EEnum'class + (type'EStructuralFeature'class + type'EEnumLiteral'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EAttribute'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'EClass'class + (type'ETypedElement'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EEnum'class + (type'EStructuralFeature'class + type'EEnumLiteral'class))))))))) { child = util'language.util'root or (some parent: type'EAttribute'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'EClass'class + (type'ETypedElement'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EEnum'class + (type'EStructuralFeature'class + type'EEnumLiteral'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EAttribute'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'EClass'class + (type'ETypedElement'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EEnum'class + (type'EStructuralFeature'class + type'EEnumLiteral'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
