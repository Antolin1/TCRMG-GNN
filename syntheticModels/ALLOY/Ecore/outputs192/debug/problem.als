...
one sig util'language {
	...
	util'root : one type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EReference'class + (type'ENamedElement'class + (type'EAttribute'class + type'EDataType'class))))))))),
	util'contains : (type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EReference'class + (type'ENamedElement'class + (type'EAttribute'class + type'EDataType'class)))))))))) lone->set (type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EReference'class + (type'ENamedElement'class + (type'EAttribute'class + type'EDataType'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EReference'class + (type'ENamedElement'class + (type'EAttribute'class + type'EDataType'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EReference'class + (type'ENamedElement'class + (type'EAttribute'class + type'EDataType'class))))))))) { child = util'language.util'root || (some parent: type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EReference'class + (type'ENamedElement'class + (type'EAttribute'class + type'EDataType'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EReference'class + (type'ENamedElement'class + (type'EAttribute'class + type'EDataType'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
