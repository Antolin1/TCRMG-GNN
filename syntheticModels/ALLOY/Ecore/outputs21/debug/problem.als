...
one sig util'language {
	...
	util'root : one type'EClassifier'class + (type'EClass'class + (type'EAttribute'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + type'EEnum'class))))))))),
	util'contains : (type'EClassifier'class + (type'EClass'class + (type'EAttribute'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + type'EEnum'class)))))))))) lone->set (type'EClassifier'class + (type'EClass'class + (type'EAttribute'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + type'EEnum'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EClassifier'class + (type'EClass'class + (type'EAttribute'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + type'EEnum'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EClassifier'class + (type'EClass'class + (type'EAttribute'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + type'EEnum'class))))))))) { child = util'language.util'root || (some parent: type'EClassifier'class + (type'EClass'class + (type'EAttribute'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + type'EEnum'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EClassifier'class + (type'EClass'class + (type'EAttribute'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + type'EEnum'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
