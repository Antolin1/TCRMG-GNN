...
one sig util'language {
	...
	util'root : one type'EAttribute'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EClassifier'class + (type'EClass'class + (type'EReference'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EDataType'class + type'ENamedElement'class))))))))),
	util'contains : (type'EAttribute'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EClassifier'class + (type'EClass'class + (type'EReference'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EDataType'class + type'ENamedElement'class)))))))))) lone->set (type'EAttribute'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EClassifier'class + (type'EClass'class + (type'EReference'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EDataType'class + type'ENamedElement'class))))))))))
}
