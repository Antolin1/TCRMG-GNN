...
one sig util'language {
	...
	util'root : one type'EClassifier'class + (type'EClass'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EReference'class + (type'EAttribute'class + (type'EEnum'class + (type'EStructuralFeature'class + type'EDataType'class))))))))),
	util'contains : (type'EClassifier'class + (type'EClass'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EReference'class + (type'EAttribute'class + (type'EEnum'class + (type'EStructuralFeature'class + type'EDataType'class)))))))))) lone->set (type'EClassifier'class + (type'EClass'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EReference'class + (type'EAttribute'class + (type'EEnum'class + (type'EStructuralFeature'class + type'EDataType'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EClassifier'class + (type'EClass'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EReference'class + (type'EAttribute'class + (type'EEnum'class + (type'EStructuralFeature'class + type'EDataType'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EClassifier'class + (type'EClass'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EReference'class + (type'EAttribute'class + (type'EEnum'class + (type'EStructuralFeature'class + type'EDataType'class))))))))) { child = util'language.util'root || (some parent: type'EClassifier'class + (type'EClass'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EReference'class + (type'EAttribute'class + (type'EEnum'class + (type'EStructuralFeature'class + type'EDataType'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EClassifier'class + (type'EClass'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EReference'class + (type'EAttribute'class + (type'EEnum'class + (type'EStructuralFeature'class + type'EDataType'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
