...
one sig util'language {
	...
	util'root : one type'EPackage'class + (type'EDataType'class + (type'EReference'class + (type'EClassifier'class + (type'EEnum'class + (type'ETypedElement'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EAttribute'class + type'ENamedElement'class))))))))),
	util'contains : (type'EPackage'class + (type'EDataType'class + (type'EReference'class + (type'EClassifier'class + (type'EEnum'class + (type'ETypedElement'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EAttribute'class + type'ENamedElement'class)))))))))) lone->set (type'EPackage'class + (type'EDataType'class + (type'EReference'class + (type'EClassifier'class + (type'EEnum'class + (type'ETypedElement'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EAttribute'class + type'ENamedElement'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EPackage'class + (type'EDataType'class + (type'EReference'class + (type'EClassifier'class + (type'EEnum'class + (type'ETypedElement'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EAttribute'class + type'ENamedElement'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EPackage'class + (type'EDataType'class + (type'EReference'class + (type'EClassifier'class + (type'EEnum'class + (type'ETypedElement'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EAttribute'class + type'ENamedElement'class))))))))) { child = util'language.util'root or (some parent: type'EPackage'class + (type'EDataType'class + (type'EReference'class + (type'EClassifier'class + (type'EEnum'class + (type'ETypedElement'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EAttribute'class + type'ENamedElement'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EPackage'class + (type'EDataType'class + (type'EReference'class + (type'EClassifier'class + (type'EEnum'class + (type'ETypedElement'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EAttribute'class + type'ENamedElement'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
