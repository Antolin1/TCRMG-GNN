...
one sig util'language {
	...
	util'root : one type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'EReference'class + type'ENamedElement'class))))))))),
	util'contains : (type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'EReference'class + type'ENamedElement'class)))))))))) lone->set (type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'EReference'class + type'ENamedElement'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'EReference'class + type'ENamedElement'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'EReference'class + type'ENamedElement'class))))))))) { child = util'language.util'root || (some parent: type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'EReference'class + type'ENamedElement'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'EReference'class + type'ENamedElement'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
