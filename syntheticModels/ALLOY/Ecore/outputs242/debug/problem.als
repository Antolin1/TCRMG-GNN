...
one sig util'language {
	...
	util'root : one type'EEnumLiteral'class + (type'EEnum'class + (type'EClassifier'class + (type'EClass'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ENamedElement'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EPackage'class + type'EDataType'class))))))))),
	util'contains : (type'EEnumLiteral'class + (type'EEnum'class + (type'EClassifier'class + (type'EClass'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ENamedElement'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EPackage'class + type'EDataType'class)))))))))) lone->set (type'EEnumLiteral'class + (type'EEnum'class + (type'EClassifier'class + (type'EClass'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ENamedElement'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EPackage'class + type'EDataType'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EEnumLiteral'class + (type'EEnum'class + (type'EClassifier'class + (type'EClass'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ENamedElement'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EPackage'class + type'EDataType'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EEnumLiteral'class + (type'EEnum'class + (type'EClassifier'class + (type'EClass'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ENamedElement'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EPackage'class + type'EDataType'class))))))))) { child = util'language.util'root || (some parent: type'EEnumLiteral'class + (type'EEnum'class + (type'EClassifier'class + (type'EClass'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ENamedElement'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EPackage'class + type'EDataType'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EEnumLiteral'class + (type'EEnum'class + (type'EClassifier'class + (type'EClass'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ENamedElement'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EPackage'class + type'EDataType'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
