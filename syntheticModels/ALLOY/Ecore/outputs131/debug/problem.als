...
one sig util'language {
	...
	util'root : one type'EPackage'class + (type'EClassifier'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EDataType'class + (type'EClass'class + (type'EReference'class + (type'EStructuralFeature'class + (type'EEnum'class + type'EEnumLiteral'class))))))))),
	util'contains : (type'EPackage'class + (type'EClassifier'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EDataType'class + (type'EClass'class + (type'EReference'class + (type'EStructuralFeature'class + (type'EEnum'class + type'EEnumLiteral'class)))))))))) lone->set (type'EPackage'class + (type'EClassifier'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EDataType'class + (type'EClass'class + (type'EReference'class + (type'EStructuralFeature'class + (type'EEnum'class + type'EEnumLiteral'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EPackage'class + (type'EClassifier'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EDataType'class + (type'EClass'class + (type'EReference'class + (type'EStructuralFeature'class + (type'EEnum'class + type'EEnumLiteral'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EPackage'class + (type'EClassifier'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EDataType'class + (type'EClass'class + (type'EReference'class + (type'EStructuralFeature'class + (type'EEnum'class + type'EEnumLiteral'class))))))))) { child = util'language.util'root or (some parent: type'EPackage'class + (type'EClassifier'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EDataType'class + (type'EClass'class + (type'EReference'class + (type'EStructuralFeature'class + (type'EEnum'class + type'EEnumLiteral'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EPackage'class + (type'EClassifier'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EDataType'class + (type'EClass'class + (type'EReference'class + (type'EStructuralFeature'class + (type'EEnum'class + type'EEnumLiteral'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
