...
one sig util'language {
	...
	util'root : one type'EAttribute'class + (type'EDataType'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EClassifier'class + (type'EReference'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EClass'class + type'EPackage'class))))))))),
	util'contains : (type'EAttribute'class + (type'EDataType'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EClassifier'class + (type'EReference'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EClass'class + type'EPackage'class)))))))))) lone->set (type'EAttribute'class + (type'EDataType'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EClassifier'class + (type'EReference'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EClass'class + type'EPackage'class))))))))))
}
