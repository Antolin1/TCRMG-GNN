...
one sig util'language {
	...
	util'root : one type'EStructuralFeature'class + (type'EDataType'class + (type'EReference'class + (type'EAttribute'class + (type'EClass'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EPackage'class + (type'ETypedElement'class + (type'EEnum'class + type'EEnumLiteral'class))))))))),
	util'contains : (type'EStructuralFeature'class + (type'EDataType'class + (type'EReference'class + (type'EAttribute'class + (type'EClass'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EPackage'class + (type'ETypedElement'class + (type'EEnum'class + type'EEnumLiteral'class)))))))))) lone->set (type'EStructuralFeature'class + (type'EDataType'class + (type'EReference'class + (type'EAttribute'class + (type'EClass'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EPackage'class + (type'ETypedElement'class + (type'EEnum'class + type'EEnumLiteral'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EStructuralFeature'class + (type'EDataType'class + (type'EReference'class + (type'EAttribute'class + (type'EClass'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EPackage'class + (type'ETypedElement'class + (type'EEnum'class + type'EEnumLiteral'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EStructuralFeature'class + (type'EDataType'class + (type'EReference'class + (type'EAttribute'class + (type'EClass'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EPackage'class + (type'ETypedElement'class + (type'EEnum'class + type'EEnumLiteral'class))))))))) { child = util'language.util'root or (some parent: type'EStructuralFeature'class + (type'EDataType'class + (type'EReference'class + (type'EAttribute'class + (type'EClass'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EPackage'class + (type'ETypedElement'class + (type'EEnum'class + type'EEnumLiteral'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EStructuralFeature'class + (type'EDataType'class + (type'EReference'class + (type'EAttribute'class + (type'EClass'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EPackage'class + (type'ETypedElement'class + (type'EEnum'class + type'EEnumLiteral'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
...
run { } for exactly 27 util'Object , 2 Int , exactly 0 String