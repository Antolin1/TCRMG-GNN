...
one sig util'language {
	...
	util'root : one type'EClass'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EEnum'class + (type'EPackage'class + (type'EAttribute'class + (type'EReference'class + (type'EEnumLiteral'class + type'ETypedElement'class))))))))),
	util'contains : (type'EClass'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EEnum'class + (type'EPackage'class + (type'EAttribute'class + (type'EReference'class + (type'EEnumLiteral'class + type'ETypedElement'class)))))))))) lone->set (type'EClass'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EEnum'class + (type'EPackage'class + (type'EAttribute'class + (type'EReference'class + (type'EEnumLiteral'class + type'ETypedElement'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EClass'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EEnum'class + (type'EPackage'class + (type'EAttribute'class + (type'EReference'class + (type'EEnumLiteral'class + type'ETypedElement'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EClass'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EEnum'class + (type'EPackage'class + (type'EAttribute'class + (type'EReference'class + (type'EEnumLiteral'class + type'ETypedElement'class))))))))) { child = util'language.util'root or (some parent: type'EClass'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EEnum'class + (type'EPackage'class + (type'EAttribute'class + (type'EReference'class + (type'EEnumLiteral'class + type'ETypedElement'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EClass'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EEnum'class + (type'EPackage'class + (type'EAttribute'class + (type'EReference'class + (type'EEnumLiteral'class + type'ETypedElement'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
