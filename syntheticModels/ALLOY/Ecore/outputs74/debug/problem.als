...
one sig util'language {
	...
	util'root : one type'EEnumLiteral'class + (type'EClassifier'class + (type'EReference'class + (type'EAttribute'class + (type'EDataType'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EClass'class + (type'ETypedElement'class + (type'EEnum'class + type'EPackage'class))))))))),
	util'contains : (type'EEnumLiteral'class + (type'EClassifier'class + (type'EReference'class + (type'EAttribute'class + (type'EDataType'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EClass'class + (type'ETypedElement'class + (type'EEnum'class + type'EPackage'class)))))))))) lone->set (type'EEnumLiteral'class + (type'EClassifier'class + (type'EReference'class + (type'EAttribute'class + (type'EDataType'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EClass'class + (type'ETypedElement'class + (type'EEnum'class + type'EPackage'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EEnumLiteral'class + (type'EClassifier'class + (type'EReference'class + (type'EAttribute'class + (type'EDataType'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EClass'class + (type'ETypedElement'class + (type'EEnum'class + type'EPackage'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EEnumLiteral'class + (type'EClassifier'class + (type'EReference'class + (type'EAttribute'class + (type'EDataType'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EClass'class + (type'ETypedElement'class + (type'EEnum'class + type'EPackage'class))))))))) { child = util'language.util'root || (some parent: type'EEnumLiteral'class + (type'EClassifier'class + (type'EReference'class + (type'EAttribute'class + (type'EDataType'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EClass'class + (type'ETypedElement'class + (type'EEnum'class + type'EPackage'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EEnumLiteral'class + (type'EClassifier'class + (type'EReference'class + (type'EAttribute'class + (type'EDataType'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EClass'class + (type'ETypedElement'class + (type'EEnum'class + type'EPackage'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
