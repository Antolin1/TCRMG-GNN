...
one sig util'language {
	...
	util'root : one type'EPackage'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EReference'class + (type'EEnum'class + (type'EClass'class + (type'EAttribute'class + (type'EStructuralFeature'class + type'EDataType'class))))))))),
	util'contains : (type'EPackage'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EReference'class + (type'EEnum'class + (type'EClass'class + (type'EAttribute'class + (type'EStructuralFeature'class + type'EDataType'class)))))))))) lone->set (type'EPackage'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EReference'class + (type'EEnum'class + (type'EClass'class + (type'EAttribute'class + (type'EStructuralFeature'class + type'EDataType'class))))))))))
}
