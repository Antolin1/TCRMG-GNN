...
one sig util'language {
	...
	util'root : one type'ETypedElement'class + (type'EClassifier'class + (type'EAttribute'class + (type'ENamedElement'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EDataType'class + (type'EClass'class + (type'EEnum'class + type'EEnumLiteral'class))))))))),
	util'contains : (type'ETypedElement'class + (type'EClassifier'class + (type'EAttribute'class + (type'ENamedElement'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EDataType'class + (type'EClass'class + (type'EEnum'class + type'EEnumLiteral'class)))))))))) lone->set (type'ETypedElement'class + (type'EClassifier'class + (type'EAttribute'class + (type'ENamedElement'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EDataType'class + (type'EClass'class + (type'EEnum'class + type'EEnumLiteral'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'ETypedElement'class + (type'EClassifier'class + (type'EAttribute'class + (type'ENamedElement'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EDataType'class + (type'EClass'class + (type'EEnum'class + type'EEnumLiteral'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'ETypedElement'class + (type'EClassifier'class + (type'EAttribute'class + (type'ENamedElement'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EDataType'class + (type'EClass'class + (type'EEnum'class + type'EEnumLiteral'class))))))))) { child = util'language.util'root || (some parent: type'ETypedElement'class + (type'EClassifier'class + (type'EAttribute'class + (type'ENamedElement'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EDataType'class + (type'EClass'class + (type'EEnum'class + type'EEnumLiteral'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'ETypedElement'class + (type'EClassifier'class + (type'EAttribute'class + (type'ENamedElement'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EDataType'class + (type'EClass'class + (type'EEnum'class + type'EEnumLiteral'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
