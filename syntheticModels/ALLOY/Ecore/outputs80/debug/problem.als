...
one sig util'language {
	...
	util'root : one type'ETypedElement'class + (type'EClassifier'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EPackage'class + (type'ENamedElement'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EAttribute'class + type'EReference'class))))))))),
	util'contains : (type'ETypedElement'class + (type'EClassifier'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EPackage'class + (type'ENamedElement'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EAttribute'class + type'EReference'class)))))))))) lone->set (type'ETypedElement'class + (type'EClassifier'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EPackage'class + (type'ENamedElement'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EAttribute'class + type'EReference'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'ETypedElement'class + (type'EClassifier'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EPackage'class + (type'ENamedElement'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EAttribute'class + type'EReference'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'ETypedElement'class + (type'EClassifier'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EPackage'class + (type'ENamedElement'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EAttribute'class + type'EReference'class))))))))) { child = util'language.util'root || (some parent: type'ETypedElement'class + (type'EClassifier'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EPackage'class + (type'ENamedElement'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EAttribute'class + type'EReference'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'ETypedElement'class + (type'EClassifier'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EPackage'class + (type'ENamedElement'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EAttribute'class + type'EReference'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
