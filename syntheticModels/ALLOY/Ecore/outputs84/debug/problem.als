...
one sig util'language {
	...
	util'root : one type'EClass'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EReference'class + (type'EPackage'class + (type'ETypedElement'class + type'EEnum'class))))))))),
	util'contains : (type'EClass'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EReference'class + (type'EPackage'class + (type'ETypedElement'class + type'EEnum'class)))))))))) lone->set (type'EClass'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EReference'class + (type'EPackage'class + (type'ETypedElement'class + type'EEnum'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EClass'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EReference'class + (type'EPackage'class + (type'ETypedElement'class + type'EEnum'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EClass'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EReference'class + (type'EPackage'class + (type'ETypedElement'class + type'EEnum'class))))))))) { child = util'language.util'root || (some parent: type'EClass'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EReference'class + (type'EPackage'class + (type'ETypedElement'class + type'EEnum'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EClass'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EReference'class + (type'EPackage'class + (type'ETypedElement'class + type'EEnum'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
