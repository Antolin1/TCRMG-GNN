...
one sig util'language {
	...
	util'root : one type'EStructuralFeature'class + (type'EClass'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EDataType'class + (type'EPackage'class + (type'EClassifier'class + type'EAttribute'class))))))))),
	util'contains : (type'EStructuralFeature'class + (type'EClass'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EDataType'class + (type'EPackage'class + (type'EClassifier'class + type'EAttribute'class)))))))))) lone->set (type'EStructuralFeature'class + (type'EClass'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EDataType'class + (type'EPackage'class + (type'EClassifier'class + type'EAttribute'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EStructuralFeature'class + (type'EClass'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EDataType'class + (type'EPackage'class + (type'EClassifier'class + type'EAttribute'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EStructuralFeature'class + (type'EClass'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EDataType'class + (type'EPackage'class + (type'EClassifier'class + type'EAttribute'class))))))))) { child = util'language.util'root || (some parent: type'EStructuralFeature'class + (type'EClass'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EDataType'class + (type'EPackage'class + (type'EClassifier'class + type'EAttribute'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EStructuralFeature'class + (type'EClass'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EDataType'class + (type'EPackage'class + (type'EClassifier'class + type'EAttribute'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
