...
one sig util'language {
	...
	util'root : one type'EReference'class + (type'EClassifier'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EEnum'class + type'EClass'class))))))))),
	util'contains : (type'EReference'class + (type'EClassifier'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EEnum'class + type'EClass'class)))))))))) lone->set (type'EReference'class + (type'EClassifier'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EEnum'class + type'EClass'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EReference'class + (type'EClassifier'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EEnum'class + type'EClass'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EReference'class + (type'EClassifier'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EEnum'class + type'EClass'class))))))))) { child = util'language.util'root or (some parent: type'EReference'class + (type'EClassifier'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EEnum'class + type'EClass'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EReference'class + (type'EClassifier'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EEnum'class + type'EClass'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
