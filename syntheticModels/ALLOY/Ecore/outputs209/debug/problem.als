...
one sig util'language {
	...
	util'root : one type'EAttribute'class + (type'EPackage'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'ETypedElement'class + (type'ENamedElement'class + type'EEnumLiteral'class))))))))),
	util'contains : (type'EAttribute'class + (type'EPackage'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'ETypedElement'class + (type'ENamedElement'class + type'EEnumLiteral'class)))))))))) lone->set (type'EAttribute'class + (type'EPackage'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'ETypedElement'class + (type'ENamedElement'class + type'EEnumLiteral'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EAttribute'class + (type'EPackage'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'ETypedElement'class + (type'ENamedElement'class + type'EEnumLiteral'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EAttribute'class + (type'EPackage'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'ETypedElement'class + (type'ENamedElement'class + type'EEnumLiteral'class))))))))) { child = util'language.util'root || (some parent: type'EAttribute'class + (type'EPackage'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'ETypedElement'class + (type'ENamedElement'class + type'EEnumLiteral'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EAttribute'class + (type'EPackage'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'ETypedElement'class + (type'ENamedElement'class + type'EEnumLiteral'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
