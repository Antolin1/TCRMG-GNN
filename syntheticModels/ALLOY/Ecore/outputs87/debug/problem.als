...
one sig util'language {
	...
	util'root : one type'EClassifier'class + (type'ENamedElement'class + (type'EPackage'class + (type'ETypedElement'class + (type'EClass'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EDataType'class + (type'EReference'class + type'EEnumLiteral'class))))))))),
	util'contains : (type'EClassifier'class + (type'ENamedElement'class + (type'EPackage'class + (type'ETypedElement'class + (type'EClass'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EDataType'class + (type'EReference'class + type'EEnumLiteral'class)))))))))) lone->set (type'EClassifier'class + (type'ENamedElement'class + (type'EPackage'class + (type'ETypedElement'class + (type'EClass'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EDataType'class + (type'EReference'class + type'EEnumLiteral'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EClassifier'class + (type'ENamedElement'class + (type'EPackage'class + (type'ETypedElement'class + (type'EClass'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EDataType'class + (type'EReference'class + type'EEnumLiteral'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EClassifier'class + (type'ENamedElement'class + (type'EPackage'class + (type'ETypedElement'class + (type'EClass'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EDataType'class + (type'EReference'class + type'EEnumLiteral'class))))))))) { child = util'language.util'root || (some parent: type'EClassifier'class + (type'ENamedElement'class + (type'EPackage'class + (type'ETypedElement'class + (type'EClass'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EDataType'class + (type'EReference'class + type'EEnumLiteral'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EClassifier'class + (type'ENamedElement'class + (type'EPackage'class + (type'ETypedElement'class + (type'EClass'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EDataType'class + (type'EReference'class + type'EEnumLiteral'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
