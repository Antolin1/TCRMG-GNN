...
one sig util'language {
	...
	util'root : one type'EAttribute'class + (type'EEnum'class + (type'EReference'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EClass'class + (type'ETypedElement'class + type'EPackage'class))))))))),
	util'contains : (type'EAttribute'class + (type'EEnum'class + (type'EReference'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EClass'class + (type'ETypedElement'class + type'EPackage'class)))))))))) lone->set (type'EAttribute'class + (type'EEnum'class + (type'EReference'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EClass'class + (type'ETypedElement'class + type'EPackage'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EAttribute'class + (type'EEnum'class + (type'EReference'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EClass'class + (type'ETypedElement'class + type'EPackage'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EAttribute'class + (type'EEnum'class + (type'EReference'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EClass'class + (type'ETypedElement'class + type'EPackage'class))))))))) { child = util'language.util'root || (some parent: type'EAttribute'class + (type'EEnum'class + (type'EReference'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EClass'class + (type'ETypedElement'class + type'EPackage'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EAttribute'class + (type'EEnum'class + (type'EReference'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EClass'class + (type'ETypedElement'class + type'EPackage'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
