...
one sig util'language {
	...
	util'root : one type'ETypedElement'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EPackage'class + (type'EClass'class + type'EReference'class))))))))),
	util'contains : (type'ETypedElement'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EPackage'class + (type'EClass'class + type'EReference'class)))))))))) lone->set (type'ETypedElement'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EPackage'class + (type'EClass'class + type'EReference'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'ETypedElement'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EPackage'class + (type'EClass'class + type'EReference'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'ETypedElement'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EPackage'class + (type'EClass'class + type'EReference'class))))))))) { child = util'language.util'root or (some parent: type'ETypedElement'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EPackage'class + (type'EClass'class + type'EReference'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'ETypedElement'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EPackage'class + (type'EClass'class + type'EReference'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
