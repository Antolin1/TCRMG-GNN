...
one sig util'language {
	...
	util'root : one type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EEnum'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EClass'class + type'EReference'class))))))))),
	util'contains : (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EEnum'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EClass'class + type'EReference'class)))))))))) lone->set (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EEnum'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EClass'class + type'EReference'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EEnum'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EClass'class + type'EReference'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EEnum'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EClass'class + type'EReference'class))))))))) { child = util'language.util'root or (some parent: type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EEnum'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EClass'class + type'EReference'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EEnum'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EClass'class + type'EReference'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
