...
one sig util'language {
	...
	util'root : one type'EPackage'class + (type'EClass'class + (type'EEnum'class + (type'ETypedElement'class + (type'EReference'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EClassifier'class + (type'EStructuralFeature'class + type'EDataType'class))))))))),
	util'contains : (type'EPackage'class + (type'EClass'class + (type'EEnum'class + (type'ETypedElement'class + (type'EReference'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EClassifier'class + (type'EStructuralFeature'class + type'EDataType'class)))))))))) lone->set (type'EPackage'class + (type'EClass'class + (type'EEnum'class + (type'ETypedElement'class + (type'EReference'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EClassifier'class + (type'EStructuralFeature'class + type'EDataType'class))))))))))
}
