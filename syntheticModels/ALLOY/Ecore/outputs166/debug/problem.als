...
one sig util'language {
	...
	util'root : one type'EDataType'class + (type'ENamedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClassifier'class + (type'EClass'class + (type'EEnumLiteral'class + (type'ETypedElement'class + type'EAttribute'class))))))))),
	util'contains : (type'EDataType'class + (type'ENamedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClassifier'class + (type'EClass'class + (type'EEnumLiteral'class + (type'ETypedElement'class + type'EAttribute'class)))))))))) lone->set (type'EDataType'class + (type'ENamedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClassifier'class + (type'EClass'class + (type'EEnumLiteral'class + (type'ETypedElement'class + type'EAttribute'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EDataType'class + (type'ENamedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClassifier'class + (type'EClass'class + (type'EEnumLiteral'class + (type'ETypedElement'class + type'EAttribute'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EDataType'class + (type'ENamedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClassifier'class + (type'EClass'class + (type'EEnumLiteral'class + (type'ETypedElement'class + type'EAttribute'class))))))))) { child = util'language.util'root || (some parent: type'EDataType'class + (type'ENamedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClassifier'class + (type'EClass'class + (type'EEnumLiteral'class + (type'ETypedElement'class + type'EAttribute'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EDataType'class + (type'ENamedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClassifier'class + (type'EClass'class + (type'EEnumLiteral'class + (type'ETypedElement'class + type'EAttribute'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
