...
one sig util'language {
	...
	util'root : one type'ETypedElement'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EAttribute'class + (type'EPackage'class + type'EEnum'class))))))))),
	util'contains : (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EAttribute'class + (type'EPackage'class + type'EEnum'class)))))))))) lone->set (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EAttribute'class + (type'EPackage'class + type'EEnum'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'ETypedElement'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EAttribute'class + (type'EPackage'class + type'EEnum'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'ETypedElement'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EAttribute'class + (type'EPackage'class + type'EEnum'class))))))))) { child = util'language.util'root || (some parent: type'ETypedElement'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EAttribute'class + (type'EPackage'class + type'EEnum'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'ETypedElement'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EAttribute'class + (type'EPackage'class + type'EEnum'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
