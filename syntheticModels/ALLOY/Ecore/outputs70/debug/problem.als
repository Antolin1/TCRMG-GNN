...
one sig util'language {
	...
	util'root : one type'EEnumLiteral'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EDataType'class + type'EClassifier'class))))))))),
	util'contains : (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EDataType'class + type'EClassifier'class)))))))))) lone->set (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EDataType'class + type'EClassifier'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EEnumLiteral'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EDataType'class + type'EClassifier'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EEnumLiteral'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EDataType'class + type'EClassifier'class))))))))) { child = util'language.util'root || (some parent: type'EEnumLiteral'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EDataType'class + type'EClassifier'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EEnumLiteral'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EDataType'class + type'EClassifier'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
