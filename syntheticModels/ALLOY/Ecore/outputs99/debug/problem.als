...
one sig util'language {
	...
	util'root : one type'EAttribute'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EDataType'class + (type'ETypedElement'class + (type'EReference'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EClassifier'class + type'EClass'class))))))))),
	util'contains : (type'EAttribute'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EDataType'class + (type'ETypedElement'class + (type'EReference'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EClassifier'class + type'EClass'class)))))))))) lone->set (type'EAttribute'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EDataType'class + (type'ETypedElement'class + (type'EReference'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EClassifier'class + type'EClass'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EAttribute'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EDataType'class + (type'ETypedElement'class + (type'EReference'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EClassifier'class + type'EClass'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EAttribute'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EDataType'class + (type'ETypedElement'class + (type'EReference'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EClassifier'class + type'EClass'class))))))))) { child = util'language.util'root or (some parent: type'EAttribute'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EDataType'class + (type'ETypedElement'class + (type'EReference'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EClassifier'class + type'EClass'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EAttribute'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EDataType'class + (type'ETypedElement'class + (type'EReference'class + (type'EPackage'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EClassifier'class + type'EClass'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
