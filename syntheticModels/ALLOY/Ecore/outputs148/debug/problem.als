...
one sig util'language {
	...
	util'root : one type'EStructuralFeature'class + (type'EDataType'class + (type'EAttribute'class + (type'EClassifier'class + (type'EEnum'class + (type'EReference'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EClass'class + type'EPackage'class))))))))),
	util'contains : (type'EStructuralFeature'class + (type'EDataType'class + (type'EAttribute'class + (type'EClassifier'class + (type'EEnum'class + (type'EReference'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EClass'class + type'EPackage'class)))))))))) lone->set (type'EStructuralFeature'class + (type'EDataType'class + (type'EAttribute'class + (type'EClassifier'class + (type'EEnum'class + (type'EReference'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EClass'class + type'EPackage'class))))))))))
}
