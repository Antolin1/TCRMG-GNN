...
one sig util'language {
	...
	util'root : one type'EReference'class + (type'EClass'class + (type'EDataType'class + (type'EClassifier'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EAttribute'class + type'EPackage'class))))))))),
	util'contains : (type'EReference'class + (type'EClass'class + (type'EDataType'class + (type'EClassifier'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EAttribute'class + type'EPackage'class)))))))))) lone->set (type'EReference'class + (type'EClass'class + (type'EDataType'class + (type'EClassifier'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EAttribute'class + type'EPackage'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EReference'class + (type'EClass'class + (type'EDataType'class + (type'EClassifier'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EAttribute'class + type'EPackage'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EReference'class + (type'EClass'class + (type'EDataType'class + (type'EClassifier'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EAttribute'class + type'EPackage'class))))))))) { child = util'language.util'root or (some parent: type'EReference'class + (type'EClass'class + (type'EDataType'class + (type'EClassifier'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EAttribute'class + type'EPackage'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EReference'class + (type'EClass'class + (type'EDataType'class + (type'EClassifier'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EAttribute'class + type'EPackage'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
