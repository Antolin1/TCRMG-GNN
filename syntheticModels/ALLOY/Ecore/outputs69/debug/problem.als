...
one sig util'language {
	...
	util'root : one type'ENamedElement'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'ETypedElement'class + (type'EStructuralFeature'class + type'EClass'class))))))))),
	util'contains : (type'ENamedElement'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'ETypedElement'class + (type'EStructuralFeature'class + type'EClass'class)))))))))) lone->set (type'ENamedElement'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'ETypedElement'class + (type'EStructuralFeature'class + type'EClass'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'ENamedElement'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'ETypedElement'class + (type'EStructuralFeature'class + type'EClass'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'ENamedElement'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'ETypedElement'class + (type'EStructuralFeature'class + type'EClass'class))))))))) { child = util'language.util'root or (some parent: type'ENamedElement'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'ETypedElement'class + (type'EStructuralFeature'class + type'EClass'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'ENamedElement'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'ETypedElement'class + (type'EStructuralFeature'class + type'EClass'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
