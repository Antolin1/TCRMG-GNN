...
one sig util'language {
	...
	util'root : one type'ENamedElement'class + (type'EClassifier'class + (type'EAttribute'class + (type'EDataType'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EPackage'class + (type'EClass'class + (type'ETypedElement'class + type'EEnumLiteral'class))))))))),
	util'contains : (type'ENamedElement'class + (type'EClassifier'class + (type'EAttribute'class + (type'EDataType'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EPackage'class + (type'EClass'class + (type'ETypedElement'class + type'EEnumLiteral'class)))))))))) lone->set (type'ENamedElement'class + (type'EClassifier'class + (type'EAttribute'class + (type'EDataType'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EPackage'class + (type'EClass'class + (type'ETypedElement'class + type'EEnumLiteral'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'ENamedElement'class + (type'EClassifier'class + (type'EAttribute'class + (type'EDataType'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EPackage'class + (type'EClass'class + (type'ETypedElement'class + type'EEnumLiteral'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'ENamedElement'class + (type'EClassifier'class + (type'EAttribute'class + (type'EDataType'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EPackage'class + (type'EClass'class + (type'ETypedElement'class + type'EEnumLiteral'class))))))))) { child = util'language.util'root or (some parent: type'ENamedElement'class + (type'EClassifier'class + (type'EAttribute'class + (type'EDataType'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EPackage'class + (type'EClass'class + (type'ETypedElement'class + type'EEnumLiteral'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'ENamedElement'class + (type'EClassifier'class + (type'EAttribute'class + (type'EDataType'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EPackage'class + (type'EClass'class + (type'ETypedElement'class + type'EEnumLiteral'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
