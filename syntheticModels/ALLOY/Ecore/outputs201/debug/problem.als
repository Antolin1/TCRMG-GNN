...
one sig util'language {
	...
	util'root : one type'EReference'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EClass'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EPackage'class + (type'EClassifier'class + (type'EDataType'class + type'EEnumLiteral'class))))))))),
	util'contains : (type'EReference'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EClass'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EPackage'class + (type'EClassifier'class + (type'EDataType'class + type'EEnumLiteral'class)))))))))) lone->set (type'EReference'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EClass'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EPackage'class + (type'EClassifier'class + (type'EDataType'class + type'EEnumLiteral'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EReference'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EClass'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EPackage'class + (type'EClassifier'class + (type'EDataType'class + type'EEnumLiteral'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EReference'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EClass'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EPackage'class + (type'EClassifier'class + (type'EDataType'class + type'EEnumLiteral'class))))))))) { child = util'language.util'root or (some parent: type'EReference'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EClass'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EPackage'class + (type'EClassifier'class + (type'EDataType'class + type'EEnumLiteral'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EReference'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EClass'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EPackage'class + (type'EClassifier'class + (type'EDataType'class + type'EEnumLiteral'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
