...
one sig util'language {
	...
	util'root : one type'EClassifier'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EPackage'class + (type'EAttribute'class + (type'EEnum'class + type'EClass'class))))))))),
	util'contains : (type'EClassifier'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EPackage'class + (type'EAttribute'class + (type'EEnum'class + type'EClass'class)))))))))) lone->set (type'EClassifier'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EPackage'class + (type'EAttribute'class + (type'EEnum'class + type'EClass'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EClassifier'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EPackage'class + (type'EAttribute'class + (type'EEnum'class + type'EClass'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EClassifier'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EPackage'class + (type'EAttribute'class + (type'EEnum'class + type'EClass'class))))))))) { child = util'language.util'root or (some parent: type'EClassifier'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EPackage'class + (type'EAttribute'class + (type'EEnum'class + type'EClass'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EClassifier'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EPackage'class + (type'EAttribute'class + (type'EEnum'class + type'EClass'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
