...
one sig util'language {
	...
	util'root : one type'EClassifier'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EAttribute'class + (type'EClass'class + (type'EDataType'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EPackage'class + type'EReference'class))))))))),
	util'contains : (type'EClassifier'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EAttribute'class + (type'EClass'class + (type'EDataType'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EPackage'class + type'EReference'class)))))))))) lone->set (type'EClassifier'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EAttribute'class + (type'EClass'class + (type'EDataType'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EPackage'class + type'EReference'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EClassifier'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EAttribute'class + (type'EClass'class + (type'EDataType'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EPackage'class + type'EReference'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EClassifier'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EAttribute'class + (type'EClass'class + (type'EDataType'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EPackage'class + type'EReference'class))))))))) { child = util'language.util'root || (some parent: type'EClassifier'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EAttribute'class + (type'EClass'class + (type'EDataType'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EPackage'class + type'EReference'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EClassifier'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EAttribute'class + (type'EClass'class + (type'EDataType'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EPackage'class + type'EReference'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
