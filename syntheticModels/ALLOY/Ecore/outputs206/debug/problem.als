...
one sig util'language {
	...
	util'root : one type'ETypedElement'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EReference'class + (type'EEnum'class + (type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + (type'EStructuralFeature'class + type'EClass'class))))))))),
	util'contains : (type'ETypedElement'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EReference'class + (type'EEnum'class + (type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + (type'EStructuralFeature'class + type'EClass'class)))))))))) lone->set (type'ETypedElement'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EReference'class + (type'EEnum'class + (type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + (type'EStructuralFeature'class + type'EClass'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'ETypedElement'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EReference'class + (type'EEnum'class + (type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + (type'EStructuralFeature'class + type'EClass'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'ETypedElement'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EReference'class + (type'EEnum'class + (type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + (type'EStructuralFeature'class + type'EClass'class))))))))) { child = util'language.util'root || (some parent: type'ETypedElement'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EReference'class + (type'EEnum'class + (type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + (type'EStructuralFeature'class + type'EClass'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'ETypedElement'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EReference'class + (type'EEnum'class + (type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + (type'EStructuralFeature'class + type'EClass'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
