...
one sig util'language {
	...
	util'root : one type'ENamedElement'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EPackage'class + (type'EAttribute'class + (type'EClassifier'class + (type'EEnum'class + (type'EReference'class + type'EClass'class))))))))),
	util'contains : (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EPackage'class + (type'EAttribute'class + (type'EClassifier'class + (type'EEnum'class + (type'EReference'class + type'EClass'class)))))))))) lone->set (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EPackage'class + (type'EAttribute'class + (type'EClassifier'class + (type'EEnum'class + (type'EReference'class + type'EClass'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'ENamedElement'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EPackage'class + (type'EAttribute'class + (type'EClassifier'class + (type'EEnum'class + (type'EReference'class + type'EClass'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'ENamedElement'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EPackage'class + (type'EAttribute'class + (type'EClassifier'class + (type'EEnum'class + (type'EReference'class + type'EClass'class))))))))) { child = util'language.util'root || (some parent: type'ENamedElement'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EPackage'class + (type'EAttribute'class + (type'EClassifier'class + (type'EEnum'class + (type'EReference'class + type'EClass'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'ENamedElement'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EPackage'class + (type'EAttribute'class + (type'EClassifier'class + (type'EEnum'class + (type'EReference'class + type'EClass'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
