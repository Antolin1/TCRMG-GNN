...
one sig util'language {
	...
	util'root : one type'EClass'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EEnum'class + (type'EReference'class + type'EDataType'class))))))))),
	util'contains : (type'EClass'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EEnum'class + (type'EReference'class + type'EDataType'class)))))))))) lone->set (type'EClass'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EEnum'class + (type'EReference'class + type'EDataType'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EClass'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EEnum'class + (type'EReference'class + type'EDataType'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EClass'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EEnum'class + (type'EReference'class + type'EDataType'class))))))))) { child = util'language.util'root or (some parent: type'EClass'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EEnum'class + (type'EReference'class + type'EDataType'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EClass'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EEnum'class + (type'EReference'class + type'EDataType'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
