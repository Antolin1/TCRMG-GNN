...
one sig util'language {
	...
	util'root : one type'EStructuralFeature'class + (type'ENamedElement'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'EEnum'class + (type'EClass'class + (type'EAttribute'class + (type'EClassifier'class + (type'ETypedElement'class + type'EEnumLiteral'class))))))))),
	util'contains : (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'EEnum'class + (type'EClass'class + (type'EAttribute'class + (type'EClassifier'class + (type'ETypedElement'class + type'EEnumLiteral'class)))))))))) lone->set (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'EEnum'class + (type'EClass'class + (type'EAttribute'class + (type'EClassifier'class + (type'ETypedElement'class + type'EEnumLiteral'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EStructuralFeature'class + (type'ENamedElement'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'EEnum'class + (type'EClass'class + (type'EAttribute'class + (type'EClassifier'class + (type'ETypedElement'class + type'EEnumLiteral'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EStructuralFeature'class + (type'ENamedElement'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'EEnum'class + (type'EClass'class + (type'EAttribute'class + (type'EClassifier'class + (type'ETypedElement'class + type'EEnumLiteral'class))))))))) { child = util'language.util'root || (some parent: type'EStructuralFeature'class + (type'ENamedElement'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'EEnum'class + (type'EClass'class + (type'EAttribute'class + (type'EClassifier'class + (type'ETypedElement'class + type'EEnumLiteral'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EStructuralFeature'class + (type'ENamedElement'class + (type'EReference'class + (type'EPackage'class + (type'EDataType'class + (type'EEnum'class + (type'EClass'class + (type'EAttribute'class + (type'EClassifier'class + (type'ETypedElement'class + type'EEnumLiteral'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
...
run { } for exactly 26 util'Object , 2 Int , exactly 0 String