...
one sig util'language {
	...
	util'root : one type'EPackage'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EDataType'class + (type'EClassifier'class + type'EEnumLiteral'class))))))))),
	util'contains : (type'EPackage'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EDataType'class + (type'EClassifier'class + type'EEnumLiteral'class)))))))))) lone->set (type'EPackage'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EDataType'class + (type'EClassifier'class + type'EEnumLiteral'class))))))))))
}
