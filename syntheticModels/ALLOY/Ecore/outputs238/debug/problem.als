...
one sig util'language {
	...
	util'root : one type'EDataType'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'ETypedElement'class + type'EEnum'class))))))))),
	util'contains : (type'EDataType'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'ETypedElement'class + type'EEnum'class)))))))))) lone->set (type'EDataType'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'ETypedElement'class + type'EEnum'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EDataType'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'ETypedElement'class + type'EEnum'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EDataType'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'ETypedElement'class + type'EEnum'class))))))))) { child = util'language.util'root || (some parent: type'EDataType'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'ETypedElement'class + type'EEnum'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EDataType'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'ETypedElement'class + type'EEnum'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
