...
one sig util'language {
	...
	util'root : one type'EAttribute'class + (type'EDataType'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EPackage'class + (type'EEnumLiteral'class + type'EEnum'class))))))))),
	util'contains : (type'EAttribute'class + (type'EDataType'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EPackage'class + (type'EEnumLiteral'class + type'EEnum'class)))))))))) lone->set (type'EAttribute'class + (type'EDataType'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EPackage'class + (type'EEnumLiteral'class + type'EEnum'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EAttribute'class + (type'EDataType'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EPackage'class + (type'EEnumLiteral'class + type'EEnum'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EAttribute'class + (type'EDataType'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EPackage'class + (type'EEnumLiteral'class + type'EEnum'class))))))))) { child = util'language.util'root or (some parent: type'EAttribute'class + (type'EDataType'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EPackage'class + (type'EEnumLiteral'class + type'EEnum'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EAttribute'class + (type'EDataType'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EPackage'class + (type'EEnumLiteral'class + type'EEnum'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
