...
one sig util'language {
	...
	util'root : one type'ETypedElement'class + (type'EAttribute'class + (type'EClass'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EPackage'class + type'EDataType'class))))))))),
	util'contains : (type'ETypedElement'class + (type'EAttribute'class + (type'EClass'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EPackage'class + type'EDataType'class)))))))))) lone->set (type'ETypedElement'class + (type'EAttribute'class + (type'EClass'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EPackage'class + type'EDataType'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'ETypedElement'class + (type'EAttribute'class + (type'EClass'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EPackage'class + type'EDataType'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'ETypedElement'class + (type'EAttribute'class + (type'EClass'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EPackage'class + type'EDataType'class))))))))) { child = util'language.util'root || (some parent: type'ETypedElement'class + (type'EAttribute'class + (type'EClass'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EPackage'class + type'EDataType'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'ETypedElement'class + (type'EAttribute'class + (type'EClass'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EPackage'class + type'EDataType'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
