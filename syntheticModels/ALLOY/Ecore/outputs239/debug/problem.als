...
one sig util'language {
	...
	util'root : one type'EDataType'class + (type'EClass'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'ENamedElement'class + type'ETypedElement'class))))))))),
	util'contains : (type'EDataType'class + (type'EClass'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'ENamedElement'class + type'ETypedElement'class)))))))))) lone->set (type'EDataType'class + (type'EClass'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'ENamedElement'class + type'ETypedElement'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EDataType'class + (type'EClass'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'ENamedElement'class + type'ETypedElement'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EDataType'class + (type'EClass'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'ENamedElement'class + type'ETypedElement'class))))))))) { child = util'language.util'root || (some parent: type'EDataType'class + (type'EClass'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'ENamedElement'class + type'ETypedElement'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EDataType'class + (type'EClass'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'ENamedElement'class + type'ETypedElement'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
