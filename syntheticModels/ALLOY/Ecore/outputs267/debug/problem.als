...
one sig util'language {
	...
	util'root : one type'EAttribute'class + (type'EClass'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EPackage'class + (type'EDataType'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EReference'class + type'EStructuralFeature'class))))))))),
	util'contains : (type'EAttribute'class + (type'EClass'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EPackage'class + (type'EDataType'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EReference'class + type'EStructuralFeature'class)))))))))) lone->set (type'EAttribute'class + (type'EClass'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EPackage'class + (type'EDataType'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EReference'class + type'EStructuralFeature'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EAttribute'class + (type'EClass'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EPackage'class + (type'EDataType'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EReference'class + type'EStructuralFeature'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EAttribute'class + (type'EClass'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EPackage'class + (type'EDataType'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EReference'class + type'EStructuralFeature'class))))))))) { child = util'language.util'root or (some parent: type'EAttribute'class + (type'EClass'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EPackage'class + (type'EDataType'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EReference'class + type'EStructuralFeature'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EAttribute'class + (type'EClass'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EPackage'class + (type'EDataType'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EReference'class + type'EStructuralFeature'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
