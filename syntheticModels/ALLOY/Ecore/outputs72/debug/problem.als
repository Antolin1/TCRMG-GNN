...
one sig util'language {
	...
	util'root : one type'EEnumLiteral'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EEnum'class + (type'EClass'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EDataType'class + (type'EReference'class + (type'EPackage'class + type'EClassifier'class))))))))),
	util'contains : (type'EEnumLiteral'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EEnum'class + (type'EClass'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EDataType'class + (type'EReference'class + (type'EPackage'class + type'EClassifier'class)))))))))) lone->set (type'EEnumLiteral'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EEnum'class + (type'EClass'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EDataType'class + (type'EReference'class + (type'EPackage'class + type'EClassifier'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EEnumLiteral'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EEnum'class + (type'EClass'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EDataType'class + (type'EReference'class + (type'EPackage'class + type'EClassifier'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EEnumLiteral'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EEnum'class + (type'EClass'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EDataType'class + (type'EReference'class + (type'EPackage'class + type'EClassifier'class))))))))) { child = util'language.util'root or (some parent: type'EEnumLiteral'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EEnum'class + (type'EClass'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EDataType'class + (type'EReference'class + (type'EPackage'class + type'EClassifier'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EEnumLiteral'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EEnum'class + (type'EClass'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EDataType'class + (type'EReference'class + (type'EPackage'class + type'EClassifier'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
