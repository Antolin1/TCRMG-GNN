...
one sig util'language {
	...
	util'root : one type'EPackage'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EClassifier'class + type'EAttribute'class))))))))),
	util'contains : (type'EPackage'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EClassifier'class + type'EAttribute'class)))))))))) lone->set (type'EPackage'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EClassifier'class + type'EAttribute'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EPackage'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EClassifier'class + type'EAttribute'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EPackage'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EClassifier'class + type'EAttribute'class))))))))) { child = util'language.util'root or (some parent: type'EPackage'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EClassifier'class + type'EAttribute'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EPackage'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EClassifier'class + type'EAttribute'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
