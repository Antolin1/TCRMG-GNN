...
one sig util'language {
	...
	util'root : one type'EEnumLiteral'class + (type'EDataType'class + (type'EAttribute'class + (type'EEnum'class + (type'ENamedElement'class + (type'EReference'class + (type'EPackage'class + (type'EClass'class + (type'EClassifier'class + (type'EStructuralFeature'class + type'ETypedElement'class))))))))),
	util'contains : (type'EEnumLiteral'class + (type'EDataType'class + (type'EAttribute'class + (type'EEnum'class + (type'ENamedElement'class + (type'EReference'class + (type'EPackage'class + (type'EClass'class + (type'EClassifier'class + (type'EStructuralFeature'class + type'ETypedElement'class)))))))))) lone->set (type'EEnumLiteral'class + (type'EDataType'class + (type'EAttribute'class + (type'EEnum'class + (type'ENamedElement'class + (type'EReference'class + (type'EPackage'class + (type'EClass'class + (type'EClassifier'class + (type'EStructuralFeature'class + type'ETypedElement'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EEnumLiteral'class + (type'EDataType'class + (type'EAttribute'class + (type'EEnum'class + (type'ENamedElement'class + (type'EReference'class + (type'EPackage'class + (type'EClass'class + (type'EClassifier'class + (type'EStructuralFeature'class + type'ETypedElement'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EEnumLiteral'class + (type'EDataType'class + (type'EAttribute'class + (type'EEnum'class + (type'ENamedElement'class + (type'EReference'class + (type'EPackage'class + (type'EClass'class + (type'EClassifier'class + (type'EStructuralFeature'class + type'ETypedElement'class))))))))) { child = util'language.util'root || (some parent: type'EEnumLiteral'class + (type'EDataType'class + (type'EAttribute'class + (type'EEnum'class + (type'ENamedElement'class + (type'EReference'class + (type'EPackage'class + (type'EClass'class + (type'EClassifier'class + (type'EStructuralFeature'class + type'ETypedElement'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EEnumLiteral'class + (type'EDataType'class + (type'EAttribute'class + (type'EEnum'class + (type'ENamedElement'class + (type'EReference'class + (type'EPackage'class + (type'EClass'class + (type'EClassifier'class + (type'EStructuralFeature'class + type'ETypedElement'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
