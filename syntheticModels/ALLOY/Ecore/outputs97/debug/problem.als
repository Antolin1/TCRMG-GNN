...
one sig util'language {
	...
	util'root : one type'EReference'class + (type'EClass'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EDataType'class + (type'EPackage'class + (type'EEnum'class + type'EClassifier'class))))))))),
	util'contains : (type'EReference'class + (type'EClass'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EDataType'class + (type'EPackage'class + (type'EEnum'class + type'EClassifier'class)))))))))) lone->set (type'EReference'class + (type'EClass'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EDataType'class + (type'EPackage'class + (type'EEnum'class + type'EClassifier'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EReference'class + (type'EClass'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EDataType'class + (type'EPackage'class + (type'EEnum'class + type'EClassifier'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EReference'class + (type'EClass'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EDataType'class + (type'EPackage'class + (type'EEnum'class + type'EClassifier'class))))))))) { child = util'language.util'root or (some parent: type'EReference'class + (type'EClass'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EDataType'class + (type'EPackage'class + (type'EEnum'class + type'EClassifier'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EReference'class + (type'EClass'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EDataType'class + (type'EPackage'class + (type'EEnum'class + type'EClassifier'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
