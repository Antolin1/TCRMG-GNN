...
one sig util'language {
	...
	util'root : one type'EClass'class + (type'EClassifier'class + (type'EPackage'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + type'EAttribute'class))))))))),
	util'contains : (type'EClass'class + (type'EClassifier'class + (type'EPackage'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + type'EAttribute'class)))))))))) lone->set (type'EClass'class + (type'EClassifier'class + (type'EPackage'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + type'EAttribute'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EClass'class + (type'EClassifier'class + (type'EPackage'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + type'EAttribute'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EClass'class + (type'EClassifier'class + (type'EPackage'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + type'EAttribute'class))))))))) { child = util'language.util'root or (some parent: type'EClass'class + (type'EClassifier'class + (type'EPackage'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + type'EAttribute'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EClass'class + (type'EClassifier'class + (type'EPackage'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + type'EAttribute'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
