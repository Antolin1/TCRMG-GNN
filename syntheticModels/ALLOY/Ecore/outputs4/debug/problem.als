...
one sig util'language {
	...
	util'root : one type'EPackage'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EReference'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EClass'class + (type'ETypedElement'class + type'EEnum'class))))))))),
	util'contains : (type'EPackage'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EReference'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EClass'class + (type'ETypedElement'class + type'EEnum'class)))))))))) lone->set (type'EPackage'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EReference'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EClass'class + (type'ETypedElement'class + type'EEnum'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EPackage'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EReference'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EClass'class + (type'ETypedElement'class + type'EEnum'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EPackage'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EReference'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EClass'class + (type'ETypedElement'class + type'EEnum'class))))))))) { child = util'language.util'root || (some parent: type'EPackage'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EReference'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EClass'class + (type'ETypedElement'class + type'EEnum'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EPackage'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EReference'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EClass'class + (type'ETypedElement'class + type'EEnum'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
