...
one sig util'language {
	...
	util'root : one type'ENamedElement'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EPackage'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EReference'class + (type'EDataType'class + (type'EClassifier'class + type'ETypedElement'class))))))))),
	util'contains : (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EPackage'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EReference'class + (type'EDataType'class + (type'EClassifier'class + type'ETypedElement'class)))))))))) lone->set (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EPackage'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EReference'class + (type'EDataType'class + (type'EClassifier'class + type'ETypedElement'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'ENamedElement'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EPackage'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EReference'class + (type'EDataType'class + (type'EClassifier'class + type'ETypedElement'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'ENamedElement'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EPackage'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EReference'class + (type'EDataType'class + (type'EClassifier'class + type'ETypedElement'class))))))))) { child = util'language.util'root or (some parent: type'ENamedElement'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EPackage'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EReference'class + (type'EDataType'class + (type'EClassifier'class + type'ETypedElement'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'ENamedElement'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EPackage'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EReference'class + (type'EDataType'class + (type'EClassifier'class + type'ETypedElement'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
