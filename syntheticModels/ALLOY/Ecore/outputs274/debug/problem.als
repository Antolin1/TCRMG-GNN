...
one sig util'language {
	...
	util'root : one type'ENamedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EReference'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EClassifier'class + (type'EEnum'class + (type'EEnumLiteral'class + type'ETypedElement'class))))))))),
	util'contains : (type'ENamedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EReference'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EClassifier'class + (type'EEnum'class + (type'EEnumLiteral'class + type'ETypedElement'class)))))))))) lone->set (type'ENamedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EReference'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EClassifier'class + (type'EEnum'class + (type'EEnumLiteral'class + type'ETypedElement'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'ENamedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EReference'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EClassifier'class + (type'EEnum'class + (type'EEnumLiteral'class + type'ETypedElement'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'ENamedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EReference'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EClassifier'class + (type'EEnum'class + (type'EEnumLiteral'class + type'ETypedElement'class))))))))) { child = util'language.util'root || (some parent: type'ENamedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EReference'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EClassifier'class + (type'EEnum'class + (type'EEnumLiteral'class + type'ETypedElement'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'ENamedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EReference'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EClassifier'class + (type'EEnum'class + (type'EEnumLiteral'class + type'ETypedElement'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
