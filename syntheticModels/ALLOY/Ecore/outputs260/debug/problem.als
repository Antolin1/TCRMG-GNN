...
one sig util'language {
	...
	util'root : one type'EStructuralFeature'class + (type'ENamedElement'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'EEnum'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EPackage'class + (type'ETypedElement'class + type'EDataType'class))))))))),
	util'contains : (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'EEnum'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EPackage'class + (type'ETypedElement'class + type'EDataType'class)))))))))) lone->set (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'EEnum'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EPackage'class + (type'ETypedElement'class + type'EDataType'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EStructuralFeature'class + (type'ENamedElement'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'EEnum'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EPackage'class + (type'ETypedElement'class + type'EDataType'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EStructuralFeature'class + (type'ENamedElement'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'EEnum'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EPackage'class + (type'ETypedElement'class + type'EDataType'class))))))))) { child = util'language.util'root or (some parent: type'EStructuralFeature'class + (type'ENamedElement'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'EEnum'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EPackage'class + (type'ETypedElement'class + type'EDataType'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EStructuralFeature'class + (type'ENamedElement'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'EEnum'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EPackage'class + (type'ETypedElement'class + type'EDataType'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
