...
one sig util'language {
	...
	util'root : one type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EReference'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + type'EPackage'class))))))))),
	util'contains : (type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EReference'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + type'EPackage'class)))))))))) lone->set (type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EReference'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + type'EPackage'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EReference'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + type'EPackage'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EReference'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + type'EPackage'class))))))))) { child = util'language.util'root || (some parent: type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EReference'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + type'EPackage'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EReference'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + type'EPackage'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
