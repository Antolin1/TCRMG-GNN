...
one sig util'language {
	...
	util'root : one type'EClass'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EEnum'class + (type'EReference'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EDataType'class + type'EPackage'class))))))))),
	util'contains : (type'EClass'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EEnum'class + (type'EReference'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EDataType'class + type'EPackage'class)))))))))) lone->set (type'EClass'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EEnum'class + (type'EReference'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EDataType'class + type'EPackage'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EClass'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EEnum'class + (type'EReference'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EDataType'class + type'EPackage'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EClass'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EEnum'class + (type'EReference'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EDataType'class + type'EPackage'class))))))))) { child = util'language.util'root or (some parent: type'EClass'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EEnum'class + (type'EReference'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EDataType'class + type'EPackage'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EClass'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EEnum'class + (type'EReference'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EDataType'class + type'EPackage'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
