...
one sig util'language {
	...
	util'root : one type'ETypedElement'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EReference'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EEnum'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EClass'class + type'EAttribute'class))))))))),
	util'contains : (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EReference'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EEnum'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EClass'class + type'EAttribute'class)))))))))) lone->set (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EReference'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EEnum'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EClass'class + type'EAttribute'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'ETypedElement'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EReference'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EEnum'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EClass'class + type'EAttribute'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'ETypedElement'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EReference'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EEnum'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EClass'class + type'EAttribute'class))))))))) { child = util'language.util'root or (some parent: type'ETypedElement'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EReference'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EEnum'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EClass'class + type'EAttribute'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'ETypedElement'class + (type'EStructuralFeature'class + (type'EPackage'class + (type'EReference'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EEnum'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EClass'class + type'EAttribute'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
