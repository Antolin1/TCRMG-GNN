...
one sig util'language {
	...
	util'root : one type'EPackage'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClass'class + (type'ETypedElement'class + type'EReference'class))))))))),
	util'contains : (type'EPackage'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClass'class + (type'ETypedElement'class + type'EReference'class)))))))))) lone->set (type'EPackage'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClass'class + (type'ETypedElement'class + type'EReference'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EPackage'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClass'class + (type'ETypedElement'class + type'EReference'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EPackage'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClass'class + (type'ETypedElement'class + type'EReference'class))))))))) { child = util'language.util'root || (some parent: type'EPackage'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClass'class + (type'ETypedElement'class + type'EReference'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EPackage'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClass'class + (type'ETypedElement'class + type'EReference'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
