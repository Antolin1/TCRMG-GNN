...
one sig util'language {
	...
	util'root : one type'ENamedElement'class + (type'EClass'class + (type'EReference'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + type'EEnum'class))))))))),
	util'contains : (type'ENamedElement'class + (type'EClass'class + (type'EReference'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + type'EEnum'class)))))))))) lone->set (type'ENamedElement'class + (type'EClass'class + (type'EReference'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + type'EEnum'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'ENamedElement'class + (type'EClass'class + (type'EReference'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + type'EEnum'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'ENamedElement'class + (type'EClass'class + (type'EReference'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + type'EEnum'class))))))))) { child = util'language.util'root or (some parent: type'ENamedElement'class + (type'EClass'class + (type'EReference'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + type'EEnum'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'ENamedElement'class + (type'EClass'class + (type'EReference'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + type'EEnum'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
