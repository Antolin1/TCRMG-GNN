...
one sig util'language {
	...
	util'root : one type'EClassifier'class + (type'ENamedElement'class + (type'EClass'class + (type'EDataType'class + (type'EReference'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EPackage'class + type'EAttribute'class))))))))),
	util'contains : (type'EClassifier'class + (type'ENamedElement'class + (type'EClass'class + (type'EDataType'class + (type'EReference'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EPackage'class + type'EAttribute'class)))))))))) lone->set (type'EClassifier'class + (type'ENamedElement'class + (type'EClass'class + (type'EDataType'class + (type'EReference'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EPackage'class + type'EAttribute'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EClassifier'class + (type'ENamedElement'class + (type'EClass'class + (type'EDataType'class + (type'EReference'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EPackage'class + type'EAttribute'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EClassifier'class + (type'ENamedElement'class + (type'EClass'class + (type'EDataType'class + (type'EReference'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EPackage'class + type'EAttribute'class))))))))) { child = util'language.util'root or (some parent: type'EClassifier'class + (type'ENamedElement'class + (type'EClass'class + (type'EDataType'class + (type'EReference'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EPackage'class + type'EAttribute'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EClassifier'class + (type'ENamedElement'class + (type'EClass'class + (type'EDataType'class + (type'EReference'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EPackage'class + type'EAttribute'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
