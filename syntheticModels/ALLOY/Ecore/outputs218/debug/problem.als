...
one sig util'language {
	...
	util'root : one type'ENamedElement'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EReference'class + (type'EPackage'class + (type'EClassifier'class + (type'EEnum'class + (type'EClass'class + type'EDataType'class))))))))),
	util'contains : (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EReference'class + (type'EPackage'class + (type'EClassifier'class + (type'EEnum'class + (type'EClass'class + type'EDataType'class)))))))))) lone->set (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EReference'class + (type'EPackage'class + (type'EClassifier'class + (type'EEnum'class + (type'EClass'class + type'EDataType'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'ENamedElement'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EReference'class + (type'EPackage'class + (type'EClassifier'class + (type'EEnum'class + (type'EClass'class + type'EDataType'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'ENamedElement'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EReference'class + (type'EPackage'class + (type'EClassifier'class + (type'EEnum'class + (type'EClass'class + type'EDataType'class))))))))) { child = util'language.util'root || (some parent: type'ENamedElement'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EReference'class + (type'EPackage'class + (type'EClassifier'class + (type'EEnum'class + (type'EClass'class + type'EDataType'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'ENamedElement'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ETypedElement'class + (type'EReference'class + (type'EPackage'class + (type'EClassifier'class + (type'EEnum'class + (type'EClass'class + type'EDataType'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
