...
one sig util'language {
	...
	util'root : one type'ENamedElement'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EPackage'class + (type'EEnum'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EDataType'class + type'EReference'class))))))))),
	util'contains : (type'ENamedElement'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EPackage'class + (type'EEnum'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EDataType'class + type'EReference'class)))))))))) lone->set (type'ENamedElement'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EPackage'class + (type'EEnum'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EDataType'class + type'EReference'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'ENamedElement'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EPackage'class + (type'EEnum'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EDataType'class + type'EReference'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'ENamedElement'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EPackage'class + (type'EEnum'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EDataType'class + type'EReference'class))))))))) { child = util'language.util'root or (some parent: type'ENamedElement'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EPackage'class + (type'EEnum'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EDataType'class + type'EReference'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'ENamedElement'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EPackage'class + (type'EEnum'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EDataType'class + type'EReference'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
