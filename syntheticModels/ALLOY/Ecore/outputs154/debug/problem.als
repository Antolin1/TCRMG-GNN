...
one sig util'language {
	...
	util'root : one type'EReference'class + (type'ENamedElement'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EAttribute'class + type'EDataType'class))))))))),
	util'contains : (type'EReference'class + (type'ENamedElement'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EAttribute'class + type'EDataType'class)))))))))) lone->set (type'EReference'class + (type'ENamedElement'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EAttribute'class + type'EDataType'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EReference'class + (type'ENamedElement'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EAttribute'class + type'EDataType'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EReference'class + (type'ENamedElement'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EAttribute'class + type'EDataType'class))))))))) { child = util'language.util'root or (some parent: type'EReference'class + (type'ENamedElement'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EAttribute'class + type'EDataType'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EReference'class + (type'ENamedElement'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EAttribute'class + type'EDataType'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
