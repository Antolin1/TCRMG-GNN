...
one sig util'language {
	...
	util'root : one type'EClass'class + (type'EReference'class + (type'ENamedElement'class + (type'EEnum'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + type'EEnumLiteral'class))))))))),
	util'contains : (type'EClass'class + (type'EReference'class + (type'ENamedElement'class + (type'EEnum'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + type'EEnumLiteral'class)))))))))) lone->set (type'EClass'class + (type'EReference'class + (type'ENamedElement'class + (type'EEnum'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + type'EEnumLiteral'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EClass'class + (type'EReference'class + (type'ENamedElement'class + (type'EEnum'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + type'EEnumLiteral'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EClass'class + (type'EReference'class + (type'ENamedElement'class + (type'EEnum'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + type'EEnumLiteral'class))))))))) { child = util'language.util'root || (some parent: type'EClass'class + (type'EReference'class + (type'ENamedElement'class + (type'EEnum'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + type'EEnumLiteral'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EClass'class + (type'EReference'class + (type'ENamedElement'class + (type'EEnum'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EPackage'class + (type'EDataType'class + (type'EClassifier'class + type'EEnumLiteral'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
