...
one sig util'language {
	...
	util'root : one type'EClass'class + (type'EDataType'class + (type'EAttribute'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EReference'class + (type'ETypedElement'class + (type'EClassifier'class + type'EPackage'class))))))))),
	util'contains : (type'EClass'class + (type'EDataType'class + (type'EAttribute'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EReference'class + (type'ETypedElement'class + (type'EClassifier'class + type'EPackage'class)))))))))) lone->set (type'EClass'class + (type'EDataType'class + (type'EAttribute'class + (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EReference'class + (type'ETypedElement'class + (type'EClassifier'class + type'EPackage'class))))))))))
}
