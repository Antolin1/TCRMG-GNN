...
one sig util'language {
	...
	util'root : one type'EAttribute'class + (type'EPackage'class + (type'EDataType'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnum'class + (type'EClass'class + (type'EStructuralFeature'class + type'EReference'class))))))))),
	util'contains : (type'EAttribute'class + (type'EPackage'class + (type'EDataType'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnum'class + (type'EClass'class + (type'EStructuralFeature'class + type'EReference'class)))))))))) lone->set (type'EAttribute'class + (type'EPackage'class + (type'EDataType'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnum'class + (type'EClass'class + (type'EStructuralFeature'class + type'EReference'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EAttribute'class + (type'EPackage'class + (type'EDataType'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnum'class + (type'EClass'class + (type'EStructuralFeature'class + type'EReference'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EAttribute'class + (type'EPackage'class + (type'EDataType'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnum'class + (type'EClass'class + (type'EStructuralFeature'class + type'EReference'class))))))))) { child = util'language.util'root or (some parent: type'EAttribute'class + (type'EPackage'class + (type'EDataType'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnum'class + (type'EClass'class + (type'EStructuralFeature'class + type'EReference'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EAttribute'class + (type'EPackage'class + (type'EDataType'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnum'class + (type'EClass'class + (type'EStructuralFeature'class + type'EReference'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
