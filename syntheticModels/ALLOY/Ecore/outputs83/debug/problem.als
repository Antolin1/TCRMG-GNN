...
one sig util'language {
	...
	util'root : one type'EClassifier'class + (type'EAttribute'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EPackage'class + (type'ENamedElement'class + type'EClass'class))))))))),
	util'contains : (type'EClassifier'class + (type'EAttribute'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EPackage'class + (type'ENamedElement'class + type'EClass'class)))))))))) lone->set (type'EClassifier'class + (type'EAttribute'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EReference'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EPackage'class + (type'ENamedElement'class + type'EClass'class))))))))))
}
