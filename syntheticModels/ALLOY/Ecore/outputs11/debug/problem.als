...
one sig util'language {
	...
	util'root : one type'EClassifier'class + (type'EReference'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EDataType'class + (type'EAttribute'class + (type'EClass'class + (type'ETypedElement'class + (type'EEnumLiteral'class + type'EPackage'class))))))))),
	util'contains : (type'EClassifier'class + (type'EReference'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EDataType'class + (type'EAttribute'class + (type'EClass'class + (type'ETypedElement'class + (type'EEnumLiteral'class + type'EPackage'class)))))))))) lone->set (type'EClassifier'class + (type'EReference'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EDataType'class + (type'EAttribute'class + (type'EClass'class + (type'ETypedElement'class + (type'EEnumLiteral'class + type'EPackage'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EClassifier'class + (type'EReference'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EDataType'class + (type'EAttribute'class + (type'EClass'class + (type'ETypedElement'class + (type'EEnumLiteral'class + type'EPackage'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EClassifier'class + (type'EReference'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EDataType'class + (type'EAttribute'class + (type'EClass'class + (type'ETypedElement'class + (type'EEnumLiteral'class + type'EPackage'class))))))))) { child = util'language.util'root || (some parent: type'EClassifier'class + (type'EReference'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EDataType'class + (type'EAttribute'class + (type'EClass'class + (type'ETypedElement'class + (type'EEnumLiteral'class + type'EPackage'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EClassifier'class + (type'EReference'class + (type'EEnum'class + (type'EStructuralFeature'class + (type'ENamedElement'class + (type'EDataType'class + (type'EAttribute'class + (type'EClass'class + (type'ETypedElement'class + (type'EEnumLiteral'class + type'EPackage'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
