...
one sig util'language {
	...
	util'root : one type'EDataType'class + (type'ENamedElement'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EClass'class + (type'ETypedElement'class + (type'EReference'class + (type'EEnum'class + (type'EEnumLiteral'class + type'EClassifier'class))))))))),
	util'contains : (type'EDataType'class + (type'ENamedElement'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EClass'class + (type'ETypedElement'class + (type'EReference'class + (type'EEnum'class + (type'EEnumLiteral'class + type'EClassifier'class)))))))))) lone->set (type'EDataType'class + (type'ENamedElement'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EClass'class + (type'ETypedElement'class + (type'EReference'class + (type'EEnum'class + (type'EEnumLiteral'class + type'EClassifier'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EDataType'class + (type'ENamedElement'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EClass'class + (type'ETypedElement'class + (type'EReference'class + (type'EEnum'class + (type'EEnumLiteral'class + type'EClassifier'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EDataType'class + (type'ENamedElement'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EClass'class + (type'ETypedElement'class + (type'EReference'class + (type'EEnum'class + (type'EEnumLiteral'class + type'EClassifier'class))))))))) { child = util'language.util'root or (some parent: type'EDataType'class + (type'ENamedElement'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EClass'class + (type'ETypedElement'class + (type'EReference'class + (type'EEnum'class + (type'EEnumLiteral'class + type'EClassifier'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EDataType'class + (type'ENamedElement'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EClass'class + (type'ETypedElement'class + (type'EReference'class + (type'EEnum'class + (type'EEnumLiteral'class + type'EClassifier'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
