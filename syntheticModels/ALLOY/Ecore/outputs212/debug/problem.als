...
one sig util'language {
	...
	util'root : one type'EStructuralFeature'class + (type'EEnum'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EAttribute'class + (type'ETypedElement'class + type'EClass'class))))))))),
	util'contains : (type'EStructuralFeature'class + (type'EEnum'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EAttribute'class + (type'ETypedElement'class + type'EClass'class)))))))))) lone->set (type'EStructuralFeature'class + (type'EEnum'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EAttribute'class + (type'ETypedElement'class + type'EClass'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EStructuralFeature'class + (type'EEnum'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EAttribute'class + (type'ETypedElement'class + type'EClass'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EStructuralFeature'class + (type'EEnum'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EAttribute'class + (type'ETypedElement'class + type'EClass'class))))))))) { child = util'language.util'root || (some parent: type'EStructuralFeature'class + (type'EEnum'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EAttribute'class + (type'ETypedElement'class + type'EClass'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EStructuralFeature'class + (type'EEnum'class + (type'EPackage'class + (type'EDataType'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EAttribute'class + (type'ETypedElement'class + type'EClass'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
