...
one sig util'language {
	...
	util'root : one type'EStructuralFeature'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EClass'class + (type'EPackage'class + type'EAttribute'class))))))))),
	util'contains : (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EClass'class + (type'EPackage'class + type'EAttribute'class)))))))))) lone->set (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnum'class + (type'ENamedElement'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EClass'class + (type'EPackage'class + type'EAttribute'class))))))))))
}
