...
one sig util'language {
	...
	util'root : one type'EClassifier'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EReference'class + (type'ENamedElement'class + (type'EClass'class + (type'EPackage'class + type'EAttribute'class))))))))),
	util'contains : (type'EClassifier'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EReference'class + (type'ENamedElement'class + (type'EClass'class + (type'EPackage'class + type'EAttribute'class)))))))))) lone->set (type'EClassifier'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EReference'class + (type'ENamedElement'class + (type'EClass'class + (type'EPackage'class + type'EAttribute'class))))))))))
}
