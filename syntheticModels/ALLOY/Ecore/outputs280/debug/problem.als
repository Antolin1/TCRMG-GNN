...
one sig util'language {
	...
	util'root : one type'EClass'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'EReference'class + (type'ETypedElement'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EPackage'class + type'EStructuralFeature'class))))))))),
	util'contains : (type'EClass'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'EReference'class + (type'ETypedElement'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EPackage'class + type'EStructuralFeature'class)))))))))) lone->set (type'EClass'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'EReference'class + (type'ETypedElement'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EPackage'class + type'EStructuralFeature'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EClass'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'EReference'class + (type'ETypedElement'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EPackage'class + type'EStructuralFeature'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EClass'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'EReference'class + (type'ETypedElement'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EPackage'class + type'EStructuralFeature'class))))))))) { child = util'language.util'root || (some parent: type'EClass'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'EReference'class + (type'ETypedElement'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EPackage'class + type'EStructuralFeature'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EClass'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'EReference'class + (type'ETypedElement'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EPackage'class + type'EStructuralFeature'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
