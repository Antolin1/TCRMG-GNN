...
one sig util'language {
	...
	util'root : one type'EClass'class + (type'EPackage'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EReference'class + (type'EEnum'class + type'EClassifier'class))))))))),
	util'contains : (type'EClass'class + (type'EPackage'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EReference'class + (type'EEnum'class + type'EClassifier'class)))))))))) lone->set (type'EClass'class + (type'EPackage'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EReference'class + (type'EEnum'class + type'EClassifier'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EClass'class + (type'EPackage'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EReference'class + (type'EEnum'class + type'EClassifier'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EClass'class + (type'EPackage'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EReference'class + (type'EEnum'class + type'EClassifier'class))))))))) { child = util'language.util'root or (some parent: type'EClass'class + (type'EPackage'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EReference'class + (type'EEnum'class + type'EClassifier'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EClass'class + (type'EPackage'class + (type'ENamedElement'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EReference'class + (type'EEnum'class + type'EClassifier'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
