...
one sig util'language {
	...
	util'root : one type'EAttribute'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EClassifier'class + (type'EEnum'class + (type'EPackage'class + type'EDataType'class))))))))),
	util'contains : (type'EAttribute'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EClassifier'class + (type'EEnum'class + (type'EPackage'class + type'EDataType'class)))))))))) lone->set (type'EAttribute'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EClassifier'class + (type'EEnum'class + (type'EPackage'class + type'EDataType'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EAttribute'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EClassifier'class + (type'EEnum'class + (type'EPackage'class + type'EDataType'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EAttribute'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EClassifier'class + (type'EEnum'class + (type'EPackage'class + type'EDataType'class))))))))) { child = util'language.util'root or (some parent: type'EAttribute'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EClassifier'class + (type'EEnum'class + (type'EPackage'class + type'EDataType'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EAttribute'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EReference'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EClassifier'class + (type'EEnum'class + (type'EPackage'class + type'EDataType'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
