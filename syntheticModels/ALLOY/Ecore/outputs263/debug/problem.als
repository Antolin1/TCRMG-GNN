...
one sig util'language {
	...
	util'root : one type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'ENamedElement'class + (type'EDataType'class + type'EClassifier'class))))))))),
	util'contains : (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'ENamedElement'class + (type'EDataType'class + type'EClassifier'class)))))))))) lone->set (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'ENamedElement'class + (type'EDataType'class + type'EClassifier'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'ENamedElement'class + (type'EDataType'class + type'EClassifier'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'ENamedElement'class + (type'EDataType'class + type'EClassifier'class))))))))) { child = util'language.util'root || (some parent: type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'ENamedElement'class + (type'EDataType'class + type'EClassifier'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EAttribute'class + (type'EReference'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'ENamedElement'class + (type'EDataType'class + type'EClassifier'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
