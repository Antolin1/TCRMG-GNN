...
one sig util'language {
	...
	util'root : one type'EEnumLiteral'class + (type'EAttribute'class + (type'EReference'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EPackage'class + (type'EClass'class + (type'EClassifier'class + (type'EDataType'class + (type'ENamedElement'class + type'EEnum'class))))))))),
	util'contains : (type'EEnumLiteral'class + (type'EAttribute'class + (type'EReference'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EPackage'class + (type'EClass'class + (type'EClassifier'class + (type'EDataType'class + (type'ENamedElement'class + type'EEnum'class)))))))))) lone->set (type'EEnumLiteral'class + (type'EAttribute'class + (type'EReference'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EPackage'class + (type'EClass'class + (type'EClassifier'class + (type'EDataType'class + (type'ENamedElement'class + type'EEnum'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EEnumLiteral'class + (type'EAttribute'class + (type'EReference'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EPackage'class + (type'EClass'class + (type'EClassifier'class + (type'EDataType'class + (type'ENamedElement'class + type'EEnum'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EEnumLiteral'class + (type'EAttribute'class + (type'EReference'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EPackage'class + (type'EClass'class + (type'EClassifier'class + (type'EDataType'class + (type'ENamedElement'class + type'EEnum'class))))))))) { child = util'language.util'root || (some parent: type'EEnumLiteral'class + (type'EAttribute'class + (type'EReference'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EPackage'class + (type'EClass'class + (type'EClassifier'class + (type'EDataType'class + (type'ENamedElement'class + type'EEnum'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EEnumLiteral'class + (type'EAttribute'class + (type'EReference'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EPackage'class + (type'EClass'class + (type'EClassifier'class + (type'EDataType'class + (type'ENamedElement'class + type'EEnum'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
