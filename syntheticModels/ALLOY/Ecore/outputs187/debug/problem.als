...
one sig util'language {
	...
	util'root : one type'ENamedElement'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EReference'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EPackage'class + type'EDataType'class))))))))),
	util'contains : (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EReference'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EPackage'class + type'EDataType'class)))))))))) lone->set (type'ENamedElement'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EReference'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EPackage'class + type'EDataType'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'ENamedElement'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EReference'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EPackage'class + type'EDataType'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'ENamedElement'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EReference'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EPackage'class + type'EDataType'class))))))))) { child = util'language.util'root || (some parent: type'ENamedElement'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EReference'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EPackage'class + type'EDataType'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'ENamedElement'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EReference'class + (type'EAttribute'class + (type'EEnum'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EPackage'class + type'EDataType'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
