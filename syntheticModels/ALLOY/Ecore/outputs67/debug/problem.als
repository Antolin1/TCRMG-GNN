...
one sig util'language {
	...
	util'root : one type'EEnumLiteral'class + (type'EDataType'class + (type'EEnum'class + (type'EReference'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EClassifier'class + type'EClass'class))))))))),
	util'contains : (type'EEnumLiteral'class + (type'EDataType'class + (type'EEnum'class + (type'EReference'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EClassifier'class + type'EClass'class)))))))))) lone->set (type'EEnumLiteral'class + (type'EDataType'class + (type'EEnum'class + (type'EReference'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EClassifier'class + type'EClass'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EEnumLiteral'class + (type'EDataType'class + (type'EEnum'class + (type'EReference'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EClassifier'class + type'EClass'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EEnumLiteral'class + (type'EDataType'class + (type'EEnum'class + (type'EReference'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EClassifier'class + type'EClass'class))))))))) { child = util'language.util'root or (some parent: type'EEnumLiteral'class + (type'EDataType'class + (type'EEnum'class + (type'EReference'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EClassifier'class + type'EClass'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EEnumLiteral'class + (type'EDataType'class + (type'EEnum'class + (type'EReference'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EClassifier'class + type'EClass'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
