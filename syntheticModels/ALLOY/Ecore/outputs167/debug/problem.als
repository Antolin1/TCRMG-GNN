...
one sig util'language {
	...
	util'root : one type'EReference'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EEnum'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EPackage'class + (type'ENamedElement'class + (type'EAttribute'class + type'EStructuralFeature'class))))))))),
	util'contains : (type'EReference'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EEnum'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EPackage'class + (type'ENamedElement'class + (type'EAttribute'class + type'EStructuralFeature'class)))))))))) lone->set (type'EReference'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EEnum'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EPackage'class + (type'ENamedElement'class + (type'EAttribute'class + type'EStructuralFeature'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EReference'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EEnum'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EPackage'class + (type'ENamedElement'class + (type'EAttribute'class + type'EStructuralFeature'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EReference'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EEnum'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EPackage'class + (type'ENamedElement'class + (type'EAttribute'class + type'EStructuralFeature'class))))))))) { child = util'language.util'root or (some parent: type'EReference'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EEnum'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EPackage'class + (type'ENamedElement'class + (type'EAttribute'class + type'EStructuralFeature'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EReference'class + (type'EClassifier'class + (type'ETypedElement'class + (type'EEnum'class + (type'EClass'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EPackage'class + (type'ENamedElement'class + (type'EAttribute'class + type'EStructuralFeature'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
