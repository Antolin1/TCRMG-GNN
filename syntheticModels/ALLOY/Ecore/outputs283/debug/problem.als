...
one sig util'language {
	...
	util'root : one type'EStructuralFeature'class + (type'EReference'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EPackage'class + (type'EClassifier'class + (type'EClass'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EDataType'class + type'ENamedElement'class))))))))),
	util'contains : (type'EStructuralFeature'class + (type'EReference'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EPackage'class + (type'EClassifier'class + (type'EClass'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EDataType'class + type'ENamedElement'class)))))))))) lone->set (type'EStructuralFeature'class + (type'EReference'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EPackage'class + (type'EClassifier'class + (type'EClass'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EDataType'class + type'ENamedElement'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EStructuralFeature'class + (type'EReference'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EPackage'class + (type'EClassifier'class + (type'EClass'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EDataType'class + type'ENamedElement'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EStructuralFeature'class + (type'EReference'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EPackage'class + (type'EClassifier'class + (type'EClass'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EDataType'class + type'ENamedElement'class))))))))) { child = util'language.util'root or (some parent: type'EStructuralFeature'class + (type'EReference'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EPackage'class + (type'EClassifier'class + (type'EClass'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EDataType'class + type'ENamedElement'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EStructuralFeature'class + (type'EReference'class + (type'EAttribute'class + (type'ETypedElement'class + (type'EPackage'class + (type'EClassifier'class + (type'EClass'class + (type'EEnum'class + (type'EEnumLiteral'class + (type'EDataType'class + type'ENamedElement'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
