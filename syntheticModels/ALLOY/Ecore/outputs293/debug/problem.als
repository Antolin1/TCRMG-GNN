...
one sig util'language {
	...
	util'root : one type'EEnum'class + (type'EClassifier'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + (type'EClass'class + (type'EDataType'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EPackage'class + type'EEnumLiteral'class))))))))),
	util'contains : (type'EEnum'class + (type'EClassifier'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + (type'EClass'class + (type'EDataType'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EPackage'class + type'EEnumLiteral'class)))))))))) lone->set (type'EEnum'class + (type'EClassifier'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + (type'EClass'class + (type'EDataType'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EPackage'class + type'EEnumLiteral'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EEnum'class + (type'EClassifier'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + (type'EClass'class + (type'EDataType'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EPackage'class + type'EEnumLiteral'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EEnum'class + (type'EClassifier'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + (type'EClass'class + (type'EDataType'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EPackage'class + type'EEnumLiteral'class))))))))) { child = util'language.util'root || (some parent: type'EEnum'class + (type'EClassifier'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + (type'EClass'class + (type'EDataType'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EPackage'class + type'EEnumLiteral'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EEnum'class + (type'EClassifier'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EReference'class + (type'EClass'class + (type'EDataType'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EPackage'class + type'EEnumLiteral'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
