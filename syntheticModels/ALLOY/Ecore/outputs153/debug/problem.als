...
one sig util'language {
	...
	util'root : one type'EDataType'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EClassifier'class + type'EReference'class))))))))),
	util'contains : (type'EDataType'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EClassifier'class + type'EReference'class)))))))))) lone->set (type'EDataType'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EClassifier'class + type'EReference'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EDataType'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EClassifier'class + type'EReference'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EDataType'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EClassifier'class + type'EReference'class))))))))) { child = util'language.util'root or (some parent: type'EDataType'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EClassifier'class + type'EReference'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EDataType'class + (type'EEnumLiteral'class + (type'EEnum'class + (type'EClass'class + (type'ETypedElement'class + (type'ENamedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EClassifier'class + type'EReference'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
