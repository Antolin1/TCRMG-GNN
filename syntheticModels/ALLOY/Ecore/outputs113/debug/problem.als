...
one sig util'language {
	...
	util'root : one type'EEnumLiteral'class + (type'EPackage'class + (type'EDataType'class + (type'EClass'class + (type'ETypedElement'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnum'class + (type'ENamedElement'class + type'EReference'class))))))))),
	util'contains : (type'EEnumLiteral'class + (type'EPackage'class + (type'EDataType'class + (type'EClass'class + (type'ETypedElement'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnum'class + (type'ENamedElement'class + type'EReference'class)))))))))) lone->set (type'EEnumLiteral'class + (type'EPackage'class + (type'EDataType'class + (type'EClass'class + (type'ETypedElement'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnum'class + (type'ENamedElement'class + type'EReference'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EEnumLiteral'class + (type'EPackage'class + (type'EDataType'class + (type'EClass'class + (type'ETypedElement'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnum'class + (type'ENamedElement'class + type'EReference'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EEnumLiteral'class + (type'EPackage'class + (type'EDataType'class + (type'EClass'class + (type'ETypedElement'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnum'class + (type'ENamedElement'class + type'EReference'class))))))))) { child = util'language.util'root or (some parent: type'EEnumLiteral'class + (type'EPackage'class + (type'EDataType'class + (type'EClass'class + (type'ETypedElement'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnum'class + (type'ENamedElement'class + type'EReference'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EEnumLiteral'class + (type'EPackage'class + (type'EDataType'class + (type'EClass'class + (type'ETypedElement'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EAttribute'class + (type'EEnum'class + (type'ENamedElement'class + type'EReference'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
