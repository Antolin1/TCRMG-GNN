...
one sig util'language {
	...
	util'root : one type'EClass'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EPackage'class + (type'ETypedElement'class + (type'EReference'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EDataType'class + type'EEnum'class))))))))),
	util'contains : (type'EClass'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EPackage'class + (type'ETypedElement'class + (type'EReference'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EDataType'class + type'EEnum'class)))))))))) lone->set (type'EClass'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'EAttribute'class + (type'EPackage'class + (type'ETypedElement'class + (type'EReference'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EDataType'class + type'EEnum'class))))))))))
}
