...
one sig util'language {
	...
	util'root : one type'EStructuralFeature'class + (type'EEnum'class + (type'EAttribute'class + (type'EClassifier'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EReference'class + type'EPackage'class))))))))),
	util'contains : (type'EStructuralFeature'class + (type'EEnum'class + (type'EAttribute'class + (type'EClassifier'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EReference'class + type'EPackage'class)))))))))) lone->set (type'EStructuralFeature'class + (type'EEnum'class + (type'EAttribute'class + (type'EClassifier'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EReference'class + type'EPackage'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EStructuralFeature'class + (type'EEnum'class + (type'EAttribute'class + (type'EClassifier'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EReference'class + type'EPackage'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EStructuralFeature'class + (type'EEnum'class + (type'EAttribute'class + (type'EClassifier'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EReference'class + type'EPackage'class))))))))) { child = util'language.util'root or (some parent: type'EStructuralFeature'class + (type'EEnum'class + (type'EAttribute'class + (type'EClassifier'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EReference'class + type'EPackage'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EStructuralFeature'class + (type'EEnum'class + (type'EAttribute'class + (type'EClassifier'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EClass'class + (type'EReference'class + type'EPackage'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
