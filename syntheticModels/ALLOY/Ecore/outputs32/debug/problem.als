...
one sig util'language {
	...
	util'root : one type'EClassifier'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EEnum'class + (type'EAttribute'class + (type'ENamedElement'class + type'EPackage'class))))))))),
	util'contains : (type'EClassifier'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EEnum'class + (type'EAttribute'class + (type'ENamedElement'class + type'EPackage'class)))))))))) lone->set (type'EClassifier'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EEnum'class + (type'EAttribute'class + (type'ENamedElement'class + type'EPackage'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EClassifier'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EEnum'class + (type'EAttribute'class + (type'ENamedElement'class + type'EPackage'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EClassifier'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EEnum'class + (type'EAttribute'class + (type'ENamedElement'class + type'EPackage'class))))))))) { child = util'language.util'root or (some parent: type'EClassifier'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EEnum'class + (type'EAttribute'class + (type'ENamedElement'class + type'EPackage'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EClassifier'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EReference'class + (type'EDataType'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EEnum'class + (type'EAttribute'class + (type'ENamedElement'class + type'EPackage'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
