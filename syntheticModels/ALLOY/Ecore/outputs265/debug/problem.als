...
one sig util'language {
	...
	util'root : one type'ETypedElement'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'EStructuralFeature'class + (type'ENamedElement'class + type'EPackage'class))))))))),
	util'contains : (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'EStructuralFeature'class + (type'ENamedElement'class + type'EPackage'class)))))))))) lone->set (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'EStructuralFeature'class + (type'ENamedElement'class + type'EPackage'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'ETypedElement'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'EStructuralFeature'class + (type'ENamedElement'class + type'EPackage'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'ETypedElement'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'EStructuralFeature'class + (type'ENamedElement'class + type'EPackage'class))))))))) { child = util'language.util'root or (some parent: type'ETypedElement'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'EStructuralFeature'class + (type'ENamedElement'class + type'EPackage'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'ETypedElement'class + (type'EEnumLiteral'class + (type'EDataType'class + (type'EClassifier'class + (type'EAttribute'class + (type'EEnum'class + (type'EClass'class + (type'EReference'class + (type'EStructuralFeature'class + (type'ENamedElement'class + type'EPackage'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
