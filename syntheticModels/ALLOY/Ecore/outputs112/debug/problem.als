...
one sig util'language {
	...
	util'root : one type'EEnumLiteral'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EReference'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EPackage'class + (type'EEnum'class + (type'EAttribute'class + type'EClass'class))))))))),
	util'contains : (type'EEnumLiteral'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EReference'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EPackage'class + (type'EEnum'class + (type'EAttribute'class + type'EClass'class)))))))))) lone->set (type'EEnumLiteral'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EReference'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EPackage'class + (type'EEnum'class + (type'EAttribute'class + type'EClass'class))))))))))
}
...
pred pattern'queries'attributeHasNotTypeConstraint [parameter'a: type'EAttribute'class] {
	all variable'0: type'EDataType'class { parameter'a in type'EAttribute'class && ! (pattern'queries'attributeHasType [ parameter'a , variable'0 ]) }
}
...
pred pattern'queries'referenceHasNotTypeConstraint [parameter'r: type'EReference'class] {
	all variable'0: type'EClass'class { parameter'r in type'EReference'class && ! (pattern'queries'referenceHasType [ parameter'r , variable'0 ]) }
}
...
pred pattern'queries'oppositeRestriction [parameter'r: type'EReference'class, parameter'rr: type'EReference'class] {
	parameter'rr in parameter'r.eOpposite'reference'EReference && (parameter'rr in type'EReference'class && ! (pattern'queries'isOpposite [ parameter'rr , parameter'r ]))
}
...
fact util'noParentForRoot {
	no parent: type'EEnumLiteral'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EReference'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EPackage'class + (type'EEnum'class + (type'EAttribute'class + type'EClass'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EEnumLiteral'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EReference'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EPackage'class + (type'EEnum'class + (type'EAttribute'class + type'EClass'class))))))))) { child = util'language.util'root || (some parent: type'EEnumLiteral'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EReference'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EPackage'class + (type'EEnum'class + (type'EAttribute'class + type'EClass'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EEnumLiteral'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EReference'class + (type'ETypedElement'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EPackage'class + (type'EEnum'class + (type'EAttribute'class + type'EClass'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
