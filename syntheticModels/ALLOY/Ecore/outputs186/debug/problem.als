...
one sig util'language {
	...
	util'root : one type'EPackage'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'ETypedElement'class + (type'EReference'class + (type'EClass'class + type'EEnum'class))))))))),
	util'contains : (type'EPackage'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'ETypedElement'class + (type'EReference'class + (type'EClass'class + type'EEnum'class)))))))))) lone->set (type'EPackage'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'ETypedElement'class + (type'EReference'class + (type'EClass'class + type'EEnum'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EPackage'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'ETypedElement'class + (type'EReference'class + (type'EClass'class + type'EEnum'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EPackage'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'ETypedElement'class + (type'EReference'class + (type'EClass'class + type'EEnum'class))))))))) { child = util'language.util'root or (some parent: type'EPackage'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'ETypedElement'class + (type'EReference'class + (type'EClass'class + type'EEnum'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EPackage'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'ETypedElement'class + (type'EReference'class + (type'EClass'class + type'EEnum'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
