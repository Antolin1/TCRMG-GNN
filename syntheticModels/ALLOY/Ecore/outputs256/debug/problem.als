...
one sig util'language {
	...
	util'root : one type'EClass'class + (type'EEnum'class + (type'ENamedElement'class + (type'EPackage'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EReference'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EStructuralFeature'class + type'EClassifier'class))))))))),
	util'contains : (type'EClass'class + (type'EEnum'class + (type'ENamedElement'class + (type'EPackage'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EReference'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EStructuralFeature'class + type'EClassifier'class)))))))))) lone->set (type'EClass'class + (type'EEnum'class + (type'ENamedElement'class + (type'EPackage'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EReference'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EStructuralFeature'class + type'EClassifier'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EClass'class + (type'EEnum'class + (type'ENamedElement'class + (type'EPackage'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EReference'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EStructuralFeature'class + type'EClassifier'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EClass'class + (type'EEnum'class + (type'ENamedElement'class + (type'EPackage'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EReference'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EStructuralFeature'class + type'EClassifier'class))))))))) { child = util'language.util'root or (some parent: type'EClass'class + (type'EEnum'class + (type'ENamedElement'class + (type'EPackage'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EReference'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EStructuralFeature'class + type'EClassifier'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EClass'class + (type'EEnum'class + (type'ENamedElement'class + (type'EPackage'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EReference'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EStructuralFeature'class + type'EClassifier'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
