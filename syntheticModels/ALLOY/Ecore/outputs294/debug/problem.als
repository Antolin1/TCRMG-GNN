...
one sig util'language {
	...
	util'root : one type'EReference'class + (type'EEnum'class + (type'EDataType'class + (type'EClass'class + (type'EPackage'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EAttribute'class + type'ENamedElement'class))))))))),
	util'contains : (type'EReference'class + (type'EEnum'class + (type'EDataType'class + (type'EClass'class + (type'EPackage'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EAttribute'class + type'ENamedElement'class)))))))))) lone->set (type'EReference'class + (type'EEnum'class + (type'EDataType'class + (type'EClass'class + (type'EPackage'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EAttribute'class + type'ENamedElement'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EReference'class + (type'EEnum'class + (type'EDataType'class + (type'EClass'class + (type'EPackage'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EAttribute'class + type'ENamedElement'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EReference'class + (type'EEnum'class + (type'EDataType'class + (type'EClass'class + (type'EPackage'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EAttribute'class + type'ENamedElement'class))))))))) { child = util'language.util'root || (some parent: type'EReference'class + (type'EEnum'class + (type'EDataType'class + (type'EClass'class + (type'EPackage'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EAttribute'class + type'ENamedElement'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EReference'class + (type'EEnum'class + (type'EDataType'class + (type'EClass'class + (type'EPackage'class + (type'EClassifier'class + (type'EStructuralFeature'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EAttribute'class + type'ENamedElement'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
