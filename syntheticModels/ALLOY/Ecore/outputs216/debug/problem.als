...
one sig util'language {
	...
	util'root : one type'EDataType'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClass'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EClassifier'class + type'EEnumLiteral'class))))))))),
	util'contains : (type'EDataType'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClass'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EClassifier'class + type'EEnumLiteral'class)))))))))) lone->set (type'EDataType'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClass'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EClassifier'class + type'EEnumLiteral'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EDataType'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClass'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EClassifier'class + type'EEnumLiteral'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EDataType'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClass'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EClassifier'class + type'EEnumLiteral'class))))))))) { child = util'language.util'root or (some parent: type'EDataType'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClass'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EClassifier'class + type'EEnumLiteral'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EDataType'class + (type'EAttribute'class + (type'EStructuralFeature'class + (type'EReference'class + (type'EClass'class + (type'ENamedElement'class + (type'ETypedElement'class + (type'EPackage'class + (type'EEnum'class + (type'EClassifier'class + type'EEnumLiteral'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
