...
one sig util'language {
	...
	util'root : one type'EReference'class + (type'EAttribute'class + (type'ENamedElement'class + (type'EClass'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'ETypedElement'class + type'EEnum'class))))))))),
	util'contains : (type'EReference'class + (type'EAttribute'class + (type'ENamedElement'class + (type'EClass'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'ETypedElement'class + type'EEnum'class)))))))))) lone->set (type'EReference'class + (type'EAttribute'class + (type'ENamedElement'class + (type'EClass'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'ETypedElement'class + type'EEnum'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EReference'class + (type'EAttribute'class + (type'ENamedElement'class + (type'EClass'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'ETypedElement'class + type'EEnum'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EReference'class + (type'EAttribute'class + (type'ENamedElement'class + (type'EClass'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'ETypedElement'class + type'EEnum'class))))))))) { child = util'language.util'root || (some parent: type'EReference'class + (type'EAttribute'class + (type'ENamedElement'class + (type'EClass'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'ETypedElement'class + type'EEnum'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EReference'class + (type'EAttribute'class + (type'ENamedElement'class + (type'EClass'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EDataType'class + (type'EEnumLiteral'class + (type'EClassifier'class + (type'ETypedElement'class + type'EEnum'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
