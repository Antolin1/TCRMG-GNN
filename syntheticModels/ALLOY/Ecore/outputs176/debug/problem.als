...
one sig util'language {
	...
	util'root : one type'ETypedElement'class + (type'EReference'class + (type'EPackage'class + (type'EEnum'class + (type'EAttribute'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EClass'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + type'EDataType'class))))))))),
	util'contains : (type'ETypedElement'class + (type'EReference'class + (type'EPackage'class + (type'EEnum'class + (type'EAttribute'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EClass'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + type'EDataType'class)))))))))) lone->set (type'ETypedElement'class + (type'EReference'class + (type'EPackage'class + (type'EEnum'class + (type'EAttribute'class + (type'EClassifier'class + (type'ENamedElement'class + (type'EClass'class + (type'EStructuralFeature'class + (type'EEnumLiteral'class + type'EDataType'class))))))))))
}
