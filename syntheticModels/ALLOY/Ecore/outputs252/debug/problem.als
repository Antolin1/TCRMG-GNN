...
one sig util'language {
	...
	util'root : one type'EPackage'class + (type'EClass'class + (type'ETypedElement'class + (type'EClassifier'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'ENamedElement'class + (type'EReference'class + type'EDataType'class))))))))),
	util'contains : (type'EPackage'class + (type'EClass'class + (type'ETypedElement'class + (type'EClassifier'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'ENamedElement'class + (type'EReference'class + type'EDataType'class)))))))))) lone->set (type'EPackage'class + (type'EClass'class + (type'ETypedElement'class + (type'EClassifier'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'ENamedElement'class + (type'EReference'class + type'EDataType'class))))))))))
}
