...
one sig util'language {
	...
	util'root : one type'ETypedElement'class + (type'EReference'class + (type'EPackage'class + (type'EClassifier'class + (type'EClass'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ENamedElement'class + type'EDataType'class))))))))),
	util'contains : (type'ETypedElement'class + (type'EReference'class + (type'EPackage'class + (type'EClassifier'class + (type'EClass'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ENamedElement'class + type'EDataType'class)))))))))) lone->set (type'ETypedElement'class + (type'EReference'class + (type'EPackage'class + (type'EClassifier'class + (type'EClass'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EAttribute'class + (type'EEnumLiteral'class + (type'ENamedElement'class + type'EDataType'class))))))))))
}
