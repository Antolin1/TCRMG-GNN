...
one sig util'language {
	...
	util'root : one type'EAttribute'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EReference'class + (type'EDataType'class + (type'EPackage'class + (type'ENamedElement'class + (type'EClassifier'class + type'EClass'class))))))))),
	util'contains : (type'EAttribute'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EReference'class + (type'EDataType'class + (type'EPackage'class + (type'ENamedElement'class + (type'EClassifier'class + type'EClass'class)))))))))) lone->set (type'EAttribute'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EReference'class + (type'EDataType'class + (type'EPackage'class + (type'ENamedElement'class + (type'EClassifier'class + type'EClass'class))))))))))
}
...
pred pattern'queries'attributeHasNotTypeConstraint [parameter'a: type'EAttribute'class] {
	all variable'0: type'EDataType'class { parameter'a in type'EAttribute'class and not (pattern'queries'attributeHasType [ parameter'a , variable'0 ]) }
}
...
pred pattern'queries'referenceHasNotTypeConstraint [parameter'r: type'EReference'class] {
	all variable'0: type'EClass'class { parameter'r in type'EReference'class and not (pattern'queries'referenceHasType [ parameter'r , variable'0 ]) }
}
...
pred pattern'queries'oppositeRestriction [parameter'r: type'EReference'class, parameter'rr: type'EReference'class] {
	parameter'rr in parameter'r.eOpposite'reference'EReference and (parameter'rr in type'EReference'class and not (pattern'queries'isOpposite [ parameter'rr , parameter'r ]))
}
...
fact util'noParentForRoot {
	no parent: type'EAttribute'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EReference'class + (type'EDataType'class + (type'EPackage'class + (type'ENamedElement'class + (type'EClassifier'class + type'EClass'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EAttribute'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EReference'class + (type'EDataType'class + (type'EPackage'class + (type'ENamedElement'class + (type'EClassifier'class + type'EClass'class))))))))) { child = util'language.util'root or (some parent: type'EAttribute'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EReference'class + (type'EDataType'class + (type'EPackage'class + (type'ENamedElement'class + (type'EClassifier'class + type'EClass'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EAttribute'class + (type'ETypedElement'class + (type'EEnumLiteral'class + (type'EStructuralFeature'class + (type'EEnum'class + (type'EReference'class + (type'EDataType'class + (type'EPackage'class + (type'ENamedElement'class + (type'EClassifier'class + type'EClass'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
