...
one sig util'language {
	...
	util'root : one type'ENamedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EReference'class + (type'ETypedElement'class + (type'EClassifier'class + (type'EEnum'class + (type'EDataType'class + type'EEnumLiteral'class))))))))),
	util'contains : (type'ENamedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EReference'class + (type'ETypedElement'class + (type'EClassifier'class + (type'EEnum'class + (type'EDataType'class + type'EEnumLiteral'class)))))))))) lone->set (type'ENamedElement'class + (type'EAttribute'class + (type'EPackage'class + (type'EStructuralFeature'class + (type'EClass'class + (type'EReference'class + (type'ETypedElement'class + (type'EClassifier'class + (type'EEnum'class + (type'EDataType'class + type'EEnumLiteral'class))))))))))
}
