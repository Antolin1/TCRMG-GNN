...
one sig util'language {
	...
	util'root : one type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EPackage'class + (type'EClassifier'class + (type'EClass'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EDataType'class + (type'EReference'class + type'EEnum'class))))))))),
	util'contains : (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EPackage'class + (type'EClassifier'class + (type'EClass'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EDataType'class + (type'EReference'class + type'EEnum'class)))))))))) lone->set (type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EPackage'class + (type'EClassifier'class + (type'EClass'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EDataType'class + (type'EReference'class + type'EEnum'class))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EPackage'class + (type'EClassifier'class + (type'EClass'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EDataType'class + (type'EReference'class + type'EEnum'class))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EPackage'class + (type'EClassifier'class + (type'EClass'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EDataType'class + (type'EReference'class + type'EEnum'class))))))))) { child = util'language.util'root or (some parent: type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EPackage'class + (type'EClassifier'class + (type'EClass'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EDataType'class + (type'EReference'class + type'EEnum'class))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'EStructuralFeature'class + (type'EEnumLiteral'class + (type'ENamedElement'class + (type'EPackage'class + (type'EClassifier'class + (type'EClass'class + (type'ETypedElement'class + (type'EAttribute'class + (type'EDataType'class + (type'EReference'class + type'EEnum'class))))))))) { circle->circle in ^ (util'language.util'contains) }
}
