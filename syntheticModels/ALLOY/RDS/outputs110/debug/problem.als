one sig util'language {
	util'root : one type'Table'class + (type'Element'class + (type'Column'class + (type'Reference'class + (type'IndexColumn'class + (type'Index'class + type'Database'class))))),
	util'contains : (type'Table'class + (type'Element'class + (type'Column'class + (type'Reference'class + (type'IndexColumn'class + (type'Index'class + type'Database'class)))))) lone->set (type'Table'class + (type'Element'class + (type'Column'class + (type'Reference'class + (type'IndexColumn'class + (type'Index'class + type'Database'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Table'class + (type'Element'class + (type'Column'class + (type'Reference'class + (type'IndexColumn'class + (type'Index'class + type'Database'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Table'class + (type'Element'class + (type'Column'class + (type'Reference'class + (type'IndexColumn'class + (type'Index'class + type'Database'class))))) { child = util'language.util'root || (some parent: type'Table'class + (type'Element'class + (type'Column'class + (type'Reference'class + (type'IndexColumn'class + (type'Index'class + type'Database'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Table'class + (type'Element'class + (type'Column'class + (type'Reference'class + (type'IndexColumn'class + (type'Index'class + type'Database'class))))) { circle->circle in ^ (util'language.util'contains) }
}
