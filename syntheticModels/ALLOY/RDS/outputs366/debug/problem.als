one sig util'language {
	util'root : one type'Element'class + (type'Reference'class + (type'Index'class + (type'Column'class + (type'Table'class + (type'IndexColumn'class + type'Database'class))))),
	util'contains : (type'Element'class + (type'Reference'class + (type'Index'class + (type'Column'class + (type'Table'class + (type'IndexColumn'class + type'Database'class)))))) lone->set (type'Element'class + (type'Reference'class + (type'Index'class + (type'Column'class + (type'Table'class + (type'IndexColumn'class + type'Database'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Element'class + (type'Reference'class + (type'Index'class + (type'Column'class + (type'Table'class + (type'IndexColumn'class + type'Database'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Element'class + (type'Reference'class + (type'Index'class + (type'Column'class + (type'Table'class + (type'IndexColumn'class + type'Database'class))))) { child = util'language.util'root || (some parent: type'Element'class + (type'Reference'class + (type'Index'class + (type'Column'class + (type'Table'class + (type'IndexColumn'class + type'Database'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Element'class + (type'Reference'class + (type'Index'class + (type'Column'class + (type'Table'class + (type'IndexColumn'class + type'Database'class))))) { circle->circle in ^ (util'language.util'contains) }
}
