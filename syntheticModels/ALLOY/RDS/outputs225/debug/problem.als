one sig util'language {
	util'root : one type'Column'class + (type'IndexColumn'class + (type'Element'class + (type'Reference'class + (type'Table'class + (type'Database'class + type'Index'class))))),
	util'contains : (type'Column'class + (type'IndexColumn'class + (type'Element'class + (type'Reference'class + (type'Table'class + (type'Database'class + type'Index'class)))))) lone->set (type'Column'class + (type'IndexColumn'class + (type'Element'class + (type'Reference'class + (type'Table'class + (type'Database'class + type'Index'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Column'class + (type'IndexColumn'class + (type'Element'class + (type'Reference'class + (type'Table'class + (type'Database'class + type'Index'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Column'class + (type'IndexColumn'class + (type'Element'class + (type'Reference'class + (type'Table'class + (type'Database'class + type'Index'class))))) { child = util'language.util'root || (some parent: type'Column'class + (type'IndexColumn'class + (type'Element'class + (type'Reference'class + (type'Table'class + (type'Database'class + type'Index'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Column'class + (type'IndexColumn'class + (type'Element'class + (type'Reference'class + (type'Table'class + (type'Database'class + type'Index'class))))) { circle->circle in ^ (util'language.util'contains) }
}
