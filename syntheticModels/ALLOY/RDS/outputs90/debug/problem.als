one sig util'language {
	util'root : one type'Index'class + (type'IndexColumn'class + (type'Database'class + (type'Reference'class + (type'Table'class + (type'Element'class + type'Column'class))))),
	util'contains : (type'Index'class + (type'IndexColumn'class + (type'Database'class + (type'Reference'class + (type'Table'class + (type'Element'class + type'Column'class)))))) lone->set (type'Index'class + (type'IndexColumn'class + (type'Database'class + (type'Reference'class + (type'Table'class + (type'Element'class + type'Column'class))))))
}
...
pred pattern'queries'icCons [parameter'ic: type'IndexColumn'class, parameter't: type'Table'class, parameter'i: type'Index'class, parameter'c: type'Column'class] {
	parameter'i in parameter't.indexes'reference'Table && (parameter'ic in parameter'i.indexColumns'reference'Index && (parameter'c in parameter'ic.column'reference'IndexColumn && (parameter'c in type'Column'class && not (pattern'queries'columnInTable [ parameter't , parameter'c ]))))
}
...
fact util'noParentForRoot {
	no parent: type'Index'class + (type'IndexColumn'class + (type'Database'class + (type'Reference'class + (type'Table'class + (type'Element'class + type'Column'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Index'class + (type'IndexColumn'class + (type'Database'class + (type'Reference'class + (type'Table'class + (type'Element'class + type'Column'class))))) { child = util'language.util'root or (some parent: type'Index'class + (type'IndexColumn'class + (type'Database'class + (type'Reference'class + (type'Table'class + (type'Element'class + type'Column'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Index'class + (type'IndexColumn'class + (type'Database'class + (type'Reference'class + (type'Table'class + (type'Element'class + type'Column'class))))) { circle->circle in ^ (util'language.util'contains) }
}
