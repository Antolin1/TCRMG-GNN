one sig util'language {
	util'root : one type'Element'class + (type'IndexColumn'class + (type'Index'class + (type'Column'class + (type'Database'class + (type'Reference'class + type'Table'class))))),
	util'contains : (type'Element'class + (type'IndexColumn'class + (type'Index'class + (type'Column'class + (type'Database'class + (type'Reference'class + type'Table'class)))))) lone->set (type'Element'class + (type'IndexColumn'class + (type'Index'class + (type'Column'class + (type'Database'class + (type'Reference'class + type'Table'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Element'class + (type'IndexColumn'class + (type'Index'class + (type'Column'class + (type'Database'class + (type'Reference'class + type'Table'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Element'class + (type'IndexColumn'class + (type'Index'class + (type'Column'class + (type'Database'class + (type'Reference'class + type'Table'class))))) { child = util'language.util'root || (some parent: type'Element'class + (type'IndexColumn'class + (type'Index'class + (type'Column'class + (type'Database'class + (type'Reference'class + type'Table'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Element'class + (type'IndexColumn'class + (type'Index'class + (type'Column'class + (type'Database'class + (type'Reference'class + type'Table'class))))) { circle->circle in ^ (util'language.util'contains) }
}
