one sig util'language {
	util'root : one type'Index'class + (type'Table'class + (type'IndexColumn'class + (type'Database'class + (type'Element'class + (type'Column'class + type'Reference'class))))),
	util'contains : (type'Index'class + (type'Table'class + (type'IndexColumn'class + (type'Database'class + (type'Element'class + (type'Column'class + type'Reference'class)))))) lone->set (type'Index'class + (type'Table'class + (type'IndexColumn'class + (type'Database'class + (type'Element'class + (type'Column'class + type'Reference'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Index'class + (type'Table'class + (type'IndexColumn'class + (type'Database'class + (type'Element'class + (type'Column'class + type'Reference'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Index'class + (type'Table'class + (type'IndexColumn'class + (type'Database'class + (type'Element'class + (type'Column'class + type'Reference'class))))) { child = util'language.util'root or (some parent: type'Index'class + (type'Table'class + (type'IndexColumn'class + (type'Database'class + (type'Element'class + (type'Column'class + type'Reference'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Index'class + (type'Table'class + (type'IndexColumn'class + (type'Database'class + (type'Element'class + (type'Column'class + type'Reference'class))))) { circle->circle in ^ (util'language.util'contains) }
}
