one sig util'language {
	util'root : one type'Reference'class + (type'Index'class + (type'Table'class + (type'IndexColumn'class + (type'Column'class + (type'Database'class + type'Element'class))))),
	util'contains : (type'Reference'class + (type'Index'class + (type'Table'class + (type'IndexColumn'class + (type'Column'class + (type'Database'class + type'Element'class)))))) lone->set (type'Reference'class + (type'Index'class + (type'Table'class + (type'IndexColumn'class + (type'Column'class + (type'Database'class + type'Element'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Reference'class + (type'Index'class + (type'Table'class + (type'IndexColumn'class + (type'Column'class + (type'Database'class + type'Element'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Reference'class + (type'Index'class + (type'Table'class + (type'IndexColumn'class + (type'Column'class + (type'Database'class + type'Element'class))))) { child = util'language.util'root or (some parent: type'Reference'class + (type'Index'class + (type'Table'class + (type'IndexColumn'class + (type'Column'class + (type'Database'class + type'Element'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Reference'class + (type'Index'class + (type'Table'class + (type'IndexColumn'class + (type'Column'class + (type'Database'class + type'Element'class))))) { circle->circle in ^ (util'language.util'contains) }
}
