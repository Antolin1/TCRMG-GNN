one sig util'language {
	util'root : one type'Element'class + (type'Index'class + (type'Database'class + (type'Table'class + (type'Column'class + (type'Reference'class + type'IndexColumn'class))))),
	util'contains : (type'Element'class + (type'Index'class + (type'Database'class + (type'Table'class + (type'Column'class + (type'Reference'class + type'IndexColumn'class)))))) lone->set (type'Element'class + (type'Index'class + (type'Database'class + (type'Table'class + (type'Column'class + (type'Reference'class + type'IndexColumn'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Element'class + (type'Index'class + (type'Database'class + (type'Table'class + (type'Column'class + (type'Reference'class + type'IndexColumn'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Element'class + (type'Index'class + (type'Database'class + (type'Table'class + (type'Column'class + (type'Reference'class + type'IndexColumn'class))))) { child = util'language.util'root || (some parent: type'Element'class + (type'Index'class + (type'Database'class + (type'Table'class + (type'Column'class + (type'Reference'class + type'IndexColumn'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Element'class + (type'Index'class + (type'Database'class + (type'Table'class + (type'Column'class + (type'Reference'class + type'IndexColumn'class))))) { circle->circle in ^ (util'language.util'contains) }
}
