one sig util'language {
	util'root : one type'Reference'class + (type'Database'class + (type'Column'class + (type'Index'class + (type'IndexColumn'class + (type'Element'class + type'Table'class))))),
	util'contains : (type'Reference'class + (type'Database'class + (type'Column'class + (type'Index'class + (type'IndexColumn'class + (type'Element'class + type'Table'class)))))) lone->set (type'Reference'class + (type'Database'class + (type'Column'class + (type'Index'class + (type'IndexColumn'class + (type'Element'class + type'Table'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Reference'class + (type'Database'class + (type'Column'class + (type'Index'class + (type'IndexColumn'class + (type'Element'class + type'Table'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Reference'class + (type'Database'class + (type'Column'class + (type'Index'class + (type'IndexColumn'class + (type'Element'class + type'Table'class))))) { child = util'language.util'root or (some parent: type'Reference'class + (type'Database'class + (type'Column'class + (type'Index'class + (type'IndexColumn'class + (type'Element'class + type'Table'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Reference'class + (type'Database'class + (type'Column'class + (type'Index'class + (type'IndexColumn'class + (type'Element'class + type'Table'class))))) { circle->circle in ^ (util'language.util'contains) }
}
