one sig util'language {
	util'root : one type'Element'class + (type'Table'class + (type'Database'class + (type'Reference'class + (type'IndexColumn'class + (type'Index'class + type'Column'class))))),
	util'contains : (type'Element'class + (type'Table'class + (type'Database'class + (type'Reference'class + (type'IndexColumn'class + (type'Index'class + type'Column'class)))))) lone->set (type'Element'class + (type'Table'class + (type'Database'class + (type'Reference'class + (type'IndexColumn'class + (type'Index'class + type'Column'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Element'class + (type'Table'class + (type'Database'class + (type'Reference'class + (type'IndexColumn'class + (type'Index'class + type'Column'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Element'class + (type'Table'class + (type'Database'class + (type'Reference'class + (type'IndexColumn'class + (type'Index'class + type'Column'class))))) { child = util'language.util'root || (some parent: type'Element'class + (type'Table'class + (type'Database'class + (type'Reference'class + (type'IndexColumn'class + (type'Index'class + type'Column'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Element'class + (type'Table'class + (type'Database'class + (type'Reference'class + (type'IndexColumn'class + (type'Index'class + type'Column'class))))) { circle->circle in ^ (util'language.util'contains) }
}
