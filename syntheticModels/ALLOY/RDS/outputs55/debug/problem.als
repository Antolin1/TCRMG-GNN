one sig util'language {
	util'root : one type'Column'class + (type'Index'class + (type'Element'class + (type'IndexColumn'class + (type'Table'class + (type'Database'class + type'Reference'class))))),
	util'contains : (type'Column'class + (type'Index'class + (type'Element'class + (type'IndexColumn'class + (type'Table'class + (type'Database'class + type'Reference'class)))))) lone->set (type'Column'class + (type'Index'class + (type'Element'class + (type'IndexColumn'class + (type'Table'class + (type'Database'class + type'Reference'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Column'class + (type'Index'class + (type'Element'class + (type'IndexColumn'class + (type'Table'class + (type'Database'class + type'Reference'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Column'class + (type'Index'class + (type'Element'class + (type'IndexColumn'class + (type'Table'class + (type'Database'class + type'Reference'class))))) { child = util'language.util'root or (some parent: type'Column'class + (type'Index'class + (type'Element'class + (type'IndexColumn'class + (type'Table'class + (type'Database'class + type'Reference'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Column'class + (type'Index'class + (type'Element'class + (type'IndexColumn'class + (type'Table'class + (type'Database'class + type'Reference'class))))) { circle->circle in ^ (util'language.util'contains) }
}
