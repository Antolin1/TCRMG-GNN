one sig util'language {
	util'root : one type'Table'class + (type'Index'class + (type'Element'class + (type'Database'class + (type'Column'class + (type'IndexColumn'class + type'Reference'class))))),
	util'contains : (type'Table'class + (type'Index'class + (type'Element'class + (type'Database'class + (type'Column'class + (type'IndexColumn'class + type'Reference'class)))))) lone->set (type'Table'class + (type'Index'class + (type'Element'class + (type'Database'class + (type'Column'class + (type'IndexColumn'class + type'Reference'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Table'class + (type'Index'class + (type'Element'class + (type'Database'class + (type'Column'class + (type'IndexColumn'class + type'Reference'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Table'class + (type'Index'class + (type'Element'class + (type'Database'class + (type'Column'class + (type'IndexColumn'class + type'Reference'class))))) { child = util'language.util'root or (some parent: type'Table'class + (type'Index'class + (type'Element'class + (type'Database'class + (type'Column'class + (type'IndexColumn'class + type'Reference'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Table'class + (type'Index'class + (type'Element'class + (type'Database'class + (type'Column'class + (type'IndexColumn'class + type'Reference'class))))) { circle->circle in ^ (util'language.util'contains) }
}
