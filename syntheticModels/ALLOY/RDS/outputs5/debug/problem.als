one sig util'language {
	util'root : one type'Reference'class + (type'IndexColumn'class + (type'Table'class + (type'Element'class + (type'Database'class + (type'Index'class + type'Column'class))))),
	util'contains : (type'Reference'class + (type'IndexColumn'class + (type'Table'class + (type'Element'class + (type'Database'class + (type'Index'class + type'Column'class)))))) lone->set (type'Reference'class + (type'IndexColumn'class + (type'Table'class + (type'Element'class + (type'Database'class + (type'Index'class + type'Column'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Reference'class + (type'IndexColumn'class + (type'Table'class + (type'Element'class + (type'Database'class + (type'Index'class + type'Column'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Reference'class + (type'IndexColumn'class + (type'Table'class + (type'Element'class + (type'Database'class + (type'Index'class + type'Column'class))))) { child = util'language.util'root or (some parent: type'Reference'class + (type'IndexColumn'class + (type'Table'class + (type'Element'class + (type'Database'class + (type'Index'class + type'Column'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Reference'class + (type'IndexColumn'class + (type'Table'class + (type'Element'class + (type'Database'class + (type'Index'class + type'Column'class))))) { circle->circle in ^ (util'language.util'contains) }
}
