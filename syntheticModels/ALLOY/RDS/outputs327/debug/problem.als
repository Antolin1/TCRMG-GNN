one sig util'language {
	util'root : one type'Database'class + (type'Table'class + (type'IndexColumn'class + (type'Reference'class + (type'Column'class + (type'Index'class + type'Element'class))))),
	util'contains : (type'Database'class + (type'Table'class + (type'IndexColumn'class + (type'Reference'class + (type'Column'class + (type'Index'class + type'Element'class)))))) lone->set (type'Database'class + (type'Table'class + (type'IndexColumn'class + (type'Reference'class + (type'Column'class + (type'Index'class + type'Element'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Database'class + (type'Table'class + (type'IndexColumn'class + (type'Reference'class + (type'Column'class + (type'Index'class + type'Element'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Database'class + (type'Table'class + (type'IndexColumn'class + (type'Reference'class + (type'Column'class + (type'Index'class + type'Element'class))))) { child = util'language.util'root or (some parent: type'Database'class + (type'Table'class + (type'IndexColumn'class + (type'Reference'class + (type'Column'class + (type'Index'class + type'Element'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Database'class + (type'Table'class + (type'IndexColumn'class + (type'Reference'class + (type'Column'class + (type'Index'class + type'Element'class))))) { circle->circle in ^ (util'language.util'contains) }
}
