one sig util'language {
	util'root : one type'IndexColumn'class + (type'Table'class + (type'Element'class + (type'Column'class + (type'Database'class + (type'Reference'class + type'Index'class))))),
	util'contains : (type'IndexColumn'class + (type'Table'class + (type'Element'class + (type'Column'class + (type'Database'class + (type'Reference'class + type'Index'class)))))) lone->set (type'IndexColumn'class + (type'Table'class + (type'Element'class + (type'Column'class + (type'Database'class + (type'Reference'class + type'Index'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'IndexColumn'class + (type'Table'class + (type'Element'class + (type'Column'class + (type'Database'class + (type'Reference'class + type'Index'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'IndexColumn'class + (type'Table'class + (type'Element'class + (type'Column'class + (type'Database'class + (type'Reference'class + type'Index'class))))) { child = util'language.util'root or (some parent: type'IndexColumn'class + (type'Table'class + (type'Element'class + (type'Column'class + (type'Database'class + (type'Reference'class + type'Index'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'IndexColumn'class + (type'Table'class + (type'Element'class + (type'Column'class + (type'Database'class + (type'Reference'class + type'Index'class))))) { circle->circle in ^ (util'language.util'contains) }
}
