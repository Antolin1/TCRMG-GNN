one sig util'language {
	util'root : one type'Element'class + (type'Table'class + (type'Database'class + (type'Index'class + (type'Column'class + (type'IndexColumn'class + type'Reference'class))))),
	util'contains : (type'Element'class + (type'Table'class + (type'Database'class + (type'Index'class + (type'Column'class + (type'IndexColumn'class + type'Reference'class)))))) lone->set (type'Element'class + (type'Table'class + (type'Database'class + (type'Index'class + (type'Column'class + (type'IndexColumn'class + type'Reference'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Element'class + (type'Table'class + (type'Database'class + (type'Index'class + (type'Column'class + (type'IndexColumn'class + type'Reference'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Element'class + (type'Table'class + (type'Database'class + (type'Index'class + (type'Column'class + (type'IndexColumn'class + type'Reference'class))))) { child = util'language.util'root || (some parent: type'Element'class + (type'Table'class + (type'Database'class + (type'Index'class + (type'Column'class + (type'IndexColumn'class + type'Reference'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Element'class + (type'Table'class + (type'Database'class + (type'Index'class + (type'Column'class + (type'IndexColumn'class + type'Reference'class))))) { circle->circle in ^ (util'language.util'contains) }
}
