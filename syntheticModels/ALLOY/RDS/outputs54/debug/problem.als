one sig util'language {
	util'root : one type'Table'class + (type'Column'class + (type'Database'class + (type'Element'class + (type'Reference'class + (type'Index'class + type'IndexColumn'class))))),
	util'contains : (type'Table'class + (type'Column'class + (type'Database'class + (type'Element'class + (type'Reference'class + (type'Index'class + type'IndexColumn'class)))))) lone->set (type'Table'class + (type'Column'class + (type'Database'class + (type'Element'class + (type'Reference'class + (type'Index'class + type'IndexColumn'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Table'class + (type'Column'class + (type'Database'class + (type'Element'class + (type'Reference'class + (type'Index'class + type'IndexColumn'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Table'class + (type'Column'class + (type'Database'class + (type'Element'class + (type'Reference'class + (type'Index'class + type'IndexColumn'class))))) { child = util'language.util'root or (some parent: type'Table'class + (type'Column'class + (type'Database'class + (type'Element'class + (type'Reference'class + (type'Index'class + type'IndexColumn'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Table'class + (type'Column'class + (type'Database'class + (type'Element'class + (type'Reference'class + (type'Index'class + type'IndexColumn'class))))) { circle->circle in ^ (util'language.util'contains) }
}
