one sig util'language {
	util'root : one type'Index'class + (type'Reference'class + (type'Element'class + (type'IndexColumn'class + (type'Database'class + (type'Table'class + type'Column'class))))),
	util'contains : (type'Index'class + (type'Reference'class + (type'Element'class + (type'IndexColumn'class + (type'Database'class + (type'Table'class + type'Column'class)))))) lone->set (type'Index'class + (type'Reference'class + (type'Element'class + (type'IndexColumn'class + (type'Database'class + (type'Table'class + type'Column'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Index'class + (type'Reference'class + (type'Element'class + (type'IndexColumn'class + (type'Database'class + (type'Table'class + type'Column'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Index'class + (type'Reference'class + (type'Element'class + (type'IndexColumn'class + (type'Database'class + (type'Table'class + type'Column'class))))) { child = util'language.util'root || (some parent: type'Index'class + (type'Reference'class + (type'Element'class + (type'IndexColumn'class + (type'Database'class + (type'Table'class + type'Column'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Index'class + (type'Reference'class + (type'Element'class + (type'IndexColumn'class + (type'Database'class + (type'Table'class + type'Column'class))))) { circle->circle in ^ (util'language.util'contains) }
}
