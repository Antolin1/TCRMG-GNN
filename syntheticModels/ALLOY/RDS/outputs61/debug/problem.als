one sig util'language {
	util'root : one type'Index'class + (type'Element'class + (type'Table'class + (type'Reference'class + (type'Column'class + (type'Database'class + type'IndexColumn'class))))),
	util'contains : (type'Index'class + (type'Element'class + (type'Table'class + (type'Reference'class + (type'Column'class + (type'Database'class + type'IndexColumn'class)))))) lone->set (type'Index'class + (type'Element'class + (type'Table'class + (type'Reference'class + (type'Column'class + (type'Database'class + type'IndexColumn'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Index'class + (type'Element'class + (type'Table'class + (type'Reference'class + (type'Column'class + (type'Database'class + type'IndexColumn'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Index'class + (type'Element'class + (type'Table'class + (type'Reference'class + (type'Column'class + (type'Database'class + type'IndexColumn'class))))) { child = util'language.util'root || (some parent: type'Index'class + (type'Element'class + (type'Table'class + (type'Reference'class + (type'Column'class + (type'Database'class + type'IndexColumn'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Index'class + (type'Element'class + (type'Table'class + (type'Reference'class + (type'Column'class + (type'Database'class + type'IndexColumn'class))))) { circle->circle in ^ (util'language.util'contains) }
}
