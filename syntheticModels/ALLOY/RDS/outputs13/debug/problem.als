one sig util'language {
	util'root : one type'Index'class + (type'Column'class + (type'Reference'class + (type'Element'class + (type'Database'class + (type'IndexColumn'class + type'Table'class))))),
	util'contains : (type'Index'class + (type'Column'class + (type'Reference'class + (type'Element'class + (type'Database'class + (type'IndexColumn'class + type'Table'class)))))) lone->set (type'Index'class + (type'Column'class + (type'Reference'class + (type'Element'class + (type'Database'class + (type'IndexColumn'class + type'Table'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Index'class + (type'Column'class + (type'Reference'class + (type'Element'class + (type'Database'class + (type'IndexColumn'class + type'Table'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Index'class + (type'Column'class + (type'Reference'class + (type'Element'class + (type'Database'class + (type'IndexColumn'class + type'Table'class))))) { child = util'language.util'root or (some parent: type'Index'class + (type'Column'class + (type'Reference'class + (type'Element'class + (type'Database'class + (type'IndexColumn'class + type'Table'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Index'class + (type'Column'class + (type'Reference'class + (type'Element'class + (type'Database'class + (type'IndexColumn'class + type'Table'class))))) { circle->circle in ^ (util'language.util'contains) }
}
