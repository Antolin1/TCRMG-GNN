one sig util'language {
	util'root : one type'Table'class + (type'Database'class + (type'Reference'class + (type'IndexColumn'class + (type'Element'class + (type'Column'class + type'Index'class))))),
	util'contains : (type'Table'class + (type'Database'class + (type'Reference'class + (type'IndexColumn'class + (type'Element'class + (type'Column'class + type'Index'class)))))) lone->set (type'Table'class + (type'Database'class + (type'Reference'class + (type'IndexColumn'class + (type'Element'class + (type'Column'class + type'Index'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Table'class + (type'Database'class + (type'Reference'class + (type'IndexColumn'class + (type'Element'class + (type'Column'class + type'Index'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Table'class + (type'Database'class + (type'Reference'class + (type'IndexColumn'class + (type'Element'class + (type'Column'class + type'Index'class))))) { child = util'language.util'root or (some parent: type'Table'class + (type'Database'class + (type'Reference'class + (type'IndexColumn'class + (type'Element'class + (type'Column'class + type'Index'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Table'class + (type'Database'class + (type'Reference'class + (type'IndexColumn'class + (type'Element'class + (type'Column'class + type'Index'class))))) { circle->circle in ^ (util'language.util'contains) }
}
