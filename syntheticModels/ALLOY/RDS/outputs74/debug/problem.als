one sig util'language {
	util'root : one type'Reference'class + (type'IndexColumn'class + (type'Element'class + (type'Column'class + (type'Index'class + (type'Table'class + type'Database'class))))),
	util'contains : (type'Reference'class + (type'IndexColumn'class + (type'Element'class + (type'Column'class + (type'Index'class + (type'Table'class + type'Database'class)))))) lone->set (type'Reference'class + (type'IndexColumn'class + (type'Element'class + (type'Column'class + (type'Index'class + (type'Table'class + type'Database'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Reference'class + (type'IndexColumn'class + (type'Element'class + (type'Column'class + (type'Index'class + (type'Table'class + type'Database'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Reference'class + (type'IndexColumn'class + (type'Element'class + (type'Column'class + (type'Index'class + (type'Table'class + type'Database'class))))) { child = util'language.util'root or (some parent: type'Reference'class + (type'IndexColumn'class + (type'Element'class + (type'Column'class + (type'Index'class + (type'Table'class + type'Database'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Reference'class + (type'IndexColumn'class + (type'Element'class + (type'Column'class + (type'Index'class + (type'Table'class + type'Database'class))))) { circle->circle in ^ (util'language.util'contains) }
}
