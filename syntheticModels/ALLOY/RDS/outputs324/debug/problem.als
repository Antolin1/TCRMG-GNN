one sig util'language {
	util'root : one type'Database'class + (type'Index'class + (type'IndexColumn'class + (type'Reference'class + (type'Table'class + (type'Element'class + type'Column'class))))),
	util'contains : (type'Database'class + (type'Index'class + (type'IndexColumn'class + (type'Reference'class + (type'Table'class + (type'Element'class + type'Column'class)))))) lone->set (type'Database'class + (type'Index'class + (type'IndexColumn'class + (type'Reference'class + (type'Table'class + (type'Element'class + type'Column'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Database'class + (type'Index'class + (type'IndexColumn'class + (type'Reference'class + (type'Table'class + (type'Element'class + type'Column'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Database'class + (type'Index'class + (type'IndexColumn'class + (type'Reference'class + (type'Table'class + (type'Element'class + type'Column'class))))) { child = util'language.util'root || (some parent: type'Database'class + (type'Index'class + (type'IndexColumn'class + (type'Reference'class + (type'Table'class + (type'Element'class + type'Column'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Database'class + (type'Index'class + (type'IndexColumn'class + (type'Reference'class + (type'Table'class + (type'Element'class + type'Column'class))))) { circle->circle in ^ (util'language.util'contains) }
}
