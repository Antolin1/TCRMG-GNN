one sig util'language {
	util'root : one type'Column'class + (type'Database'class + (type'Reference'class + (type'Element'class + (type'Index'class + (type'Table'class + type'IndexColumn'class))))),
	util'contains : (type'Column'class + (type'Database'class + (type'Reference'class + (type'Element'class + (type'Index'class + (type'Table'class + type'IndexColumn'class)))))) lone->set (type'Column'class + (type'Database'class + (type'Reference'class + (type'Element'class + (type'Index'class + (type'Table'class + type'IndexColumn'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Column'class + (type'Database'class + (type'Reference'class + (type'Element'class + (type'Index'class + (type'Table'class + type'IndexColumn'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Column'class + (type'Database'class + (type'Reference'class + (type'Element'class + (type'Index'class + (type'Table'class + type'IndexColumn'class))))) { child = util'language.util'root or (some parent: type'Column'class + (type'Database'class + (type'Reference'class + (type'Element'class + (type'Index'class + (type'Table'class + type'IndexColumn'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Column'class + (type'Database'class + (type'Reference'class + (type'Element'class + (type'Index'class + (type'Table'class + type'IndexColumn'class))))) { circle->circle in ^ (util'language.util'contains) }
}
