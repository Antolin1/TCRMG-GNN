one sig util'language {
	util'root : one type'Element'class + (type'IndexColumn'class + (type'Table'class + (type'Reference'class + (type'Column'class + (type'Database'class + type'Index'class))))),
	util'contains : (type'Element'class + (type'IndexColumn'class + (type'Table'class + (type'Reference'class + (type'Column'class + (type'Database'class + type'Index'class)))))) lone->set (type'Element'class + (type'IndexColumn'class + (type'Table'class + (type'Reference'class + (type'Column'class + (type'Database'class + type'Index'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Element'class + (type'IndexColumn'class + (type'Table'class + (type'Reference'class + (type'Column'class + (type'Database'class + type'Index'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Element'class + (type'IndexColumn'class + (type'Table'class + (type'Reference'class + (type'Column'class + (type'Database'class + type'Index'class))))) { child = util'language.util'root || (some parent: type'Element'class + (type'IndexColumn'class + (type'Table'class + (type'Reference'class + (type'Column'class + (type'Database'class + type'Index'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Element'class + (type'IndexColumn'class + (type'Table'class + (type'Reference'class + (type'Column'class + (type'Database'class + type'Index'class))))) { circle->circle in ^ (util'language.util'contains) }
}
