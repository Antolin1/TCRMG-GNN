one sig util'language {
	util'root : one type'Database'class + (type'Column'class + (type'IndexColumn'class + (type'Reference'class + (type'Element'class + (type'Index'class + type'Table'class))))),
	util'contains : (type'Database'class + (type'Column'class + (type'IndexColumn'class + (type'Reference'class + (type'Element'class + (type'Index'class + type'Table'class)))))) lone->set (type'Database'class + (type'Column'class + (type'IndexColumn'class + (type'Reference'class + (type'Element'class + (type'Index'class + type'Table'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Database'class + (type'Column'class + (type'IndexColumn'class + (type'Reference'class + (type'Element'class + (type'Index'class + type'Table'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Database'class + (type'Column'class + (type'IndexColumn'class + (type'Reference'class + (type'Element'class + (type'Index'class + type'Table'class))))) { child = util'language.util'root || (some parent: type'Database'class + (type'Column'class + (type'IndexColumn'class + (type'Reference'class + (type'Element'class + (type'Index'class + type'Table'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Database'class + (type'Column'class + (type'IndexColumn'class + (type'Reference'class + (type'Element'class + (type'Index'class + type'Table'class))))) { circle->circle in ^ (util'language.util'contains) }
}
