one sig util'language {
	util'root : one type'Column'class + (type'IndexColumn'class + (type'Reference'class + (type'Index'class + (type'Database'class + (type'Element'class + type'Table'class))))),
	util'contains : (type'Column'class + (type'IndexColumn'class + (type'Reference'class + (type'Index'class + (type'Database'class + (type'Element'class + type'Table'class)))))) lone->set (type'Column'class + (type'IndexColumn'class + (type'Reference'class + (type'Index'class + (type'Database'class + (type'Element'class + type'Table'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Column'class + (type'IndexColumn'class + (type'Reference'class + (type'Index'class + (type'Database'class + (type'Element'class + type'Table'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Column'class + (type'IndexColumn'class + (type'Reference'class + (type'Index'class + (type'Database'class + (type'Element'class + type'Table'class))))) { child = util'language.util'root || (some parent: type'Column'class + (type'IndexColumn'class + (type'Reference'class + (type'Index'class + (type'Database'class + (type'Element'class + type'Table'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Column'class + (type'IndexColumn'class + (type'Reference'class + (type'Index'class + (type'Database'class + (type'Element'class + type'Table'class))))) { circle->circle in ^ (util'language.util'contains) }
}
