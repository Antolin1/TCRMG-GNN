one sig util'language {
	util'root : one type'Reference'class + (type'Table'class + (type'Element'class + (type'Database'class + (type'Column'class + (type'Index'class + type'IndexColumn'class))))),
	util'contains : (type'Reference'class + (type'Table'class + (type'Element'class + (type'Database'class + (type'Column'class + (type'Index'class + type'IndexColumn'class)))))) lone->set (type'Reference'class + (type'Table'class + (type'Element'class + (type'Database'class + (type'Column'class + (type'Index'class + type'IndexColumn'class))))))
}
...
fact util'noParentForRoot {
	no parent: type'Reference'class + (type'Table'class + (type'Element'class + (type'Database'class + (type'Column'class + (type'Index'class + type'IndexColumn'class))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Reference'class + (type'Table'class + (type'Element'class + (type'Database'class + (type'Column'class + (type'Index'class + type'IndexColumn'class))))) { child = util'language.util'root || (some parent: type'Reference'class + (type'Table'class + (type'Element'class + (type'Database'class + (type'Column'class + (type'Index'class + type'IndexColumn'class))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Reference'class + (type'Table'class + (type'Element'class + (type'Database'class + (type'Column'class + (type'Index'class + type'IndexColumn'class))))) { circle->circle in ^ (util'language.util'contains) }
}
