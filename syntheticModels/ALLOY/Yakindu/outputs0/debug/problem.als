one sig util'language {
	...
	util'root : one type'Vertex'class + (type'State'class + (type'Entry'class + (type'Transition'class + (type'Region'class + (type'Statechart'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Pseudostate'class + (type'Exit'class + type'Choice'class))))))))))))),
	util'contains : (type'Vertex'class + (type'State'class + (type'Entry'class + (type'Transition'class + (type'Region'class + (type'Statechart'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Pseudostate'class + (type'Exit'class + type'Choice'class)))))))))))))) lone->set (type'Vertex'class + (type'State'class + (type'Entry'class + (type'Transition'class + (type'Region'class + (type'Statechart'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Pseudostate'class + (type'Exit'class + type'Choice'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Vertex'class + (type'State'class + (type'Entry'class + (type'Transition'class + (type'Region'class + (type'Statechart'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Pseudostate'class + (type'Exit'class + type'Choice'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Vertex'class + (type'State'class + (type'Entry'class + (type'Transition'class + (type'Region'class + (type'Statechart'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Pseudostate'class + (type'Exit'class + type'Choice'class))))))))))))) { child = util'language.util'root || (some parent: type'Vertex'class + (type'State'class + (type'Entry'class + (type'Transition'class + (type'Region'class + (type'Statechart'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Pseudostate'class + (type'Exit'class + type'Choice'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Vertex'class + (type'State'class + (type'Entry'class + (type'Transition'class + (type'Region'class + (type'Statechart'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Pseudostate'class + (type'Exit'class + type'Choice'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
