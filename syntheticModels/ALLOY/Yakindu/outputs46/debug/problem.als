one sig util'language {
	...
	util'root : one type'Statechart'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Exit'class + (type'Entry'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'State'class + type'Synchronization'class))))))))))))),
	util'contains : (type'Statechart'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Exit'class + (type'Entry'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'State'class + type'Synchronization'class)))))))))))))) lone->set (type'Statechart'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Exit'class + (type'Entry'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'State'class + type'Synchronization'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Statechart'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Exit'class + (type'Entry'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'State'class + type'Synchronization'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Statechart'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Exit'class + (type'Entry'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'State'class + type'Synchronization'class))))))))))))) { child = util'language.util'root or (some parent: type'Statechart'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Exit'class + (type'Entry'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'State'class + type'Synchronization'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Statechart'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Exit'class + (type'Entry'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'State'class + type'Synchronization'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
