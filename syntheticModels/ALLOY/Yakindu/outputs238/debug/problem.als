one sig util'language {
	...
	util'root : one type'Pseudostate'class + (type'Entry'class + (type'Choice'class + (type'Vertex'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'Exit'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + type'Region'class))))))))))))),
	util'contains : (type'Pseudostate'class + (type'Entry'class + (type'Choice'class + (type'Vertex'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'Exit'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + type'Region'class)))))))))))))) lone->set (type'Pseudostate'class + (type'Entry'class + (type'Choice'class + (type'Vertex'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'Exit'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + type'Region'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Pseudostate'class + (type'Entry'class + (type'Choice'class + (type'Vertex'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'Exit'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + type'Region'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Pseudostate'class + (type'Entry'class + (type'Choice'class + (type'Vertex'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'Exit'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + type'Region'class))))))))))))) { child = util'language.util'root || (some parent: type'Pseudostate'class + (type'Entry'class + (type'Choice'class + (type'Vertex'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'Exit'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + type'Region'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Pseudostate'class + (type'Entry'class + (type'Choice'class + (type'Vertex'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'Exit'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + type'Region'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
