one sig util'language {
	...
	util'root : one type'Region'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'Pseudostate'class + (type'FinalState'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + type'Entry'class))))))))))))),
	util'contains : (type'Region'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'Pseudostate'class + (type'FinalState'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + type'Entry'class)))))))))))))) lone->set (type'Region'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'Pseudostate'class + (type'FinalState'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + type'Entry'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Region'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'Pseudostate'class + (type'FinalState'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + type'Entry'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Region'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'Pseudostate'class + (type'FinalState'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + type'Entry'class))))))))))))) { child = util'language.util'root || (some parent: type'Region'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'Pseudostate'class + (type'FinalState'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + type'Entry'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Region'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'Pseudostate'class + (type'FinalState'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + type'Entry'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
