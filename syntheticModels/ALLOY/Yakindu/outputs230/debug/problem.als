one sig util'language {
	...
	util'root : one type'Vertex'class + (type'FinalState'class + (type'State'class + (type'Transition'class + (type'Pseudostate'class + (type'Entry'class + (type'Exit'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Choice'class + type'Region'class))))))))))))),
	util'contains : (type'Vertex'class + (type'FinalState'class + (type'State'class + (type'Transition'class + (type'Pseudostate'class + (type'Entry'class + (type'Exit'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Choice'class + type'Region'class)))))))))))))) lone->set (type'Vertex'class + (type'FinalState'class + (type'State'class + (type'Transition'class + (type'Pseudostate'class + (type'Entry'class + (type'Exit'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Choice'class + type'Region'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Vertex'class + (type'FinalState'class + (type'State'class + (type'Transition'class + (type'Pseudostate'class + (type'Entry'class + (type'Exit'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Choice'class + type'Region'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Vertex'class + (type'FinalState'class + (type'State'class + (type'Transition'class + (type'Pseudostate'class + (type'Entry'class + (type'Exit'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Choice'class + type'Region'class))))))))))))) { child = util'language.util'root || (some parent: type'Vertex'class + (type'FinalState'class + (type'State'class + (type'Transition'class + (type'Pseudostate'class + (type'Entry'class + (type'Exit'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Choice'class + type'Region'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Vertex'class + (type'FinalState'class + (type'State'class + (type'Transition'class + (type'Pseudostate'class + (type'Entry'class + (type'Exit'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Choice'class + type'Region'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
