one sig util'language {
	...
	util'root : one type'Transition'class + (type'Statechart'class + (type'Pseudostate'class + (type'Vertex'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'State'class + (type'Region'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Exit'class + type'Entry'class))))))))))))),
	util'contains : (type'Transition'class + (type'Statechart'class + (type'Pseudostate'class + (type'Vertex'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'State'class + (type'Region'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Exit'class + type'Entry'class)))))))))))))) lone->set (type'Transition'class + (type'Statechart'class + (type'Pseudostate'class + (type'Vertex'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'State'class + (type'Region'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Exit'class + type'Entry'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Transition'class + (type'Statechart'class + (type'Pseudostate'class + (type'Vertex'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'State'class + (type'Region'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Exit'class + type'Entry'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Transition'class + (type'Statechart'class + (type'Pseudostate'class + (type'Vertex'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'State'class + (type'Region'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Exit'class + type'Entry'class))))))))))))) { child = util'language.util'root or (some parent: type'Transition'class + (type'Statechart'class + (type'Pseudostate'class + (type'Vertex'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'State'class + (type'Region'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Exit'class + type'Entry'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Transition'class + (type'Statechart'class + (type'Pseudostate'class + (type'Vertex'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'State'class + (type'Region'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Exit'class + type'Entry'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
