one sig util'language {
	...
	util'root : one type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Region'class + (type'Vertex'class + (type'Choice'class + (type'Pseudostate'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'State'class + (type'Entry'class + type'Synchronization'class))))))))))))),
	util'contains : (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Region'class + (type'Vertex'class + (type'Choice'class + (type'Pseudostate'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'State'class + (type'Entry'class + type'Synchronization'class)))))))))))))) lone->set (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Region'class + (type'Vertex'class + (type'Choice'class + (type'Pseudostate'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'State'class + (type'Entry'class + type'Synchronization'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Region'class + (type'Vertex'class + (type'Choice'class + (type'Pseudostate'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'State'class + (type'Entry'class + type'Synchronization'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Region'class + (type'Vertex'class + (type'Choice'class + (type'Pseudostate'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'State'class + (type'Entry'class + type'Synchronization'class))))))))))))) { child = util'language.util'root || (some parent: type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Region'class + (type'Vertex'class + (type'Choice'class + (type'Pseudostate'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'State'class + (type'Entry'class + type'Synchronization'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Region'class + (type'Vertex'class + (type'Choice'class + (type'Pseudostate'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'State'class + (type'Entry'class + type'Synchronization'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
