one sig util'language {
	...
	util'root : one type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'FinalState'class + (type'Vertex'class + (type'Statechart'class + (type'Choice'class + (type'Transition'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Synchronization'class + type'Region'class))))))))))))),
	util'contains : (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'FinalState'class + (type'Vertex'class + (type'Statechart'class + (type'Choice'class + (type'Transition'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Synchronization'class + type'Region'class)))))))))))))) lone->set (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'FinalState'class + (type'Vertex'class + (type'Statechart'class + (type'Choice'class + (type'Transition'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Synchronization'class + type'Region'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'FinalState'class + (type'Vertex'class + (type'Statechart'class + (type'Choice'class + (type'Transition'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Synchronization'class + type'Region'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'FinalState'class + (type'Vertex'class + (type'Statechart'class + (type'Choice'class + (type'Transition'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Synchronization'class + type'Region'class))))))))))))) { child = util'language.util'root || (some parent: type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'FinalState'class + (type'Vertex'class + (type'Statechart'class + (type'Choice'class + (type'Transition'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Synchronization'class + type'Region'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'FinalState'class + (type'Vertex'class + (type'Statechart'class + (type'Choice'class + (type'Transition'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Synchronization'class + type'Region'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
