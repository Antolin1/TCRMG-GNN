one sig util'language {
	...
	util'root : one type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + (type'Transition'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Vertex'class + type'Choice'class))))))))))))),
	util'contains : (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + (type'Transition'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Vertex'class + type'Choice'class)))))))))))))) lone->set (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + (type'Transition'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Vertex'class + type'Choice'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + (type'Transition'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Vertex'class + type'Choice'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + (type'Transition'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Vertex'class + type'Choice'class))))))))))))) { child = util'language.util'root || (some parent: type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + (type'Transition'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Vertex'class + type'Choice'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + (type'Transition'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Vertex'class + type'Choice'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
