one sig util'language {
	...
	util'root : one type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'FinalState'class + (type'Pseudostate'class + (type'State'class + (type'Region'class + (type'Exit'class + (type'Synchronization'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Entry'class + type'Transition'class))))))))))))),
	util'contains : (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'FinalState'class + (type'Pseudostate'class + (type'State'class + (type'Region'class + (type'Exit'class + (type'Synchronization'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Entry'class + type'Transition'class)))))))))))))) lone->set (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'FinalState'class + (type'Pseudostate'class + (type'State'class + (type'Region'class + (type'Exit'class + (type'Synchronization'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Entry'class + type'Transition'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'FinalState'class + (type'Pseudostate'class + (type'State'class + (type'Region'class + (type'Exit'class + (type'Synchronization'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Entry'class + type'Transition'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'FinalState'class + (type'Pseudostate'class + (type'State'class + (type'Region'class + (type'Exit'class + (type'Synchronization'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Entry'class + type'Transition'class))))))))))))) { child = util'language.util'root || (some parent: type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'FinalState'class + (type'Pseudostate'class + (type'State'class + (type'Region'class + (type'Exit'class + (type'Synchronization'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Entry'class + type'Transition'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'FinalState'class + (type'Pseudostate'class + (type'State'class + (type'Region'class + (type'Exit'class + (type'Synchronization'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Entry'class + type'Transition'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
