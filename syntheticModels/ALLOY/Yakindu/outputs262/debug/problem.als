one sig util'language {
	...
	util'root : one type'Statechart'class + (type'State'class + (type'Exit'class + (type'Vertex'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Entry'class + (type'Region'class + (type'FinalState'class + (type'Transition'class + (type'RegularState'class + (type'State'class + type'Choice'class))))))))))))),
	util'contains : (type'Statechart'class + (type'State'class + (type'Exit'class + (type'Vertex'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Entry'class + (type'Region'class + (type'FinalState'class + (type'Transition'class + (type'RegularState'class + (type'State'class + type'Choice'class)))))))))))))) lone->set (type'Statechart'class + (type'State'class + (type'Exit'class + (type'Vertex'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Entry'class + (type'Region'class + (type'FinalState'class + (type'Transition'class + (type'RegularState'class + (type'State'class + type'Choice'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Statechart'class + (type'State'class + (type'Exit'class + (type'Vertex'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Entry'class + (type'Region'class + (type'FinalState'class + (type'Transition'class + (type'RegularState'class + (type'State'class + type'Choice'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Statechart'class + (type'State'class + (type'Exit'class + (type'Vertex'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Entry'class + (type'Region'class + (type'FinalState'class + (type'Transition'class + (type'RegularState'class + (type'State'class + type'Choice'class))))))))))))) { child = util'language.util'root or (some parent: type'Statechart'class + (type'State'class + (type'Exit'class + (type'Vertex'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Entry'class + (type'Region'class + (type'FinalState'class + (type'Transition'class + (type'RegularState'class + (type'State'class + type'Choice'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Statechart'class + (type'State'class + (type'Exit'class + (type'Vertex'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Entry'class + (type'Region'class + (type'FinalState'class + (type'Transition'class + (type'RegularState'class + (type'State'class + type'Choice'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
