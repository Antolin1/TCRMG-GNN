one sig util'language {
	...
	util'root : one type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'Region'class + (type'Entry'class + (type'FinalState'class + (type'Exit'class + (type'Choice'class + (type'Pseudostate'class + type'State'class))))))))))))),
	util'contains : (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'Region'class + (type'Entry'class + (type'FinalState'class + (type'Exit'class + (type'Choice'class + (type'Pseudostate'class + type'State'class)))))))))))))) lone->set (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'Region'class + (type'Entry'class + (type'FinalState'class + (type'Exit'class + (type'Choice'class + (type'Pseudostate'class + type'State'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'Region'class + (type'Entry'class + (type'FinalState'class + (type'Exit'class + (type'Choice'class + (type'Pseudostate'class + type'State'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'Region'class + (type'Entry'class + (type'FinalState'class + (type'Exit'class + (type'Choice'class + (type'Pseudostate'class + type'State'class))))))))))))) { child = util'language.util'root || (some parent: type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'Region'class + (type'Entry'class + (type'FinalState'class + (type'Exit'class + (type'Choice'class + (type'Pseudostate'class + type'State'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'Region'class + (type'Entry'class + (type'FinalState'class + (type'Exit'class + (type'Choice'class + (type'Pseudostate'class + type'State'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
