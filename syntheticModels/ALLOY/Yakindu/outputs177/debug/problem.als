one sig util'language {
	...
	util'root : one type'Exit'class + (type'Region'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Vertex'class + (type'Pseudostate'class + (type'Choice'class + (type'RegularState'class + type'State'class))))))))))))),
	util'contains : (type'Exit'class + (type'Region'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Vertex'class + (type'Pseudostate'class + (type'Choice'class + (type'RegularState'class + type'State'class)))))))))))))) lone->set (type'Exit'class + (type'Region'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Vertex'class + (type'Pseudostate'class + (type'Choice'class + (type'RegularState'class + type'State'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Exit'class + (type'Region'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Vertex'class + (type'Pseudostate'class + (type'Choice'class + (type'RegularState'class + type'State'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Exit'class + (type'Region'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Vertex'class + (type'Pseudostate'class + (type'Choice'class + (type'RegularState'class + type'State'class))))))))))))) { child = util'language.util'root || (some parent: type'Exit'class + (type'Region'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Vertex'class + (type'Pseudostate'class + (type'Choice'class + (type'RegularState'class + type'State'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Exit'class + (type'Region'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Vertex'class + (type'Pseudostate'class + (type'Choice'class + (type'RegularState'class + type'State'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
