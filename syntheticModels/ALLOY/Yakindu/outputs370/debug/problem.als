one sig util'language {
	...
	util'root : one type'Statechart'class + (type'Vertex'class + (type'Pseudostate'class + (type'Choice'class + (type'FinalState'class + (type'Entry'class + (type'State'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + type'Exit'class))))))))))))),
	util'contains : (type'Statechart'class + (type'Vertex'class + (type'Pseudostate'class + (type'Choice'class + (type'FinalState'class + (type'Entry'class + (type'State'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + type'Exit'class)))))))))))))) lone->set (type'Statechart'class + (type'Vertex'class + (type'Pseudostate'class + (type'Choice'class + (type'FinalState'class + (type'Entry'class + (type'State'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + type'Exit'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Statechart'class + (type'Vertex'class + (type'Pseudostate'class + (type'Choice'class + (type'FinalState'class + (type'Entry'class + (type'State'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + type'Exit'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Statechart'class + (type'Vertex'class + (type'Pseudostate'class + (type'Choice'class + (type'FinalState'class + (type'Entry'class + (type'State'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + type'Exit'class))))))))))))) { child = util'language.util'root || (some parent: type'Statechart'class + (type'Vertex'class + (type'Pseudostate'class + (type'Choice'class + (type'FinalState'class + (type'Entry'class + (type'State'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + type'Exit'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Statechart'class + (type'Vertex'class + (type'Pseudostate'class + (type'Choice'class + (type'FinalState'class + (type'Entry'class + (type'State'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + type'Exit'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
