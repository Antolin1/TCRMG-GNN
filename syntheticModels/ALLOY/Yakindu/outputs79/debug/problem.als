one sig util'language {
	...
	util'root : one type'Pseudostate'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Entry'class + (type'Synchronization'class + (type'State'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Statechart'class + (type'Choice'class + type'FinalState'class))))))))))))),
	util'contains : (type'Pseudostate'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Entry'class + (type'Synchronization'class + (type'State'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Statechart'class + (type'Choice'class + type'FinalState'class)))))))))))))) lone->set (type'Pseudostate'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Entry'class + (type'Synchronization'class + (type'State'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Statechart'class + (type'Choice'class + type'FinalState'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Pseudostate'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Entry'class + (type'Synchronization'class + (type'State'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Statechart'class + (type'Choice'class + type'FinalState'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Pseudostate'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Entry'class + (type'Synchronization'class + (type'State'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Statechart'class + (type'Choice'class + type'FinalState'class))))))))))))) { child = util'language.util'root || (some parent: type'Pseudostate'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Entry'class + (type'Synchronization'class + (type'State'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Statechart'class + (type'Choice'class + type'FinalState'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Pseudostate'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Entry'class + (type'Synchronization'class + (type'State'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Statechart'class + (type'Choice'class + type'FinalState'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
