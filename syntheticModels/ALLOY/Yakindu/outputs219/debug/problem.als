one sig util'language {
	...
	util'root : one type'Choice'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + type'Vertex'class))))))))))))),
	util'contains : (type'Choice'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + type'Vertex'class)))))))))))))) lone->set (type'Choice'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + type'Vertex'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Choice'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + type'Vertex'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Choice'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + type'Vertex'class))))))))))))) { child = util'language.util'root || (some parent: type'Choice'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + type'Vertex'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Choice'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + type'Vertex'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
