one sig util'language {
	...
	util'root : one type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Choice'class + (type'Synchronization'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'Vertex'class + (type'Pseudostate'class + (type'Exit'class + type'Region'class))))))))))))),
	util'contains : (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Choice'class + (type'Synchronization'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'Vertex'class + (type'Pseudostate'class + (type'Exit'class + type'Region'class)))))))))))))) lone->set (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Choice'class + (type'Synchronization'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'Vertex'class + (type'Pseudostate'class + (type'Exit'class + type'Region'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Choice'class + (type'Synchronization'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'Vertex'class + (type'Pseudostate'class + (type'Exit'class + type'Region'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Choice'class + (type'Synchronization'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'Vertex'class + (type'Pseudostate'class + (type'Exit'class + type'Region'class))))))))))))) { child = util'language.util'root || (some parent: type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Choice'class + (type'Synchronization'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'Vertex'class + (type'Pseudostate'class + (type'Exit'class + type'Region'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Choice'class + (type'Synchronization'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'Vertex'class + (type'Pseudostate'class + (type'Exit'class + type'Region'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
