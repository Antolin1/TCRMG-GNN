one sig util'language {
	...
	util'root : one type'Pseudostate'class + (type'Region'class + (type'Choice'class + (type'Vertex'class + (type'Entry'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Synchronization'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + type'Exit'class))))))))))))),
	util'contains : (type'Pseudostate'class + (type'Region'class + (type'Choice'class + (type'Vertex'class + (type'Entry'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Synchronization'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + type'Exit'class)))))))))))))) lone->set (type'Pseudostate'class + (type'Region'class + (type'Choice'class + (type'Vertex'class + (type'Entry'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Synchronization'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + type'Exit'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Pseudostate'class + (type'Region'class + (type'Choice'class + (type'Vertex'class + (type'Entry'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Synchronization'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + type'Exit'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Pseudostate'class + (type'Region'class + (type'Choice'class + (type'Vertex'class + (type'Entry'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Synchronization'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + type'Exit'class))))))))))))) { child = util'language.util'root or (some parent: type'Pseudostate'class + (type'Region'class + (type'Choice'class + (type'Vertex'class + (type'Entry'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Synchronization'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + type'Exit'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Pseudostate'class + (type'Region'class + (type'Choice'class + (type'Vertex'class + (type'Entry'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Synchronization'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + type'Exit'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
