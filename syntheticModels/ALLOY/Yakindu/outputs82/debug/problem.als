one sig util'language {
	...
	util'root : one type'Region'class + (type'Exit'class + (type'FinalState'class + (type'Pseudostate'class + (type'Entry'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Choice'class + (type'Statechart'class + type'State'class))))))))))))),
	util'contains : (type'Region'class + (type'Exit'class + (type'FinalState'class + (type'Pseudostate'class + (type'Entry'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Choice'class + (type'Statechart'class + type'State'class)))))))))))))) lone->set (type'Region'class + (type'Exit'class + (type'FinalState'class + (type'Pseudostate'class + (type'Entry'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Choice'class + (type'Statechart'class + type'State'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Region'class + (type'Exit'class + (type'FinalState'class + (type'Pseudostate'class + (type'Entry'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Choice'class + (type'Statechart'class + type'State'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Region'class + (type'Exit'class + (type'FinalState'class + (type'Pseudostate'class + (type'Entry'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Choice'class + (type'Statechart'class + type'State'class))))))))))))) { child = util'language.util'root || (some parent: type'Region'class + (type'Exit'class + (type'FinalState'class + (type'Pseudostate'class + (type'Entry'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Choice'class + (type'Statechart'class + type'State'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Region'class + (type'Exit'class + (type'FinalState'class + (type'Pseudostate'class + (type'Entry'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Choice'class + (type'Statechart'class + type'State'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
