one sig util'language {
	...
	util'root : one type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Region'class + (type'State'class + (type'Transition'class + (type'Exit'class + (type'Entry'class + type'Vertex'class))))))))))))),
	util'contains : (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Region'class + (type'State'class + (type'Transition'class + (type'Exit'class + (type'Entry'class + type'Vertex'class)))))))))))))) lone->set (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Region'class + (type'State'class + (type'Transition'class + (type'Exit'class + (type'Entry'class + type'Vertex'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Region'class + (type'State'class + (type'Transition'class + (type'Exit'class + (type'Entry'class + type'Vertex'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Region'class + (type'State'class + (type'Transition'class + (type'Exit'class + (type'Entry'class + type'Vertex'class))))))))))))) { child = util'language.util'root || (some parent: type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Region'class + (type'State'class + (type'Transition'class + (type'Exit'class + (type'Entry'class + type'Vertex'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Region'class + (type'State'class + (type'Transition'class + (type'Exit'class + (type'Entry'class + type'Vertex'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
...
run { } for exactly 4 util'Object , 2 Int , exactly 0 String