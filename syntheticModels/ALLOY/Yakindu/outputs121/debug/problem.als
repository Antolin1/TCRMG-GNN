one sig util'language {
	...
	util'root : one type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Exit'class + (type'FinalState'class + (type'Region'class + (type'Choice'class + (type'Vertex'class + (type'Entry'class + (type'Pseudostate'class + (type'Transition'class + (type'State'class + (type'CompositeElement'class + type'State'class))))))))))))),
	util'contains : (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Exit'class + (type'FinalState'class + (type'Region'class + (type'Choice'class + (type'Vertex'class + (type'Entry'class + (type'Pseudostate'class + (type'Transition'class + (type'State'class + (type'CompositeElement'class + type'State'class)))))))))))))) lone->set (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Exit'class + (type'FinalState'class + (type'Region'class + (type'Choice'class + (type'Vertex'class + (type'Entry'class + (type'Pseudostate'class + (type'Transition'class + (type'State'class + (type'CompositeElement'class + type'State'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Exit'class + (type'FinalState'class + (type'Region'class + (type'Choice'class + (type'Vertex'class + (type'Entry'class + (type'Pseudostate'class + (type'Transition'class + (type'State'class + (type'CompositeElement'class + type'State'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Exit'class + (type'FinalState'class + (type'Region'class + (type'Choice'class + (type'Vertex'class + (type'Entry'class + (type'Pseudostate'class + (type'Transition'class + (type'State'class + (type'CompositeElement'class + type'State'class))))))))))))) { child = util'language.util'root || (some parent: type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Exit'class + (type'FinalState'class + (type'Region'class + (type'Choice'class + (type'Vertex'class + (type'Entry'class + (type'Pseudostate'class + (type'Transition'class + (type'State'class + (type'CompositeElement'class + type'State'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Exit'class + (type'FinalState'class + (type'Region'class + (type'Choice'class + (type'Vertex'class + (type'Entry'class + (type'Pseudostate'class + (type'Transition'class + (type'State'class + (type'CompositeElement'class + type'State'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
