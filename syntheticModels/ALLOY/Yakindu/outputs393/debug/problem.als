one sig util'language {
	...
	util'root : one type'Transition'class + (type'Synchronization'class + (type'Pseudostate'class + (type'Vertex'class + (type'State'class + (type'Region'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Choice'class + type'Exit'class))))))))))))),
	util'contains : (type'Transition'class + (type'Synchronization'class + (type'Pseudostate'class + (type'Vertex'class + (type'State'class + (type'Region'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Choice'class + type'Exit'class)))))))))))))) lone->set (type'Transition'class + (type'Synchronization'class + (type'Pseudostate'class + (type'Vertex'class + (type'State'class + (type'Region'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Choice'class + type'Exit'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Transition'class + (type'Synchronization'class + (type'Pseudostate'class + (type'Vertex'class + (type'State'class + (type'Region'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Choice'class + type'Exit'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Transition'class + (type'Synchronization'class + (type'Pseudostate'class + (type'Vertex'class + (type'State'class + (type'Region'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Choice'class + type'Exit'class))))))))))))) { child = util'language.util'root || (some parent: type'Transition'class + (type'Synchronization'class + (type'Pseudostate'class + (type'Vertex'class + (type'State'class + (type'Region'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Choice'class + type'Exit'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Transition'class + (type'Synchronization'class + (type'Pseudostate'class + (type'Vertex'class + (type'State'class + (type'Region'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Choice'class + type'Exit'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
