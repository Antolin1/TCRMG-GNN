one sig util'language {
	...
	util'root : one type'Synchronization'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Region'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Vertex'class + (type'Statechart'class + (type'Exit'class + type'Entry'class))))))))))))),
	util'contains : (type'Synchronization'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Region'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Vertex'class + (type'Statechart'class + (type'Exit'class + type'Entry'class)))))))))))))) lone->set (type'Synchronization'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Region'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Vertex'class + (type'Statechart'class + (type'Exit'class + type'Entry'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Synchronization'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Region'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Vertex'class + (type'Statechart'class + (type'Exit'class + type'Entry'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Synchronization'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Region'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Vertex'class + (type'Statechart'class + (type'Exit'class + type'Entry'class))))))))))))) { child = util'language.util'root || (some parent: type'Synchronization'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Region'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Vertex'class + (type'Statechart'class + (type'Exit'class + type'Entry'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Synchronization'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Region'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Vertex'class + (type'Statechart'class + (type'Exit'class + type'Entry'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
