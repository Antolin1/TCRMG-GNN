one sig util'language {
	...
	util'root : one type'State'class + (type'Choice'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + (type'FinalState'class + (type'Vertex'class + (type'Transition'class + (type'Entry'class + (type'RegularState'class + type'State'class))))))))))))),
	util'contains : (type'State'class + (type'Choice'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + (type'FinalState'class + (type'Vertex'class + (type'Transition'class + (type'Entry'class + (type'RegularState'class + type'State'class)))))))))))))) lone->set (type'State'class + (type'Choice'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + (type'FinalState'class + (type'Vertex'class + (type'Transition'class + (type'Entry'class + (type'RegularState'class + type'State'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'State'class + (type'Choice'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + (type'FinalState'class + (type'Vertex'class + (type'Transition'class + (type'Entry'class + (type'RegularState'class + type'State'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'State'class + (type'Choice'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + (type'FinalState'class + (type'Vertex'class + (type'Transition'class + (type'Entry'class + (type'RegularState'class + type'State'class))))))))))))) { child = util'language.util'root || (some parent: type'State'class + (type'Choice'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + (type'FinalState'class + (type'Vertex'class + (type'Transition'class + (type'Entry'class + (type'RegularState'class + type'State'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'State'class + (type'Choice'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + (type'FinalState'class + (type'Vertex'class + (type'Transition'class + (type'Entry'class + (type'RegularState'class + type'State'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
