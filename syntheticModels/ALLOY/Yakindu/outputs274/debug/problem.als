one sig util'language {
	...
	util'root : one type'Pseudostate'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Transition'class + (type'FinalState'class + (type'Entry'class + (type'Vertex'class + (type'Statechart'class + (type'Exit'class + (type'State'class + (type'Region'class + (type'RegularState'class + type'State'class))))))))))))),
	util'contains : (type'Pseudostate'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Transition'class + (type'FinalState'class + (type'Entry'class + (type'Vertex'class + (type'Statechart'class + (type'Exit'class + (type'State'class + (type'Region'class + (type'RegularState'class + type'State'class)))))))))))))) lone->set (type'Pseudostate'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Transition'class + (type'FinalState'class + (type'Entry'class + (type'Vertex'class + (type'Statechart'class + (type'Exit'class + (type'State'class + (type'Region'class + (type'RegularState'class + type'State'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Pseudostate'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Transition'class + (type'FinalState'class + (type'Entry'class + (type'Vertex'class + (type'Statechart'class + (type'Exit'class + (type'State'class + (type'Region'class + (type'RegularState'class + type'State'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Pseudostate'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Transition'class + (type'FinalState'class + (type'Entry'class + (type'Vertex'class + (type'Statechart'class + (type'Exit'class + (type'State'class + (type'Region'class + (type'RegularState'class + type'State'class))))))))))))) { child = util'language.util'root or (some parent: type'Pseudostate'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Transition'class + (type'FinalState'class + (type'Entry'class + (type'Vertex'class + (type'Statechart'class + (type'Exit'class + (type'State'class + (type'Region'class + (type'RegularState'class + type'State'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Pseudostate'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Transition'class + (type'FinalState'class + (type'Entry'class + (type'Vertex'class + (type'Statechart'class + (type'Exit'class + (type'State'class + (type'Region'class + (type'RegularState'class + type'State'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
