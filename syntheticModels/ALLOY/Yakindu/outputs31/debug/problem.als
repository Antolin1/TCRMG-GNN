one sig util'language {
	...
	util'root : one type'State'class + (type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Transition'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Exit'class + type'Synchronization'class))))))))))))),
	util'contains : (type'State'class + (type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Transition'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Exit'class + type'Synchronization'class)))))))))))))) lone->set (type'State'class + (type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Transition'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Exit'class + type'Synchronization'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'State'class + (type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Transition'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Exit'class + type'Synchronization'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'State'class + (type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Transition'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Exit'class + type'Synchronization'class))))))))))))) { child = util'language.util'root or (some parent: type'State'class + (type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Transition'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Exit'class + type'Synchronization'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'State'class + (type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Transition'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Exit'class + type'Synchronization'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
