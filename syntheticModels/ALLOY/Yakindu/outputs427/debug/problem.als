one sig util'language {
	...
	util'root : one type'Exit'class + (type'FinalState'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'State'class + (type'Synchronization'class + (type'Vertex'class + (type'Pseudostate'class + (type'Transition'class + type'Entry'class))))))))))))),
	util'contains : (type'Exit'class + (type'FinalState'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'State'class + (type'Synchronization'class + (type'Vertex'class + (type'Pseudostate'class + (type'Transition'class + type'Entry'class)))))))))))))) lone->set (type'Exit'class + (type'FinalState'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'State'class + (type'Synchronization'class + (type'Vertex'class + (type'Pseudostate'class + (type'Transition'class + type'Entry'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Exit'class + (type'FinalState'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'State'class + (type'Synchronization'class + (type'Vertex'class + (type'Pseudostate'class + (type'Transition'class + type'Entry'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Exit'class + (type'FinalState'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'State'class + (type'Synchronization'class + (type'Vertex'class + (type'Pseudostate'class + (type'Transition'class + type'Entry'class))))))))))))) { child = util'language.util'root or (some parent: type'Exit'class + (type'FinalState'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'State'class + (type'Synchronization'class + (type'Vertex'class + (type'Pseudostate'class + (type'Transition'class + type'Entry'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Exit'class + (type'FinalState'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'State'class + (type'Synchronization'class + (type'Vertex'class + (type'Pseudostate'class + (type'Transition'class + type'Entry'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
