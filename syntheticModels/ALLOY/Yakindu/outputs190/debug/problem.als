one sig util'language {
	...
	util'root : one type'Synchronization'class + (type'Choice'class + (type'Statechart'class + (type'State'class + (type'Region'class + (type'Transition'class + (type'Exit'class + (type'Entry'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + type'Pseudostate'class))))))))))))),
	util'contains : (type'Synchronization'class + (type'Choice'class + (type'Statechart'class + (type'State'class + (type'Region'class + (type'Transition'class + (type'Exit'class + (type'Entry'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + type'Pseudostate'class)))))))))))))) lone->set (type'Synchronization'class + (type'Choice'class + (type'Statechart'class + (type'State'class + (type'Region'class + (type'Transition'class + (type'Exit'class + (type'Entry'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + type'Pseudostate'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Synchronization'class + (type'Choice'class + (type'Statechart'class + (type'State'class + (type'Region'class + (type'Transition'class + (type'Exit'class + (type'Entry'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + type'Pseudostate'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Synchronization'class + (type'Choice'class + (type'Statechart'class + (type'State'class + (type'Region'class + (type'Transition'class + (type'Exit'class + (type'Entry'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + type'Pseudostate'class))))))))))))) { child = util'language.util'root or (some parent: type'Synchronization'class + (type'Choice'class + (type'Statechart'class + (type'State'class + (type'Region'class + (type'Transition'class + (type'Exit'class + (type'Entry'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + type'Pseudostate'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Synchronization'class + (type'Choice'class + (type'Statechart'class + (type'State'class + (type'Region'class + (type'Transition'class + (type'Exit'class + (type'Entry'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + type'Pseudostate'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
