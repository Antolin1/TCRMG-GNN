one sig util'language {
	...
	util'root : one type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Entry'class + (type'State'class + (type'Statechart'class + (type'Transition'class + (type'Pseudostate'class + (type'Vertex'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + type'FinalState'class))))))))))))),
	util'contains : (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Entry'class + (type'State'class + (type'Statechart'class + (type'Transition'class + (type'Pseudostate'class + (type'Vertex'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + type'FinalState'class)))))))))))))) lone->set (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Entry'class + (type'State'class + (type'Statechart'class + (type'Transition'class + (type'Pseudostate'class + (type'Vertex'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + type'FinalState'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Entry'class + (type'State'class + (type'Statechart'class + (type'Transition'class + (type'Pseudostate'class + (type'Vertex'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + type'FinalState'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Entry'class + (type'State'class + (type'Statechart'class + (type'Transition'class + (type'Pseudostate'class + (type'Vertex'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + type'FinalState'class))))))))))))) { child = util'language.util'root || (some parent: type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Entry'class + (type'State'class + (type'Statechart'class + (type'Transition'class + (type'Pseudostate'class + (type'Vertex'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + type'FinalState'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Entry'class + (type'State'class + (type'Statechart'class + (type'Transition'class + (type'Pseudostate'class + (type'Vertex'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + type'FinalState'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
