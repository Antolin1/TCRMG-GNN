one sig util'language {
	...
	util'root : one type'Statechart'class + (type'FinalState'class + (type'Vertex'class + (type'Transition'class + (type'Synchronization'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'State'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Exit'class + type'Pseudostate'class))))))))))))),
	util'contains : (type'Statechart'class + (type'FinalState'class + (type'Vertex'class + (type'Transition'class + (type'Synchronization'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'State'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Exit'class + type'Pseudostate'class)))))))))))))) lone->set (type'Statechart'class + (type'FinalState'class + (type'Vertex'class + (type'Transition'class + (type'Synchronization'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'State'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Exit'class + type'Pseudostate'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Statechart'class + (type'FinalState'class + (type'Vertex'class + (type'Transition'class + (type'Synchronization'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'State'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Exit'class + type'Pseudostate'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Statechart'class + (type'FinalState'class + (type'Vertex'class + (type'Transition'class + (type'Synchronization'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'State'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Exit'class + type'Pseudostate'class))))))))))))) { child = util'language.util'root or (some parent: type'Statechart'class + (type'FinalState'class + (type'Vertex'class + (type'Transition'class + (type'Synchronization'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'State'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Exit'class + type'Pseudostate'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Statechart'class + (type'FinalState'class + (type'Vertex'class + (type'Transition'class + (type'Synchronization'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'State'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Exit'class + type'Pseudostate'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
