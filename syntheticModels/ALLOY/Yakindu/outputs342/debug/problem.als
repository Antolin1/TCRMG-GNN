one sig util'language {
	...
	util'root : one type'Synchronization'class + (type'Choice'class + (type'Transition'class + (type'Entry'class + (type'Vertex'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'State'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + type'Statechart'class))))))))))))),
	util'contains : (type'Synchronization'class + (type'Choice'class + (type'Transition'class + (type'Entry'class + (type'Vertex'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'State'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + type'Statechart'class)))))))))))))) lone->set (type'Synchronization'class + (type'Choice'class + (type'Transition'class + (type'Entry'class + (type'Vertex'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'State'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + type'Statechart'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Synchronization'class + (type'Choice'class + (type'Transition'class + (type'Entry'class + (type'Vertex'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'State'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + type'Statechart'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Synchronization'class + (type'Choice'class + (type'Transition'class + (type'Entry'class + (type'Vertex'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'State'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + type'Statechart'class))))))))))))) { child = util'language.util'root or (some parent: type'Synchronization'class + (type'Choice'class + (type'Transition'class + (type'Entry'class + (type'Vertex'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'State'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + type'Statechart'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Synchronization'class + (type'Choice'class + (type'Transition'class + (type'Entry'class + (type'Vertex'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'State'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + type'Statechart'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
