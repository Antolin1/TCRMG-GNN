one sig util'language {
	...
	util'root : one type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Transition'class + (type'Pseudostate'class + type'Vertex'class))))))))))))),
	util'contains : (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Transition'class + (type'Pseudostate'class + type'Vertex'class)))))))))))))) lone->set (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Transition'class + (type'Pseudostate'class + type'Vertex'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Transition'class + (type'Pseudostate'class + type'Vertex'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Transition'class + (type'Pseudostate'class + type'Vertex'class))))))))))))) { child = util'language.util'root or (some parent: type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Transition'class + (type'Pseudostate'class + type'Vertex'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Transition'class + (type'Pseudostate'class + type'Vertex'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
