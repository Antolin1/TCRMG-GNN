one sig util'language {
	...
	util'root : one type'Vertex'class + (type'Pseudostate'class + (type'Choice'class + (type'Region'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Entry'class + (type'State'class + (type'Transition'class + (type'Synchronization'class + type'Exit'class))))))))))))),
	util'contains : (type'Vertex'class + (type'Pseudostate'class + (type'Choice'class + (type'Region'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Entry'class + (type'State'class + (type'Transition'class + (type'Synchronization'class + type'Exit'class)))))))))))))) lone->set (type'Vertex'class + (type'Pseudostate'class + (type'Choice'class + (type'Region'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Entry'class + (type'State'class + (type'Transition'class + (type'Synchronization'class + type'Exit'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Vertex'class + (type'Pseudostate'class + (type'Choice'class + (type'Region'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Entry'class + (type'State'class + (type'Transition'class + (type'Synchronization'class + type'Exit'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Vertex'class + (type'Pseudostate'class + (type'Choice'class + (type'Region'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Entry'class + (type'State'class + (type'Transition'class + (type'Synchronization'class + type'Exit'class))))))))))))) { child = util'language.util'root or (some parent: type'Vertex'class + (type'Pseudostate'class + (type'Choice'class + (type'Region'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Entry'class + (type'State'class + (type'Transition'class + (type'Synchronization'class + type'Exit'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Vertex'class + (type'Pseudostate'class + (type'Choice'class + (type'Region'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Entry'class + (type'State'class + (type'Transition'class + (type'Synchronization'class + type'Exit'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
