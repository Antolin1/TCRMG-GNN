one sig util'language {
	...
	util'root : one type'Region'class + (type'Pseudostate'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Entry'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + type'Transition'class))))))))))))),
	util'contains : (type'Region'class + (type'Pseudostate'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Entry'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + type'Transition'class)))))))))))))) lone->set (type'Region'class + (type'Pseudostate'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Entry'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + type'Transition'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Region'class + (type'Pseudostate'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Entry'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + type'Transition'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Region'class + (type'Pseudostate'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Entry'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + type'Transition'class))))))))))))) { child = util'language.util'root or (some parent: type'Region'class + (type'Pseudostate'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Entry'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + type'Transition'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Region'class + (type'Pseudostate'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Entry'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + type'Transition'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
