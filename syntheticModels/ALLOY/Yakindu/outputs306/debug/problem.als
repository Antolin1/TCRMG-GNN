one sig util'language {
	...
	util'root : one type'Choice'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Transition'class + (type'Pseudostate'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + type'Statechart'class))))))))))))),
	util'contains : (type'Choice'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Transition'class + (type'Pseudostate'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + type'Statechart'class)))))))))))))) lone->set (type'Choice'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Transition'class + (type'Pseudostate'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + type'Statechart'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Choice'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Transition'class + (type'Pseudostate'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + type'Statechart'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Choice'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Transition'class + (type'Pseudostate'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + type'Statechart'class))))))))))))) { child = util'language.util'root || (some parent: type'Choice'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Transition'class + (type'Pseudostate'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + type'Statechart'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Choice'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Transition'class + (type'Pseudostate'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + type'Statechart'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
