one sig util'language {
	...
	util'root : one type'Entry'class + (type'Synchronization'class + (type'Pseudostate'class + (type'Vertex'class + (type'Transition'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'State'class + (type'Region'class + (type'Choice'class + type'Exit'class))))))))))))),
	util'contains : (type'Entry'class + (type'Synchronization'class + (type'Pseudostate'class + (type'Vertex'class + (type'Transition'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'State'class + (type'Region'class + (type'Choice'class + type'Exit'class)))))))))))))) lone->set (type'Entry'class + (type'Synchronization'class + (type'Pseudostate'class + (type'Vertex'class + (type'Transition'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'State'class + (type'Region'class + (type'Choice'class + type'Exit'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Entry'class + (type'Synchronization'class + (type'Pseudostate'class + (type'Vertex'class + (type'Transition'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'State'class + (type'Region'class + (type'Choice'class + type'Exit'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Entry'class + (type'Synchronization'class + (type'Pseudostate'class + (type'Vertex'class + (type'Transition'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'State'class + (type'Region'class + (type'Choice'class + type'Exit'class))))))))))))) { child = util'language.util'root || (some parent: type'Entry'class + (type'Synchronization'class + (type'Pseudostate'class + (type'Vertex'class + (type'Transition'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'State'class + (type'Region'class + (type'Choice'class + type'Exit'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Entry'class + (type'Synchronization'class + (type'Pseudostate'class + (type'Vertex'class + (type'Transition'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'State'class + (type'Region'class + (type'Choice'class + type'Exit'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
