one sig util'language {
	...
	util'root : one type'FinalState'class + (type'Region'class + (type'Exit'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Statechart'class + (type'Pseudostate'class + (type'State'class + (type'Entry'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + type'Choice'class))))))))))))),
	util'contains : (type'FinalState'class + (type'Region'class + (type'Exit'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Statechart'class + (type'Pseudostate'class + (type'State'class + (type'Entry'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + type'Choice'class)))))))))))))) lone->set (type'FinalState'class + (type'Region'class + (type'Exit'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Statechart'class + (type'Pseudostate'class + (type'State'class + (type'Entry'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + type'Choice'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'FinalState'class + (type'Region'class + (type'Exit'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Statechart'class + (type'Pseudostate'class + (type'State'class + (type'Entry'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + type'Choice'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'FinalState'class + (type'Region'class + (type'Exit'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Statechart'class + (type'Pseudostate'class + (type'State'class + (type'Entry'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + type'Choice'class))))))))))))) { child = util'language.util'root || (some parent: type'FinalState'class + (type'Region'class + (type'Exit'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Statechart'class + (type'Pseudostate'class + (type'State'class + (type'Entry'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + type'Choice'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'FinalState'class + (type'Region'class + (type'Exit'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Statechart'class + (type'Pseudostate'class + (type'State'class + (type'Entry'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + type'Choice'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
