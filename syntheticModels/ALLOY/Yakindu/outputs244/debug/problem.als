one sig util'language {
	...
	util'root : one type'Entry'class + (type'State'class + (type'Choice'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Region'class + (type'Exit'class + (type'Statechart'class + (type'Vertex'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + type'Synchronization'class))))))))))))),
	util'contains : (type'Entry'class + (type'State'class + (type'Choice'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Region'class + (type'Exit'class + (type'Statechart'class + (type'Vertex'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + type'Synchronization'class)))))))))))))) lone->set (type'Entry'class + (type'State'class + (type'Choice'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Region'class + (type'Exit'class + (type'Statechart'class + (type'Vertex'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + type'Synchronization'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Entry'class + (type'State'class + (type'Choice'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Region'class + (type'Exit'class + (type'Statechart'class + (type'Vertex'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + type'Synchronization'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Entry'class + (type'State'class + (type'Choice'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Region'class + (type'Exit'class + (type'Statechart'class + (type'Vertex'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + type'Synchronization'class))))))))))))) { child = util'language.util'root or (some parent: type'Entry'class + (type'State'class + (type'Choice'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Region'class + (type'Exit'class + (type'Statechart'class + (type'Vertex'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + type'Synchronization'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Entry'class + (type'State'class + (type'Choice'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Region'class + (type'Exit'class + (type'Statechart'class + (type'Vertex'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + type'Synchronization'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
