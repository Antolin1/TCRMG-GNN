one sig util'language {
	...
	util'root : one type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Transition'class + (type'Choice'class + (type'State'class + (type'Vertex'class + (type'Entry'class + type'Pseudostate'class))))))))))))),
	util'contains : (type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Transition'class + (type'Choice'class + (type'State'class + (type'Vertex'class + (type'Entry'class + type'Pseudostate'class)))))))))))))) lone->set (type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Transition'class + (type'Choice'class + (type'State'class + (type'Vertex'class + (type'Entry'class + type'Pseudostate'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Transition'class + (type'Choice'class + (type'State'class + (type'Vertex'class + (type'Entry'class + type'Pseudostate'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Transition'class + (type'Choice'class + (type'State'class + (type'Vertex'class + (type'Entry'class + type'Pseudostate'class))))))))))))) { child = util'language.util'root || (some parent: type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Transition'class + (type'Choice'class + (type'State'class + (type'Vertex'class + (type'Entry'class + type'Pseudostate'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Transition'class + (type'Choice'class + (type'State'class + (type'Vertex'class + (type'Entry'class + type'Pseudostate'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
