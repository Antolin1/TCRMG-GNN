one sig util'language {
	...
	util'root : one type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'State'class + (type'Entry'class + (type'Choice'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Synchronization'class + (type'Exit'class + (type'Vertex'class + type'Region'class))))))))))))),
	util'contains : (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'State'class + (type'Entry'class + (type'Choice'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Synchronization'class + (type'Exit'class + (type'Vertex'class + type'Region'class)))))))))))))) lone->set (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'State'class + (type'Entry'class + (type'Choice'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Synchronization'class + (type'Exit'class + (type'Vertex'class + type'Region'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'State'class + (type'Entry'class + (type'Choice'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Synchronization'class + (type'Exit'class + (type'Vertex'class + type'Region'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'State'class + (type'Entry'class + (type'Choice'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Synchronization'class + (type'Exit'class + (type'Vertex'class + type'Region'class))))))))))))) { child = util'language.util'root || (some parent: type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'State'class + (type'Entry'class + (type'Choice'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Synchronization'class + (type'Exit'class + (type'Vertex'class + type'Region'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'State'class + (type'Entry'class + (type'Choice'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Synchronization'class + (type'Exit'class + (type'Vertex'class + type'Region'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
