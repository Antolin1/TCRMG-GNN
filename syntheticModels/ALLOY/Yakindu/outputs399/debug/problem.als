one sig util'language {
	...
	util'root : one type'Synchronization'class + (type'Region'class + (type'Vertex'class + (type'Transition'class + (type'Choice'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + type'Statechart'class))))))))))))),
	util'contains : (type'Synchronization'class + (type'Region'class + (type'Vertex'class + (type'Transition'class + (type'Choice'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + type'Statechart'class)))))))))))))) lone->set (type'Synchronization'class + (type'Region'class + (type'Vertex'class + (type'Transition'class + (type'Choice'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + type'Statechart'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Synchronization'class + (type'Region'class + (type'Vertex'class + (type'Transition'class + (type'Choice'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + type'Statechart'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Synchronization'class + (type'Region'class + (type'Vertex'class + (type'Transition'class + (type'Choice'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + type'Statechart'class))))))))))))) { child = util'language.util'root or (some parent: type'Synchronization'class + (type'Region'class + (type'Vertex'class + (type'Transition'class + (type'Choice'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + type'Statechart'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Synchronization'class + (type'Region'class + (type'Vertex'class + (type'Transition'class + (type'Choice'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + type'Statechart'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
