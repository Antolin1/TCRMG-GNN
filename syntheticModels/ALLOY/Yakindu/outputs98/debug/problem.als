one sig util'language {
	...
	util'root : one type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'Region'class + (type'Vertex'class + (type'Pseudostate'class + (type'Entry'class + (type'Choice'class + (type'State'class + type'Exit'class))))))))))))),
	util'contains : (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'Region'class + (type'Vertex'class + (type'Pseudostate'class + (type'Entry'class + (type'Choice'class + (type'State'class + type'Exit'class)))))))))))))) lone->set (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'Region'class + (type'Vertex'class + (type'Pseudostate'class + (type'Entry'class + (type'Choice'class + (type'State'class + type'Exit'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'Region'class + (type'Vertex'class + (type'Pseudostate'class + (type'Entry'class + (type'Choice'class + (type'State'class + type'Exit'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'Region'class + (type'Vertex'class + (type'Pseudostate'class + (type'Entry'class + (type'Choice'class + (type'State'class + type'Exit'class))))))))))))) { child = util'language.util'root or (some parent: type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'Region'class + (type'Vertex'class + (type'Pseudostate'class + (type'Entry'class + (type'Choice'class + (type'State'class + type'Exit'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'Region'class + (type'Vertex'class + (type'Pseudostate'class + (type'Entry'class + (type'Choice'class + (type'State'class + type'Exit'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
