one sig util'language {
	...
	util'root : one type'RegularState'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Pseudostate'class + (type'Exit'class + (type'State'class + (type'FinalState'class + (type'Transition'class + type'Vertex'class))))))))))))),
	util'contains : (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Pseudostate'class + (type'Exit'class + (type'State'class + (type'FinalState'class + (type'Transition'class + type'Vertex'class)))))))))))))) lone->set (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Pseudostate'class + (type'Exit'class + (type'State'class + (type'FinalState'class + (type'Transition'class + type'Vertex'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'RegularState'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Pseudostate'class + (type'Exit'class + (type'State'class + (type'FinalState'class + (type'Transition'class + type'Vertex'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'RegularState'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Pseudostate'class + (type'Exit'class + (type'State'class + (type'FinalState'class + (type'Transition'class + type'Vertex'class))))))))))))) { child = util'language.util'root || (some parent: type'RegularState'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Pseudostate'class + (type'Exit'class + (type'State'class + (type'FinalState'class + (type'Transition'class + type'Vertex'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'RegularState'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Pseudostate'class + (type'Exit'class + (type'State'class + (type'FinalState'class + (type'Transition'class + type'Vertex'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
...
run { } for exactly 21 util'Object , 2 Int , exactly 0 String