one sig util'language {
	...
	util'root : one type'Region'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Choice'class + (type'State'class + (type'Transition'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + type'Vertex'class))))))))))))),
	util'contains : (type'Region'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Choice'class + (type'State'class + (type'Transition'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + type'Vertex'class)))))))))))))) lone->set (type'Region'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Choice'class + (type'State'class + (type'Transition'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + type'Vertex'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Region'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Choice'class + (type'State'class + (type'Transition'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + type'Vertex'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Region'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Choice'class + (type'State'class + (type'Transition'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + type'Vertex'class))))))))))))) { child = util'language.util'root or (some parent: type'Region'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Choice'class + (type'State'class + (type'Transition'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + type'Vertex'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Region'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Choice'class + (type'State'class + (type'Transition'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + type'Vertex'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
