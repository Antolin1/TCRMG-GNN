one sig util'language {
	...
	util'root : one type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'Exit'class + (type'FinalState'class + (type'Transition'class + (type'Vertex'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Statechart'class + type'Pseudostate'class))))))))))))),
	util'contains : (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'Exit'class + (type'FinalState'class + (type'Transition'class + (type'Vertex'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Statechart'class + type'Pseudostate'class)))))))))))))) lone->set (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'Exit'class + (type'FinalState'class + (type'Transition'class + (type'Vertex'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Statechart'class + type'Pseudostate'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'Exit'class + (type'FinalState'class + (type'Transition'class + (type'Vertex'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Statechart'class + type'Pseudostate'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'Exit'class + (type'FinalState'class + (type'Transition'class + (type'Vertex'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Statechart'class + type'Pseudostate'class))))))))))))) { child = util'language.util'root || (some parent: type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'Exit'class + (type'FinalState'class + (type'Transition'class + (type'Vertex'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Statechart'class + type'Pseudostate'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'Exit'class + (type'FinalState'class + (type'Transition'class + (type'Vertex'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Statechart'class + type'Pseudostate'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
