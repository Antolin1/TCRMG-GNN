one sig util'language {
	...
	util'root : one type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Region'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'Vertex'class + type'Pseudostate'class))))))))))))),
	util'contains : (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Region'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'Vertex'class + type'Pseudostate'class)))))))))))))) lone->set (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Region'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'Vertex'class + type'Pseudostate'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Region'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'Vertex'class + type'Pseudostate'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Region'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'Vertex'class + type'Pseudostate'class))))))))))))) { child = util'language.util'root or (some parent: type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Region'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'Vertex'class + type'Pseudostate'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Region'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'Vertex'class + type'Pseudostate'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
