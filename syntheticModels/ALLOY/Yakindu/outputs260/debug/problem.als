one sig util'language {
	...
	util'root : one type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Statechart'class + (type'FinalState'class + (type'Vertex'class + (type'State'class + (type'Region'class + (type'Choice'class + (type'Exit'class + (type'RegularState'class + (type'State'class + type'Transition'class))))))))))))),
	util'contains : (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Statechart'class + (type'FinalState'class + (type'Vertex'class + (type'State'class + (type'Region'class + (type'Choice'class + (type'Exit'class + (type'RegularState'class + (type'State'class + type'Transition'class)))))))))))))) lone->set (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Statechart'class + (type'FinalState'class + (type'Vertex'class + (type'State'class + (type'Region'class + (type'Choice'class + (type'Exit'class + (type'RegularState'class + (type'State'class + type'Transition'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Statechart'class + (type'FinalState'class + (type'Vertex'class + (type'State'class + (type'Region'class + (type'Choice'class + (type'Exit'class + (type'RegularState'class + (type'State'class + type'Transition'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Statechart'class + (type'FinalState'class + (type'Vertex'class + (type'State'class + (type'Region'class + (type'Choice'class + (type'Exit'class + (type'RegularState'class + (type'State'class + type'Transition'class))))))))))))) { child = util'language.util'root or (some parent: type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Statechart'class + (type'FinalState'class + (type'Vertex'class + (type'State'class + (type'Region'class + (type'Choice'class + (type'Exit'class + (type'RegularState'class + (type'State'class + type'Transition'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Statechart'class + (type'FinalState'class + (type'Vertex'class + (type'State'class + (type'Region'class + (type'Choice'class + (type'Exit'class + (type'RegularState'class + (type'State'class + type'Transition'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
