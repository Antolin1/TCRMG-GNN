one sig util'language {
	...
	util'root : one type'Vertex'class + (type'Synchronization'class + (type'Statechart'class + (type'Choice'class + (type'Exit'class + (type'Region'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'FinalState'class + type'Pseudostate'class))))))))))))),
	util'contains : (type'Vertex'class + (type'Synchronization'class + (type'Statechart'class + (type'Choice'class + (type'Exit'class + (type'Region'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'FinalState'class + type'Pseudostate'class)))))))))))))) lone->set (type'Vertex'class + (type'Synchronization'class + (type'Statechart'class + (type'Choice'class + (type'Exit'class + (type'Region'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'FinalState'class + type'Pseudostate'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Vertex'class + (type'Synchronization'class + (type'Statechart'class + (type'Choice'class + (type'Exit'class + (type'Region'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'FinalState'class + type'Pseudostate'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Vertex'class + (type'Synchronization'class + (type'Statechart'class + (type'Choice'class + (type'Exit'class + (type'Region'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'FinalState'class + type'Pseudostate'class))))))))))))) { child = util'language.util'root || (some parent: type'Vertex'class + (type'Synchronization'class + (type'Statechart'class + (type'Choice'class + (type'Exit'class + (type'Region'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'FinalState'class + type'Pseudostate'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Vertex'class + (type'Synchronization'class + (type'Statechart'class + (type'Choice'class + (type'Exit'class + (type'Region'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'FinalState'class + type'Pseudostate'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
