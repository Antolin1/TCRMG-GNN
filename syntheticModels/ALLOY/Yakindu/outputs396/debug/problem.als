one sig util'language {
	...
	util'root : one type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'State'class + (type'Entry'class + (type'Exit'class + (type'Vertex'class + (type'Region'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Transition'class + (type'Choice'class + (type'RegularState'class + type'State'class))))))))))))),
	util'contains : (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'State'class + (type'Entry'class + (type'Exit'class + (type'Vertex'class + (type'Region'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Transition'class + (type'Choice'class + (type'RegularState'class + type'State'class)))))))))))))) lone->set (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'State'class + (type'Entry'class + (type'Exit'class + (type'Vertex'class + (type'Region'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Transition'class + (type'Choice'class + (type'RegularState'class + type'State'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'State'class + (type'Entry'class + (type'Exit'class + (type'Vertex'class + (type'Region'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Transition'class + (type'Choice'class + (type'RegularState'class + type'State'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'State'class + (type'Entry'class + (type'Exit'class + (type'Vertex'class + (type'Region'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Transition'class + (type'Choice'class + (type'RegularState'class + type'State'class))))))))))))) { child = util'language.util'root or (some parent: type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'State'class + (type'Entry'class + (type'Exit'class + (type'Vertex'class + (type'Region'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Transition'class + (type'Choice'class + (type'RegularState'class + type'State'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'State'class + (type'Entry'class + (type'Exit'class + (type'Vertex'class + (type'Region'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Transition'class + (type'Choice'class + (type'RegularState'class + type'State'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
