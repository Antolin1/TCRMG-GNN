one sig util'language {
	...
	util'root : one type'Pseudostate'class + (type'FinalState'class + (type'Vertex'class + (type'Synchronization'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Region'class + (type'Transition'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + type'Choice'class))))))))))))),
	util'contains : (type'Pseudostate'class + (type'FinalState'class + (type'Vertex'class + (type'Synchronization'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Region'class + (type'Transition'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + type'Choice'class)))))))))))))) lone->set (type'Pseudostate'class + (type'FinalState'class + (type'Vertex'class + (type'Synchronization'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Region'class + (type'Transition'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + type'Choice'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Pseudostate'class + (type'FinalState'class + (type'Vertex'class + (type'Synchronization'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Region'class + (type'Transition'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + type'Choice'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Pseudostate'class + (type'FinalState'class + (type'Vertex'class + (type'Synchronization'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Region'class + (type'Transition'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + type'Choice'class))))))))))))) { child = util'language.util'root or (some parent: type'Pseudostate'class + (type'FinalState'class + (type'Vertex'class + (type'Synchronization'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Region'class + (type'Transition'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + type'Choice'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Pseudostate'class + (type'FinalState'class + (type'Vertex'class + (type'Synchronization'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Region'class + (type'Transition'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + type'Choice'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
