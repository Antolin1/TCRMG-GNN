one sig util'language {
	...
	util'root : one type'RegularState'class + (type'State'class + (type'Vertex'class + (type'State'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'Choice'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + (type'Statechart'class + type'Entry'class))))))))))))),
	util'contains : (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'State'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'Choice'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + (type'Statechart'class + type'Entry'class)))))))))))))) lone->set (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'State'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'Choice'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + (type'Statechart'class + type'Entry'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'RegularState'class + (type'State'class + (type'Vertex'class + (type'State'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'Choice'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + (type'Statechart'class + type'Entry'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'RegularState'class + (type'State'class + (type'Vertex'class + (type'State'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'Choice'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + (type'Statechart'class + type'Entry'class))))))))))))) { child = util'language.util'root || (some parent: type'RegularState'class + (type'State'class + (type'Vertex'class + (type'State'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'Choice'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + (type'Statechart'class + type'Entry'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'RegularState'class + (type'State'class + (type'Vertex'class + (type'State'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'Choice'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + (type'Statechart'class + type'Entry'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
