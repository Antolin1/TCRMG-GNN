one sig util'language {
	...
	util'root : one type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Transition'class + (type'Entry'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Synchronization'class + (type'Region'class + type'FinalState'class))))))))))))),
	util'contains : (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Transition'class + (type'Entry'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Synchronization'class + (type'Region'class + type'FinalState'class)))))))))))))) lone->set (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Transition'class + (type'Entry'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Synchronization'class + (type'Region'class + type'FinalState'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Transition'class + (type'Entry'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Synchronization'class + (type'Region'class + type'FinalState'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Transition'class + (type'Entry'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Synchronization'class + (type'Region'class + type'FinalState'class))))))))))))) { child = util'language.util'root or (some parent: type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Transition'class + (type'Entry'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Synchronization'class + (type'Region'class + type'FinalState'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Transition'class + (type'Entry'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Synchronization'class + (type'Region'class + type'FinalState'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
