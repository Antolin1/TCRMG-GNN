one sig util'language {
	...
	util'root : one type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'State'class + (type'Synchronization'class + (type'Choice'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Region'class + type'Vertex'class))))))))))))),
	util'contains : (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'State'class + (type'Synchronization'class + (type'Choice'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Region'class + type'Vertex'class)))))))))))))) lone->set (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'State'class + (type'Synchronization'class + (type'Choice'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Region'class + type'Vertex'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'State'class + (type'Synchronization'class + (type'Choice'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Region'class + type'Vertex'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'State'class + (type'Synchronization'class + (type'Choice'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Region'class + type'Vertex'class))))))))))))) { child = util'language.util'root or (some parent: type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'State'class + (type'Synchronization'class + (type'Choice'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Region'class + type'Vertex'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'State'class + (type'Synchronization'class + (type'Choice'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Region'class + type'Vertex'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
