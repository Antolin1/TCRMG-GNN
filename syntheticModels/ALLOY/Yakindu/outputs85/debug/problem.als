one sig util'language {
	...
	util'root : one type'Transition'class + (type'Choice'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Entry'class + (type'Region'class + type'Statechart'class))))))))))))),
	util'contains : (type'Transition'class + (type'Choice'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Entry'class + (type'Region'class + type'Statechart'class)))))))))))))) lone->set (type'Transition'class + (type'Choice'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Entry'class + (type'Region'class + type'Statechart'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Transition'class + (type'Choice'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Entry'class + (type'Region'class + type'Statechart'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Transition'class + (type'Choice'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Entry'class + (type'Region'class + type'Statechart'class))))))))))))) { child = util'language.util'root || (some parent: type'Transition'class + (type'Choice'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Entry'class + (type'Region'class + type'Statechart'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Transition'class + (type'Choice'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Entry'class + (type'Region'class + type'Statechart'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
