one sig util'language {
	...
	util'root : one type'Entry'class + (type'Pseudostate'class + (type'Vertex'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Transition'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'FinalState'class + type'State'class))))))))))))),
	util'contains : (type'Entry'class + (type'Pseudostate'class + (type'Vertex'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Transition'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'FinalState'class + type'State'class)))))))))))))) lone->set (type'Entry'class + (type'Pseudostate'class + (type'Vertex'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Transition'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'FinalState'class + type'State'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Entry'class + (type'Pseudostate'class + (type'Vertex'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Transition'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'FinalState'class + type'State'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Entry'class + (type'Pseudostate'class + (type'Vertex'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Transition'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'FinalState'class + type'State'class))))))))))))) { child = util'language.util'root or (some parent: type'Entry'class + (type'Pseudostate'class + (type'Vertex'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Transition'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'FinalState'class + type'State'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Entry'class + (type'Pseudostate'class + (type'Vertex'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Statechart'class + (type'Transition'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'FinalState'class + type'State'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
