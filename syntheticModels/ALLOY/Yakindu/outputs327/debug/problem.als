one sig util'language {
	...
	util'root : one type'Pseudostate'class + (type'Statechart'class + (type'Entry'class + (type'FinalState'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Exit'class + (type'Synchronization'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + type'Region'class))))))))))))),
	util'contains : (type'Pseudostate'class + (type'Statechart'class + (type'Entry'class + (type'FinalState'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Exit'class + (type'Synchronization'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + type'Region'class)))))))))))))) lone->set (type'Pseudostate'class + (type'Statechart'class + (type'Entry'class + (type'FinalState'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Exit'class + (type'Synchronization'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + type'Region'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Pseudostate'class + (type'Statechart'class + (type'Entry'class + (type'FinalState'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Exit'class + (type'Synchronization'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + type'Region'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Pseudostate'class + (type'Statechart'class + (type'Entry'class + (type'FinalState'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Exit'class + (type'Synchronization'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + type'Region'class))))))))))))) { child = util'language.util'root or (some parent: type'Pseudostate'class + (type'Statechart'class + (type'Entry'class + (type'FinalState'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Exit'class + (type'Synchronization'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + type'Region'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Pseudostate'class + (type'Statechart'class + (type'Entry'class + (type'FinalState'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Exit'class + (type'Synchronization'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + type'Region'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
