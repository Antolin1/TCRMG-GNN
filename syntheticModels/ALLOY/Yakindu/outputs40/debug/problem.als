one sig util'language {
	...
	util'root : one type'Entry'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Region'class + (type'FinalState'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'Choice'class + (type'Pseudostate'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + type'Synchronization'class))))))))))))),
	util'contains : (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Region'class + (type'FinalState'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'Choice'class + (type'Pseudostate'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + type'Synchronization'class)))))))))))))) lone->set (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Region'class + (type'FinalState'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'Choice'class + (type'Pseudostate'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + type'Synchronization'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Entry'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Region'class + (type'FinalState'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'Choice'class + (type'Pseudostate'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + type'Synchronization'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Entry'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Region'class + (type'FinalState'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'Choice'class + (type'Pseudostate'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + type'Synchronization'class))))))))))))) { child = util'language.util'root || (some parent: type'Entry'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Region'class + (type'FinalState'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'Choice'class + (type'Pseudostate'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + type'Synchronization'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Entry'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Region'class + (type'FinalState'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'Choice'class + (type'Pseudostate'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + type'Synchronization'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
