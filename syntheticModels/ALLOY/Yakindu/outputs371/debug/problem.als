one sig util'language {
	...
	util'root : one type'Region'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Choice'class + (type'State'class + (type'Transition'class + (type'Exit'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + type'Vertex'class))))))))))))),
	util'contains : (type'Region'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Choice'class + (type'State'class + (type'Transition'class + (type'Exit'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + type'Vertex'class)))))))))))))) lone->set (type'Region'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Choice'class + (type'State'class + (type'Transition'class + (type'Exit'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + type'Vertex'class))))))))))))))
}
...
pred pattern'queries'noEntryInRegion [parameter'r1: type'Region'class] {
	all variable'0: type'Entry'class { parameter'r1 in type'Region'class and not (pattern'queries'entryInRegion [ parameter'r1 , variable'0 ]) }
}
...
pred pattern'queries'noOutgoingTransitionFromEntry [parameter'e: type'Entry'class] {
	all variable'0: type'Transition'class, variable'1: type'Vertex'class { parameter'e in type'Entry'class and not (pattern'queries'transition [ variable'0 , parameter'e , variable'1 ]) }
}
...
pred pattern'queries'noStateInRegion [parameter'region: type'Region'class] {
	all variable'0: type'State'class { parameter'region in type'Region'class and not (pattern'queries'StateInRegion [ parameter'region , variable'0 ]) }
}
...
pred pattern'queries'choiceHasNoOutgoing [parameter'c: type'Choice'class] {
	all variable'0: type'Transition'class, variable'1: type'Vertex'class { parameter'c in type'Choice'class and not (pattern'queries'transition [ variable'0 , parameter'c , variable'1 ]) }
}
pred pattern'queries'choiceHasNoIncoming [parameter'c: type'Choice'class] {
	all variable'0: type'Transition'class, variable'1: type'Vertex'class { parameter'c in type'Choice'class and not (pattern'queries'transition [ variable'0 , variable'1 , parameter'c ]) }
}
...
fact util'noParentForRoot {
	no parent: type'Region'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Choice'class + (type'State'class + (type'Transition'class + (type'Exit'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + type'Vertex'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Region'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Choice'class + (type'State'class + (type'Transition'class + (type'Exit'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + type'Vertex'class))))))))))))) { child = util'language.util'root or (some parent: type'Region'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Choice'class + (type'State'class + (type'Transition'class + (type'Exit'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + type'Vertex'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Region'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Choice'class + (type'State'class + (type'Transition'class + (type'Exit'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + type'Vertex'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
...
run { } for exactly 7 util'Object , 2 Int , exactly 0 String