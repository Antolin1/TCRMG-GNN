one sig util'language {
	...
	util'root : one type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Entry'class + (type'Statechart'class + (type'FinalState'class + (type'Choice'class + (type'Vertex'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'State'class + type'Transition'class))))))))))))),
	util'contains : (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Entry'class + (type'Statechart'class + (type'FinalState'class + (type'Choice'class + (type'Vertex'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'State'class + type'Transition'class)))))))))))))) lone->set (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Entry'class + (type'Statechart'class + (type'FinalState'class + (type'Choice'class + (type'Vertex'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'State'class + type'Transition'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Entry'class + (type'Statechart'class + (type'FinalState'class + (type'Choice'class + (type'Vertex'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'State'class + type'Transition'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Entry'class + (type'Statechart'class + (type'FinalState'class + (type'Choice'class + (type'Vertex'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'State'class + type'Transition'class))))))))))))) { child = util'language.util'root || (some parent: type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Entry'class + (type'Statechart'class + (type'FinalState'class + (type'Choice'class + (type'Vertex'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'State'class + type'Transition'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Entry'class + (type'Statechart'class + (type'FinalState'class + (type'Choice'class + (type'Vertex'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'State'class + type'Transition'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
