one sig util'language {
	...
	util'root : one type'Entry'class + (type'Exit'class + (type'Choice'class + (type'State'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'FinalState'class + (type'Vertex'class + (type'Transition'class + type'Statechart'class))))))))))))),
	util'contains : (type'Entry'class + (type'Exit'class + (type'Choice'class + (type'State'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'FinalState'class + (type'Vertex'class + (type'Transition'class + type'Statechart'class)))))))))))))) lone->set (type'Entry'class + (type'Exit'class + (type'Choice'class + (type'State'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'FinalState'class + (type'Vertex'class + (type'Transition'class + type'Statechart'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Entry'class + (type'Exit'class + (type'Choice'class + (type'State'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'FinalState'class + (type'Vertex'class + (type'Transition'class + type'Statechart'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Entry'class + (type'Exit'class + (type'Choice'class + (type'State'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'FinalState'class + (type'Vertex'class + (type'Transition'class + type'Statechart'class))))))))))))) { child = util'language.util'root || (some parent: type'Entry'class + (type'Exit'class + (type'Choice'class + (type'State'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'FinalState'class + (type'Vertex'class + (type'Transition'class + type'Statechart'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Entry'class + (type'Exit'class + (type'Choice'class + (type'State'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'FinalState'class + (type'Vertex'class + (type'Transition'class + type'Statechart'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
