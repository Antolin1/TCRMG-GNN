one sig util'language {
	...
	util'root : one type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'FinalState'class + (type'Statechart'class + (type'Vertex'class + (type'Entry'class + (type'Exit'class + (type'Choice'class + (type'Synchronization'class + type'Region'class))))))))))))),
	util'contains : (type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'FinalState'class + (type'Statechart'class + (type'Vertex'class + (type'Entry'class + (type'Exit'class + (type'Choice'class + (type'Synchronization'class + type'Region'class)))))))))))))) lone->set (type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'FinalState'class + (type'Statechart'class + (type'Vertex'class + (type'Entry'class + (type'Exit'class + (type'Choice'class + (type'Synchronization'class + type'Region'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'FinalState'class + (type'Statechart'class + (type'Vertex'class + (type'Entry'class + (type'Exit'class + (type'Choice'class + (type'Synchronization'class + type'Region'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'FinalState'class + (type'Statechart'class + (type'Vertex'class + (type'Entry'class + (type'Exit'class + (type'Choice'class + (type'Synchronization'class + type'Region'class))))))))))))) { child = util'language.util'root || (some parent: type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'FinalState'class + (type'Statechart'class + (type'Vertex'class + (type'Entry'class + (type'Exit'class + (type'Choice'class + (type'Synchronization'class + type'Region'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'FinalState'class + (type'Statechart'class + (type'Vertex'class + (type'Entry'class + (type'Exit'class + (type'Choice'class + (type'Synchronization'class + type'Region'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
