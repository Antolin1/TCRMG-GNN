one sig util'language {
	...
	util'root : one type'FinalState'class + (type'Statechart'class + (type'Choice'class + (type'Region'class + (type'Transition'class + (type'State'class + (type'Vertex'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + type'Exit'class))))))))))))),
	util'contains : (type'FinalState'class + (type'Statechart'class + (type'Choice'class + (type'Region'class + (type'Transition'class + (type'State'class + (type'Vertex'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + type'Exit'class)))))))))))))) lone->set (type'FinalState'class + (type'Statechart'class + (type'Choice'class + (type'Region'class + (type'Transition'class + (type'State'class + (type'Vertex'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + type'Exit'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'FinalState'class + (type'Statechart'class + (type'Choice'class + (type'Region'class + (type'Transition'class + (type'State'class + (type'Vertex'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + type'Exit'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'FinalState'class + (type'Statechart'class + (type'Choice'class + (type'Region'class + (type'Transition'class + (type'State'class + (type'Vertex'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + type'Exit'class))))))))))))) { child = util'language.util'root or (some parent: type'FinalState'class + (type'Statechart'class + (type'Choice'class + (type'Region'class + (type'Transition'class + (type'State'class + (type'Vertex'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + type'Exit'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'FinalState'class + (type'Statechart'class + (type'Choice'class + (type'Region'class + (type'Transition'class + (type'State'class + (type'Vertex'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + type'Exit'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
