one sig util'language {
	...
	util'root : one type'RegularState'class + (type'State'class + (type'Choice'class + (type'Entry'class + (type'Synchronization'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Statechart'class + (type'Pseudostate'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Vertex'class + type'Exit'class))))))))))))),
	util'contains : (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Entry'class + (type'Synchronization'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Statechart'class + (type'Pseudostate'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Vertex'class + type'Exit'class)))))))))))))) lone->set (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Entry'class + (type'Synchronization'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Statechart'class + (type'Pseudostate'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Vertex'class + type'Exit'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'RegularState'class + (type'State'class + (type'Choice'class + (type'Entry'class + (type'Synchronization'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Statechart'class + (type'Pseudostate'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Vertex'class + type'Exit'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'RegularState'class + (type'State'class + (type'Choice'class + (type'Entry'class + (type'Synchronization'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Statechart'class + (type'Pseudostate'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Vertex'class + type'Exit'class))))))))))))) { child = util'language.util'root or (some parent: type'RegularState'class + (type'State'class + (type'Choice'class + (type'Entry'class + (type'Synchronization'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Statechart'class + (type'Pseudostate'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Vertex'class + type'Exit'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'RegularState'class + (type'State'class + (type'Choice'class + (type'Entry'class + (type'Synchronization'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Statechart'class + (type'Pseudostate'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Vertex'class + type'Exit'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
...
run { } for exactly 16 util'Object , 2 Int , exactly 0 String