one sig util'language {
	...
	util'root : one type'State'class + (type'Transition'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Entry'class + (type'Exit'class + (type'Statechart'class + (type'Choice'class + (type'FinalState'class + type'Vertex'class))))))))))))),
	util'contains : (type'State'class + (type'Transition'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Entry'class + (type'Exit'class + (type'Statechart'class + (type'Choice'class + (type'FinalState'class + type'Vertex'class)))))))))))))) lone->set (type'State'class + (type'Transition'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Entry'class + (type'Exit'class + (type'Statechart'class + (type'Choice'class + (type'FinalState'class + type'Vertex'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'State'class + (type'Transition'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Entry'class + (type'Exit'class + (type'Statechart'class + (type'Choice'class + (type'FinalState'class + type'Vertex'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'State'class + (type'Transition'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Entry'class + (type'Exit'class + (type'Statechart'class + (type'Choice'class + (type'FinalState'class + type'Vertex'class))))))))))))) { child = util'language.util'root or (some parent: type'State'class + (type'Transition'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Entry'class + (type'Exit'class + (type'Statechart'class + (type'Choice'class + (type'FinalState'class + type'Vertex'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'State'class + (type'Transition'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Entry'class + (type'Exit'class + (type'Statechart'class + (type'Choice'class + (type'FinalState'class + type'Vertex'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
