one sig util'language {
	...
	util'root : one type'FinalState'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Choice'class + (type'Statechart'class + (type'Vertex'class + (type'Pseudostate'class + (type'Transition'class + (type'Entry'class + (type'Synchronization'class + (type'Region'class + type'State'class))))))))))))),
	util'contains : (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Choice'class + (type'Statechart'class + (type'Vertex'class + (type'Pseudostate'class + (type'Transition'class + (type'Entry'class + (type'Synchronization'class + (type'Region'class + type'State'class)))))))))))))) lone->set (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Choice'class + (type'Statechart'class + (type'Vertex'class + (type'Pseudostate'class + (type'Transition'class + (type'Entry'class + (type'Synchronization'class + (type'Region'class + type'State'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'FinalState'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Choice'class + (type'Statechart'class + (type'Vertex'class + (type'Pseudostate'class + (type'Transition'class + (type'Entry'class + (type'Synchronization'class + (type'Region'class + type'State'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'FinalState'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Choice'class + (type'Statechart'class + (type'Vertex'class + (type'Pseudostate'class + (type'Transition'class + (type'Entry'class + (type'Synchronization'class + (type'Region'class + type'State'class))))))))))))) { child = util'language.util'root || (some parent: type'FinalState'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Choice'class + (type'Statechart'class + (type'Vertex'class + (type'Pseudostate'class + (type'Transition'class + (type'Entry'class + (type'Synchronization'class + (type'Region'class + type'State'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'FinalState'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Choice'class + (type'Statechart'class + (type'Vertex'class + (type'Pseudostate'class + (type'Transition'class + (type'Entry'class + (type'Synchronization'class + (type'Region'class + type'State'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
