one sig util'language {
	...
	util'root : one type'RegularState'class + (type'State'class + (type'Exit'class + (type'Region'class + (type'Synchronization'class + (type'Transition'class + (type'Entry'class + (type'Pseudostate'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'State'class + (type'Choice'class + (type'FinalState'class + type'Statechart'class))))))))))))),
	util'contains : (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Region'class + (type'Synchronization'class + (type'Transition'class + (type'Entry'class + (type'Pseudostate'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'State'class + (type'Choice'class + (type'FinalState'class + type'Statechart'class)))))))))))))) lone->set (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Region'class + (type'Synchronization'class + (type'Transition'class + (type'Entry'class + (type'Pseudostate'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'State'class + (type'Choice'class + (type'FinalState'class + type'Statechart'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'RegularState'class + (type'State'class + (type'Exit'class + (type'Region'class + (type'Synchronization'class + (type'Transition'class + (type'Entry'class + (type'Pseudostate'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'State'class + (type'Choice'class + (type'FinalState'class + type'Statechart'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'RegularState'class + (type'State'class + (type'Exit'class + (type'Region'class + (type'Synchronization'class + (type'Transition'class + (type'Entry'class + (type'Pseudostate'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'State'class + (type'Choice'class + (type'FinalState'class + type'Statechart'class))))))))))))) { child = util'language.util'root || (some parent: type'RegularState'class + (type'State'class + (type'Exit'class + (type'Region'class + (type'Synchronization'class + (type'Transition'class + (type'Entry'class + (type'Pseudostate'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'State'class + (type'Choice'class + (type'FinalState'class + type'Statechart'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'RegularState'class + (type'State'class + (type'Exit'class + (type'Region'class + (type'Synchronization'class + (type'Transition'class + (type'Entry'class + (type'Pseudostate'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'State'class + (type'Choice'class + (type'FinalState'class + type'Statechart'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
