one sig util'language {
	...
	util'root : one type'Region'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'FinalState'class + (type'State'class + (type'Exit'class + (type'Vertex'class + (type'Choice'class + (type'Transition'class + (type'Entry'class + type'Synchronization'class))))))))))))),
	util'contains : (type'Region'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'FinalState'class + (type'State'class + (type'Exit'class + (type'Vertex'class + (type'Choice'class + (type'Transition'class + (type'Entry'class + type'Synchronization'class)))))))))))))) lone->set (type'Region'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'FinalState'class + (type'State'class + (type'Exit'class + (type'Vertex'class + (type'Choice'class + (type'Transition'class + (type'Entry'class + type'Synchronization'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Region'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'FinalState'class + (type'State'class + (type'Exit'class + (type'Vertex'class + (type'Choice'class + (type'Transition'class + (type'Entry'class + type'Synchronization'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Region'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'FinalState'class + (type'State'class + (type'Exit'class + (type'Vertex'class + (type'Choice'class + (type'Transition'class + (type'Entry'class + type'Synchronization'class))))))))))))) { child = util'language.util'root or (some parent: type'Region'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'FinalState'class + (type'State'class + (type'Exit'class + (type'Vertex'class + (type'Choice'class + (type'Transition'class + (type'Entry'class + type'Synchronization'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Region'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'FinalState'class + (type'State'class + (type'Exit'class + (type'Vertex'class + (type'Choice'class + (type'Transition'class + (type'Entry'class + type'Synchronization'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
