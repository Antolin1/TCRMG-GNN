one sig util'language {
	...
	util'root : one type'Synchronization'class + (type'State'class + (type'Region'class + (type'Entry'class + (type'Pseudostate'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Transition'class + (type'Exit'class + type'Choice'class))))))))))))),
	util'contains : (type'Synchronization'class + (type'State'class + (type'Region'class + (type'Entry'class + (type'Pseudostate'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Transition'class + (type'Exit'class + type'Choice'class)))))))))))))) lone->set (type'Synchronization'class + (type'State'class + (type'Region'class + (type'Entry'class + (type'Pseudostate'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Transition'class + (type'Exit'class + type'Choice'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Synchronization'class + (type'State'class + (type'Region'class + (type'Entry'class + (type'Pseudostate'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Transition'class + (type'Exit'class + type'Choice'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Synchronization'class + (type'State'class + (type'Region'class + (type'Entry'class + (type'Pseudostate'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Transition'class + (type'Exit'class + type'Choice'class))))))))))))) { child = util'language.util'root || (some parent: type'Synchronization'class + (type'State'class + (type'Region'class + (type'Entry'class + (type'Pseudostate'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Transition'class + (type'Exit'class + type'Choice'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Synchronization'class + (type'State'class + (type'Region'class + (type'Entry'class + (type'Pseudostate'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Transition'class + (type'Exit'class + type'Choice'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
