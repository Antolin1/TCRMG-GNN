one sig util'language {
	...
	util'root : one type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Vertex'class + (type'Synchronization'class + (type'FinalState'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Choice'class + (type'Exit'class + (type'Statechart'class + type'Region'class))))))))))))),
	util'contains : (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Vertex'class + (type'Synchronization'class + (type'FinalState'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Choice'class + (type'Exit'class + (type'Statechart'class + type'Region'class)))))))))))))) lone->set (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Vertex'class + (type'Synchronization'class + (type'FinalState'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Choice'class + (type'Exit'class + (type'Statechart'class + type'Region'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Vertex'class + (type'Synchronization'class + (type'FinalState'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Choice'class + (type'Exit'class + (type'Statechart'class + type'Region'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Vertex'class + (type'Synchronization'class + (type'FinalState'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Choice'class + (type'Exit'class + (type'Statechart'class + type'Region'class))))))))))))) { child = util'language.util'root || (some parent: type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Vertex'class + (type'Synchronization'class + (type'FinalState'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Choice'class + (type'Exit'class + (type'Statechart'class + type'Region'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Vertex'class + (type'Synchronization'class + (type'FinalState'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Choice'class + (type'Exit'class + (type'Statechart'class + type'Region'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
