one sig util'language {
	...
	util'root : one type'Choice'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'Entry'class + (type'Statechart'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'FinalState'class + type'Synchronization'class))))))))))))),
	util'contains : (type'Choice'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'Entry'class + (type'Statechart'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'FinalState'class + type'Synchronization'class)))))))))))))) lone->set (type'Choice'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'Entry'class + (type'Statechart'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'FinalState'class + type'Synchronization'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Choice'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'Entry'class + (type'Statechart'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'FinalState'class + type'Synchronization'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Choice'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'Entry'class + (type'Statechart'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'FinalState'class + type'Synchronization'class))))))))))))) { child = util'language.util'root or (some parent: type'Choice'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'Entry'class + (type'Statechart'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'FinalState'class + type'Synchronization'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Choice'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'Entry'class + (type'Statechart'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'FinalState'class + type'Synchronization'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
