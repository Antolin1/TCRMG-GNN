one sig util'language {
	...
	util'root : one type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'State'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Pseudostate'class + (type'Vertex'class + (type'Entry'class + type'Exit'class))))))))))))),
	util'contains : (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'State'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Pseudostate'class + (type'Vertex'class + (type'Entry'class + type'Exit'class)))))))))))))) lone->set (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'State'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Pseudostate'class + (type'Vertex'class + (type'Entry'class + type'Exit'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'State'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Pseudostate'class + (type'Vertex'class + (type'Entry'class + type'Exit'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'State'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Pseudostate'class + (type'Vertex'class + (type'Entry'class + type'Exit'class))))))))))))) { child = util'language.util'root || (some parent: type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'State'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Pseudostate'class + (type'Vertex'class + (type'Entry'class + type'Exit'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'State'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Pseudostate'class + (type'Vertex'class + (type'Entry'class + type'Exit'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
