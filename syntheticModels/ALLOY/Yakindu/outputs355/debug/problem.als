one sig util'language {
	...
	util'root : one type'Pseudostate'class + (type'Entry'class + (type'Choice'class + (type'FinalState'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Vertex'class + (type'Exit'class + (type'Region'class + type'Synchronization'class))))))))))))),
	util'contains : (type'Pseudostate'class + (type'Entry'class + (type'Choice'class + (type'FinalState'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Vertex'class + (type'Exit'class + (type'Region'class + type'Synchronization'class)))))))))))))) lone->set (type'Pseudostate'class + (type'Entry'class + (type'Choice'class + (type'FinalState'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Vertex'class + (type'Exit'class + (type'Region'class + type'Synchronization'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Pseudostate'class + (type'Entry'class + (type'Choice'class + (type'FinalState'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Vertex'class + (type'Exit'class + (type'Region'class + type'Synchronization'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Pseudostate'class + (type'Entry'class + (type'Choice'class + (type'FinalState'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Vertex'class + (type'Exit'class + (type'Region'class + type'Synchronization'class))))))))))))) { child = util'language.util'root or (some parent: type'Pseudostate'class + (type'Entry'class + (type'Choice'class + (type'FinalState'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Vertex'class + (type'Exit'class + (type'Region'class + type'Synchronization'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Pseudostate'class + (type'Entry'class + (type'Choice'class + (type'FinalState'class + (type'State'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Vertex'class + (type'Exit'class + (type'Region'class + type'Synchronization'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
