one sig util'language {
	...
	util'root : one type'Transition'class + (type'Choice'class + (type'Exit'class + (type'Vertex'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + type'FinalState'class))))))))))))),
	util'contains : (type'Transition'class + (type'Choice'class + (type'Exit'class + (type'Vertex'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + type'FinalState'class)))))))))))))) lone->set (type'Transition'class + (type'Choice'class + (type'Exit'class + (type'Vertex'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + type'FinalState'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Transition'class + (type'Choice'class + (type'Exit'class + (type'Vertex'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + type'FinalState'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Transition'class + (type'Choice'class + (type'Exit'class + (type'Vertex'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + type'FinalState'class))))))))))))) { child = util'language.util'root or (some parent: type'Transition'class + (type'Choice'class + (type'Exit'class + (type'Vertex'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + type'FinalState'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Transition'class + (type'Choice'class + (type'Exit'class + (type'Vertex'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + type'FinalState'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
