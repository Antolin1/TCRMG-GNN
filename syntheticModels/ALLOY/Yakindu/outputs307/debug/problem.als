one sig util'language {
	...
	util'root : one type'Entry'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Choice'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Pseudostate'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + type'Exit'class))))))))))))),
	util'contains : (type'Entry'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Choice'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Pseudostate'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + type'Exit'class)))))))))))))) lone->set (type'Entry'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Choice'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Pseudostate'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + type'Exit'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Entry'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Choice'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Pseudostate'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + type'Exit'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Entry'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Choice'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Pseudostate'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + type'Exit'class))))))))))))) { child = util'language.util'root or (some parent: type'Entry'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Choice'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Pseudostate'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + type'Exit'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Entry'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Choice'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Pseudostate'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + type'Exit'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
