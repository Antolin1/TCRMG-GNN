one sig util'language {
	...
	util'root : one type'Region'class + (type'Vertex'class + (type'Transition'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'FinalState'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + type'Statechart'class))))))))))))),
	util'contains : (type'Region'class + (type'Vertex'class + (type'Transition'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'FinalState'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + type'Statechart'class)))))))))))))) lone->set (type'Region'class + (type'Vertex'class + (type'Transition'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'FinalState'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + type'Statechart'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Region'class + (type'Vertex'class + (type'Transition'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'FinalState'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + type'Statechart'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Region'class + (type'Vertex'class + (type'Transition'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'FinalState'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + type'Statechart'class))))))))))))) { child = util'language.util'root or (some parent: type'Region'class + (type'Vertex'class + (type'Transition'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'FinalState'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + type'Statechart'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Region'class + (type'Vertex'class + (type'Transition'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'FinalState'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + type'Statechart'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
