one sig util'language {
	...
	util'root : one type'RegularState'class + (type'State'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Synchronization'class + (type'Pseudostate'class + (type'State'class + (type'Transition'class + (type'Exit'class + (type'Region'class + (type'FinalState'class + (type'Vertex'class + type'Choice'class))))))))))))),
	util'contains : (type'RegularState'class + (type'State'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Synchronization'class + (type'Pseudostate'class + (type'State'class + (type'Transition'class + (type'Exit'class + (type'Region'class + (type'FinalState'class + (type'Vertex'class + type'Choice'class)))))))))))))) lone->set (type'RegularState'class + (type'State'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Synchronization'class + (type'Pseudostate'class + (type'State'class + (type'Transition'class + (type'Exit'class + (type'Region'class + (type'FinalState'class + (type'Vertex'class + type'Choice'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'RegularState'class + (type'State'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Synchronization'class + (type'Pseudostate'class + (type'State'class + (type'Transition'class + (type'Exit'class + (type'Region'class + (type'FinalState'class + (type'Vertex'class + type'Choice'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'RegularState'class + (type'State'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Synchronization'class + (type'Pseudostate'class + (type'State'class + (type'Transition'class + (type'Exit'class + (type'Region'class + (type'FinalState'class + (type'Vertex'class + type'Choice'class))))))))))))) { child = util'language.util'root or (some parent: type'RegularState'class + (type'State'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Synchronization'class + (type'Pseudostate'class + (type'State'class + (type'Transition'class + (type'Exit'class + (type'Region'class + (type'FinalState'class + (type'Vertex'class + type'Choice'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'RegularState'class + (type'State'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Synchronization'class + (type'Pseudostate'class + (type'State'class + (type'Transition'class + (type'Exit'class + (type'Region'class + (type'FinalState'class + (type'Vertex'class + type'Choice'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
