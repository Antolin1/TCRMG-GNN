one sig util'language {
	...
	util'root : one type'Statechart'class + (type'Entry'class + (type'Choice'class + (type'State'class + (type'Vertex'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Synchronization'class + type'FinalState'class))))))))))))),
	util'contains : (type'Statechart'class + (type'Entry'class + (type'Choice'class + (type'State'class + (type'Vertex'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Synchronization'class + type'FinalState'class)))))))))))))) lone->set (type'Statechart'class + (type'Entry'class + (type'Choice'class + (type'State'class + (type'Vertex'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Synchronization'class + type'FinalState'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Statechart'class + (type'Entry'class + (type'Choice'class + (type'State'class + (type'Vertex'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Synchronization'class + type'FinalState'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Statechart'class + (type'Entry'class + (type'Choice'class + (type'State'class + (type'Vertex'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Synchronization'class + type'FinalState'class))))))))))))) { child = util'language.util'root || (some parent: type'Statechart'class + (type'Entry'class + (type'Choice'class + (type'State'class + (type'Vertex'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Synchronization'class + type'FinalState'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Statechart'class + (type'Entry'class + (type'Choice'class + (type'State'class + (type'Vertex'class + (type'Region'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Synchronization'class + type'FinalState'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
