one sig util'language {
	...
	util'root : one type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Pseudostate'class + (type'Exit'class + (type'State'class + (type'Statechart'class + (type'Entry'class + (type'Region'class + (type'Transition'class + (type'FinalState'class + type'Synchronization'class))))))))))))),
	util'contains : (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Pseudostate'class + (type'Exit'class + (type'State'class + (type'Statechart'class + (type'Entry'class + (type'Region'class + (type'Transition'class + (type'FinalState'class + type'Synchronization'class)))))))))))))) lone->set (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Pseudostate'class + (type'Exit'class + (type'State'class + (type'Statechart'class + (type'Entry'class + (type'Region'class + (type'Transition'class + (type'FinalState'class + type'Synchronization'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Pseudostate'class + (type'Exit'class + (type'State'class + (type'Statechart'class + (type'Entry'class + (type'Region'class + (type'Transition'class + (type'FinalState'class + type'Synchronization'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Pseudostate'class + (type'Exit'class + (type'State'class + (type'Statechart'class + (type'Entry'class + (type'Region'class + (type'Transition'class + (type'FinalState'class + type'Synchronization'class))))))))))))) { child = util'language.util'root || (some parent: type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Pseudostate'class + (type'Exit'class + (type'State'class + (type'Statechart'class + (type'Entry'class + (type'Region'class + (type'Transition'class + (type'FinalState'class + type'Synchronization'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Pseudostate'class + (type'Exit'class + (type'State'class + (type'Statechart'class + (type'Entry'class + (type'Region'class + (type'Transition'class + (type'FinalState'class + type'Synchronization'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
