one sig util'language {
	...
	util'root : one type'CompositeElement'class + (type'State'class + (type'State'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'FinalState'class + (type'Entry'class + (type'Exit'class + (type'Transition'class + (type'Pseudostate'class + (type'Statechart'class + (type'Region'class + type'Synchronization'class))))))))))))),
	util'contains : (type'CompositeElement'class + (type'State'class + (type'State'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'FinalState'class + (type'Entry'class + (type'Exit'class + (type'Transition'class + (type'Pseudostate'class + (type'Statechart'class + (type'Region'class + type'Synchronization'class)))))))))))))) lone->set (type'CompositeElement'class + (type'State'class + (type'State'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'FinalState'class + (type'Entry'class + (type'Exit'class + (type'Transition'class + (type'Pseudostate'class + (type'Statechart'class + (type'Region'class + type'Synchronization'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'CompositeElement'class + (type'State'class + (type'State'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'FinalState'class + (type'Entry'class + (type'Exit'class + (type'Transition'class + (type'Pseudostate'class + (type'Statechart'class + (type'Region'class + type'Synchronization'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'CompositeElement'class + (type'State'class + (type'State'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'FinalState'class + (type'Entry'class + (type'Exit'class + (type'Transition'class + (type'Pseudostate'class + (type'Statechart'class + (type'Region'class + type'Synchronization'class))))))))))))) { child = util'language.util'root || (some parent: type'CompositeElement'class + (type'State'class + (type'State'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'FinalState'class + (type'Entry'class + (type'Exit'class + (type'Transition'class + (type'Pseudostate'class + (type'Statechart'class + (type'Region'class + type'Synchronization'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'CompositeElement'class + (type'State'class + (type'State'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'FinalState'class + (type'Entry'class + (type'Exit'class + (type'Transition'class + (type'Pseudostate'class + (type'Statechart'class + (type'Region'class + type'Synchronization'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
