one sig util'language {
	...
	util'root : one type'RegularState'class + (type'State'class + (type'Exit'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Transition'class + (type'State'class + (type'Statechart'class + (type'Region'class + (type'Choice'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + type'Vertex'class))))))))))))),
	util'contains : (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Transition'class + (type'State'class + (type'Statechart'class + (type'Region'class + (type'Choice'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + type'Vertex'class)))))))))))))) lone->set (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Transition'class + (type'State'class + (type'Statechart'class + (type'Region'class + (type'Choice'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + type'Vertex'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'RegularState'class + (type'State'class + (type'Exit'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Transition'class + (type'State'class + (type'Statechart'class + (type'Region'class + (type'Choice'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + type'Vertex'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'RegularState'class + (type'State'class + (type'Exit'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Transition'class + (type'State'class + (type'Statechart'class + (type'Region'class + (type'Choice'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + type'Vertex'class))))))))))))) { child = util'language.util'root or (some parent: type'RegularState'class + (type'State'class + (type'Exit'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Transition'class + (type'State'class + (type'Statechart'class + (type'Region'class + (type'Choice'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + type'Vertex'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'RegularState'class + (type'State'class + (type'Exit'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Transition'class + (type'State'class + (type'Statechart'class + (type'Region'class + (type'Choice'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + type'Vertex'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
