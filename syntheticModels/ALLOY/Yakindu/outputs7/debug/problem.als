one sig util'language {
	...
	util'root : one type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Exit'class + (type'FinalState'class + (type'Statechart'class + (type'Choice'class + (type'Region'class + (type'Synchronization'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'State'class + type'Vertex'class))))))))))))),
	util'contains : (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Exit'class + (type'FinalState'class + (type'Statechart'class + (type'Choice'class + (type'Region'class + (type'Synchronization'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'State'class + type'Vertex'class)))))))))))))) lone->set (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Exit'class + (type'FinalState'class + (type'Statechart'class + (type'Choice'class + (type'Region'class + (type'Synchronization'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'State'class + type'Vertex'class))))))))))))))
}
...
pred pattern'queries'noEntryInRegion [parameter'r1: type'Region'class] {
	all variable'0: type'Entry'class { parameter'r1 in type'Region'class && ! (pattern'queries'entryInRegion [ parameter'r1 , variable'0 ]) }
}
...
pred pattern'queries'noOutgoingTransitionFromEntry [parameter'e: type'Entry'class] {
	all variable'0: type'Transition'class, variable'1: type'Vertex'class { parameter'e in type'Entry'class && ! (pattern'queries'transition [ variable'0 , parameter'e , variable'1 ]) }
}
...
pred pattern'queries'noStateInRegion [parameter'region: type'Region'class] {
	all variable'0: type'State'class { parameter'region in type'Region'class && ! (pattern'queries'StateInRegion [ parameter'region , variable'0 ]) }
}
...
pred pattern'queries'choiceHasNoOutgoing [parameter'c: type'Choice'class] {
	all variable'0: type'Transition'class, variable'1: type'Vertex'class { parameter'c in type'Choice'class && ! (pattern'queries'transition [ variable'0 , parameter'c , variable'1 ]) }
}
pred pattern'queries'choiceHasNoIncoming [parameter'c: type'Choice'class] {
	all variable'0: type'Transition'class, variable'1: type'Vertex'class { parameter'c in type'Choice'class && ! (pattern'queries'transition [ variable'0 , variable'1 , parameter'c ]) }
}
...
fact util'noParentForRoot {
	no parent: type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Exit'class + (type'FinalState'class + (type'Statechart'class + (type'Choice'class + (type'Region'class + (type'Synchronization'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'State'class + type'Vertex'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Exit'class + (type'FinalState'class + (type'Statechart'class + (type'Choice'class + (type'Region'class + (type'Synchronization'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'State'class + type'Vertex'class))))))))))))) { child = util'language.util'root or (some parent: type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Exit'class + (type'FinalState'class + (type'Statechart'class + (type'Choice'class + (type'Region'class + (type'Synchronization'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'State'class + type'Vertex'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Exit'class + (type'FinalState'class + (type'Statechart'class + (type'Choice'class + (type'Region'class + (type'Synchronization'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'State'class + type'Vertex'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
...
run { } for exactly 18 util'Object , 2 Int , exactly 0 String