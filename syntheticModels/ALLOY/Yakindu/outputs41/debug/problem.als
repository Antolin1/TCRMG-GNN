one sig util'language {
	...
	util'root : one type'Vertex'class + (type'Entry'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Region'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Exit'class + (type'Statechart'class + (type'Synchronization'class + type'FinalState'class))))))))))))),
	util'contains : (type'Vertex'class + (type'Entry'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Region'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Exit'class + (type'Statechart'class + (type'Synchronization'class + type'FinalState'class)))))))))))))) lone->set (type'Vertex'class + (type'Entry'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Region'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Exit'class + (type'Statechart'class + (type'Synchronization'class + type'FinalState'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Vertex'class + (type'Entry'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Region'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Exit'class + (type'Statechart'class + (type'Synchronization'class + type'FinalState'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Vertex'class + (type'Entry'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Region'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Exit'class + (type'Statechart'class + (type'Synchronization'class + type'FinalState'class))))))))))))) { child = util'language.util'root || (some parent: type'Vertex'class + (type'Entry'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Region'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Exit'class + (type'Statechart'class + (type'Synchronization'class + type'FinalState'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Vertex'class + (type'Entry'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Region'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Exit'class + (type'Statechart'class + (type'Synchronization'class + type'FinalState'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
