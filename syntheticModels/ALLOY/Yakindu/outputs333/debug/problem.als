one sig util'language {
	...
	util'root : one type'Region'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'Pseudostate'class + (type'Vertex'class + (type'Entry'class + (type'State'class + (type'Exit'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + type'State'class))))))))))))),
	util'contains : (type'Region'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'Pseudostate'class + (type'Vertex'class + (type'Entry'class + (type'State'class + (type'Exit'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + type'State'class)))))))))))))) lone->set (type'Region'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'Pseudostate'class + (type'Vertex'class + (type'Entry'class + (type'State'class + (type'Exit'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + type'State'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Region'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'Pseudostate'class + (type'Vertex'class + (type'Entry'class + (type'State'class + (type'Exit'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + type'State'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Region'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'Pseudostate'class + (type'Vertex'class + (type'Entry'class + (type'State'class + (type'Exit'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + type'State'class))))))))))))) { child = util'language.util'root or (some parent: type'Region'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'Pseudostate'class + (type'Vertex'class + (type'Entry'class + (type'State'class + (type'Exit'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + type'State'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Region'class + (type'FinalState'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'Pseudostate'class + (type'Vertex'class + (type'Entry'class + (type'State'class + (type'Exit'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + type'State'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
