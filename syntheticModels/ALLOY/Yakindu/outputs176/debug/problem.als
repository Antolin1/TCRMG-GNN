one sig util'language {
	...
	util'root : one type'Entry'class + (type'Exit'class + (type'Vertex'class + (type'Region'class + (type'Choice'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + type'Transition'class))))))))))))),
	util'contains : (type'Entry'class + (type'Exit'class + (type'Vertex'class + (type'Region'class + (type'Choice'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + type'Transition'class)))))))))))))) lone->set (type'Entry'class + (type'Exit'class + (type'Vertex'class + (type'Region'class + (type'Choice'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + type'Transition'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Entry'class + (type'Exit'class + (type'Vertex'class + (type'Region'class + (type'Choice'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + type'Transition'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Entry'class + (type'Exit'class + (type'Vertex'class + (type'Region'class + (type'Choice'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + type'Transition'class))))))))))))) { child = util'language.util'root or (some parent: type'Entry'class + (type'Exit'class + (type'Vertex'class + (type'Region'class + (type'Choice'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + type'Transition'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Entry'class + (type'Exit'class + (type'Vertex'class + (type'Region'class + (type'Choice'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + type'Transition'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
