one sig util'language {
	...
	util'root : one type'Entry'class + (type'Statechart'class + (type'Vertex'class + (type'Transition'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Region'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + type'Choice'class))))))))))))),
	util'contains : (type'Entry'class + (type'Statechart'class + (type'Vertex'class + (type'Transition'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Region'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + type'Choice'class)))))))))))))) lone->set (type'Entry'class + (type'Statechart'class + (type'Vertex'class + (type'Transition'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Region'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + type'Choice'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Entry'class + (type'Statechart'class + (type'Vertex'class + (type'Transition'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Region'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + type'Choice'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Entry'class + (type'Statechart'class + (type'Vertex'class + (type'Transition'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Region'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + type'Choice'class))))))))))))) { child = util'language.util'root || (some parent: type'Entry'class + (type'Statechart'class + (type'Vertex'class + (type'Transition'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Region'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + type'Choice'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Entry'class + (type'Statechart'class + (type'Vertex'class + (type'Transition'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Region'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + type'Choice'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
