one sig util'language {
	...
	util'root : one type'RegularState'class + (type'State'class + (type'Exit'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Vertex'class + (type'Statechart'class + (type'Region'class + type'Synchronization'class))))))))))))),
	util'contains : (type'RegularState'class + (type'State'class + (type'Exit'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Vertex'class + (type'Statechart'class + (type'Region'class + type'Synchronization'class)))))))))))))) lone->set (type'RegularState'class + (type'State'class + (type'Exit'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Vertex'class + (type'Statechart'class + (type'Region'class + type'Synchronization'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'RegularState'class + (type'State'class + (type'Exit'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Vertex'class + (type'Statechart'class + (type'Region'class + type'Synchronization'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'RegularState'class + (type'State'class + (type'Exit'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Vertex'class + (type'Statechart'class + (type'Region'class + type'Synchronization'class))))))))))))) { child = util'language.util'root || (some parent: type'RegularState'class + (type'State'class + (type'Exit'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Vertex'class + (type'Statechart'class + (type'Region'class + type'Synchronization'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'RegularState'class + (type'State'class + (type'Exit'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Vertex'class + (type'Statechart'class + (type'Region'class + type'Synchronization'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
