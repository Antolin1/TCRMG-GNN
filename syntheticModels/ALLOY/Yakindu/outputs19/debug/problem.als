one sig util'language {
	...
	util'root : one type'State'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Vertex'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Synchronization'class + (type'Entry'class + (type'Pseudostate'class + (type'Statechart'class + type'FinalState'class))))))))))))),
	util'contains : (type'State'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Vertex'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Synchronization'class + (type'Entry'class + (type'Pseudostate'class + (type'Statechart'class + type'FinalState'class)))))))))))))) lone->set (type'State'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Vertex'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Synchronization'class + (type'Entry'class + (type'Pseudostate'class + (type'Statechart'class + type'FinalState'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'State'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Vertex'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Synchronization'class + (type'Entry'class + (type'Pseudostate'class + (type'Statechart'class + type'FinalState'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'State'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Vertex'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Synchronization'class + (type'Entry'class + (type'Pseudostate'class + (type'Statechart'class + type'FinalState'class))))))))))))) { child = util'language.util'root or (some parent: type'State'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Vertex'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Synchronization'class + (type'Entry'class + (type'Pseudostate'class + (type'Statechart'class + type'FinalState'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'State'class + (type'RegularState'class + (type'State'class + (type'Exit'class + (type'Vertex'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Region'class + (type'Synchronization'class + (type'Entry'class + (type'Pseudostate'class + (type'Statechart'class + type'FinalState'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
