one sig util'language {
	...
	util'root : one type'Transition'class + (type'Statechart'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Entry'class + (type'State'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Choice'class + (type'FinalState'class + type'Region'class))))))))))))),
	util'contains : (type'Transition'class + (type'Statechart'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Entry'class + (type'State'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Choice'class + (type'FinalState'class + type'Region'class)))))))))))))) lone->set (type'Transition'class + (type'Statechart'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Entry'class + (type'State'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Choice'class + (type'FinalState'class + type'Region'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Transition'class + (type'Statechart'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Entry'class + (type'State'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Choice'class + (type'FinalState'class + type'Region'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Transition'class + (type'Statechart'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Entry'class + (type'State'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Choice'class + (type'FinalState'class + type'Region'class))))))))))))) { child = util'language.util'root or (some parent: type'Transition'class + (type'Statechart'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Entry'class + (type'State'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Choice'class + (type'FinalState'class + type'Region'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Transition'class + (type'Statechart'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Entry'class + (type'State'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Choice'class + (type'FinalState'class + type'Region'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
