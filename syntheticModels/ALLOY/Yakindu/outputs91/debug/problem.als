one sig util'language {
	...
	util'root : one type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'FinalState'class + (type'Statechart'class + (type'Region'class + (type'Vertex'class + (type'Entry'class + (type'Pseudostate'class + (type'State'class + (type'Exit'class + type'Synchronization'class))))))))))))),
	util'contains : (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'FinalState'class + (type'Statechart'class + (type'Region'class + (type'Vertex'class + (type'Entry'class + (type'Pseudostate'class + (type'State'class + (type'Exit'class + type'Synchronization'class)))))))))))))) lone->set (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'FinalState'class + (type'Statechart'class + (type'Region'class + (type'Vertex'class + (type'Entry'class + (type'Pseudostate'class + (type'State'class + (type'Exit'class + type'Synchronization'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'FinalState'class + (type'Statechart'class + (type'Region'class + (type'Vertex'class + (type'Entry'class + (type'Pseudostate'class + (type'State'class + (type'Exit'class + type'Synchronization'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'FinalState'class + (type'Statechart'class + (type'Region'class + (type'Vertex'class + (type'Entry'class + (type'Pseudostate'class + (type'State'class + (type'Exit'class + type'Synchronization'class))))))))))))) { child = util'language.util'root or (some parent: type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'FinalState'class + (type'Statechart'class + (type'Region'class + (type'Vertex'class + (type'Entry'class + (type'Pseudostate'class + (type'State'class + (type'Exit'class + type'Synchronization'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'FinalState'class + (type'Statechart'class + (type'Region'class + (type'Vertex'class + (type'Entry'class + (type'Pseudostate'class + (type'State'class + (type'Exit'class + type'Synchronization'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
