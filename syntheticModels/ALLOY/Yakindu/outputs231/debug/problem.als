one sig util'language {
	...
	util'root : one type'Vertex'class + (type'Transition'class + (type'Exit'class + (type'Pseudostate'class + (type'Statechart'class + (type'Region'class + (type'FinalState'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'State'class + (type'CompositeElement'class + (type'State'class + type'Synchronization'class))))))))))))),
	util'contains : (type'Vertex'class + (type'Transition'class + (type'Exit'class + (type'Pseudostate'class + (type'Statechart'class + (type'Region'class + (type'FinalState'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'State'class + (type'CompositeElement'class + (type'State'class + type'Synchronization'class)))))))))))))) lone->set (type'Vertex'class + (type'Transition'class + (type'Exit'class + (type'Pseudostate'class + (type'Statechart'class + (type'Region'class + (type'FinalState'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'State'class + (type'CompositeElement'class + (type'State'class + type'Synchronization'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Vertex'class + (type'Transition'class + (type'Exit'class + (type'Pseudostate'class + (type'Statechart'class + (type'Region'class + (type'FinalState'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'State'class + (type'CompositeElement'class + (type'State'class + type'Synchronization'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Vertex'class + (type'Transition'class + (type'Exit'class + (type'Pseudostate'class + (type'Statechart'class + (type'Region'class + (type'FinalState'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'State'class + (type'CompositeElement'class + (type'State'class + type'Synchronization'class))))))))))))) { child = util'language.util'root || (some parent: type'Vertex'class + (type'Transition'class + (type'Exit'class + (type'Pseudostate'class + (type'Statechart'class + (type'Region'class + (type'FinalState'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'State'class + (type'CompositeElement'class + (type'State'class + type'Synchronization'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Vertex'class + (type'Transition'class + (type'Exit'class + (type'Pseudostate'class + (type'Statechart'class + (type'Region'class + (type'FinalState'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'State'class + (type'CompositeElement'class + (type'State'class + type'Synchronization'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
