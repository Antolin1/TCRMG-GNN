one sig util'language {
	...
	util'root : one type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Region'class + (type'State'class + (type'Choice'class + (type'FinalState'class + (type'Entry'class + (type'Vertex'class + (type'Pseudostate'class + (type'Exit'class + (type'RegularState'class + (type'State'class + type'Statechart'class))))))))))))),
	util'contains : (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Region'class + (type'State'class + (type'Choice'class + (type'FinalState'class + (type'Entry'class + (type'Vertex'class + (type'Pseudostate'class + (type'Exit'class + (type'RegularState'class + (type'State'class + type'Statechart'class)))))))))))))) lone->set (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Region'class + (type'State'class + (type'Choice'class + (type'FinalState'class + (type'Entry'class + (type'Vertex'class + (type'Pseudostate'class + (type'Exit'class + (type'RegularState'class + (type'State'class + type'Statechart'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Region'class + (type'State'class + (type'Choice'class + (type'FinalState'class + (type'Entry'class + (type'Vertex'class + (type'Pseudostate'class + (type'Exit'class + (type'RegularState'class + (type'State'class + type'Statechart'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Region'class + (type'State'class + (type'Choice'class + (type'FinalState'class + (type'Entry'class + (type'Vertex'class + (type'Pseudostate'class + (type'Exit'class + (type'RegularState'class + (type'State'class + type'Statechart'class))))))))))))) { child = util'language.util'root or (some parent: type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Region'class + (type'State'class + (type'Choice'class + (type'FinalState'class + (type'Entry'class + (type'Vertex'class + (type'Pseudostate'class + (type'Exit'class + (type'RegularState'class + (type'State'class + type'Statechart'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Region'class + (type'State'class + (type'Choice'class + (type'FinalState'class + (type'Entry'class + (type'Vertex'class + (type'Pseudostate'class + (type'Exit'class + (type'RegularState'class + (type'State'class + type'Statechart'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
