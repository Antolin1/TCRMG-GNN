one sig util'language {
	...
	util'root : one type'Synchronization'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Entry'class + (type'Exit'class + (type'Region'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + type'Vertex'class))))))))))))),
	util'contains : (type'Synchronization'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Entry'class + (type'Exit'class + (type'Region'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + type'Vertex'class)))))))))))))) lone->set (type'Synchronization'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Entry'class + (type'Exit'class + (type'Region'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + type'Vertex'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Synchronization'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Entry'class + (type'Exit'class + (type'Region'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + type'Vertex'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Synchronization'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Entry'class + (type'Exit'class + (type'Region'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + type'Vertex'class))))))))))))) { child = util'language.util'root || (some parent: type'Synchronization'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Entry'class + (type'Exit'class + (type'Region'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + type'Vertex'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Synchronization'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'Entry'class + (type'Exit'class + (type'Region'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + type'Vertex'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
