one sig util'language {
	...
	util'root : one type'Transition'class + (type'Region'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Exit'class + (type'FinalState'class + (type'Pseudostate'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'State'class + (type'Statechart'class + type'Vertex'class))))))))))))),
	util'contains : (type'Transition'class + (type'Region'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Exit'class + (type'FinalState'class + (type'Pseudostate'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'State'class + (type'Statechart'class + type'Vertex'class)))))))))))))) lone->set (type'Transition'class + (type'Region'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Exit'class + (type'FinalState'class + (type'Pseudostate'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'State'class + (type'Statechart'class + type'Vertex'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Transition'class + (type'Region'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Exit'class + (type'FinalState'class + (type'Pseudostate'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'State'class + (type'Statechart'class + type'Vertex'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Transition'class + (type'Region'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Exit'class + (type'FinalState'class + (type'Pseudostate'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'State'class + (type'Statechart'class + type'Vertex'class))))))))))))) { child = util'language.util'root or (some parent: type'Transition'class + (type'Region'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Exit'class + (type'FinalState'class + (type'Pseudostate'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'State'class + (type'Statechart'class + type'Vertex'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Transition'class + (type'Region'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Exit'class + (type'FinalState'class + (type'Pseudostate'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'State'class + (type'Statechart'class + type'Vertex'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
