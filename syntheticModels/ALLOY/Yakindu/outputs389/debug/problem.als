one sig util'language {
	...
	util'root : one type'Choice'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Region'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + (type'Statechart'class + type'Exit'class))))))))))))),
	util'contains : (type'Choice'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Region'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + (type'Statechart'class + type'Exit'class)))))))))))))) lone->set (type'Choice'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Region'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + (type'Statechart'class + type'Exit'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Choice'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Region'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + (type'Statechart'class + type'Exit'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Choice'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Region'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + (type'Statechart'class + type'Exit'class))))))))))))) { child = util'language.util'root || (some parent: type'Choice'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Region'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + (type'Statechart'class + type'Exit'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Choice'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Transition'class + (type'Region'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'FinalState'class + (type'State'class + (type'Pseudostate'class + (type'Statechart'class + type'Exit'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
