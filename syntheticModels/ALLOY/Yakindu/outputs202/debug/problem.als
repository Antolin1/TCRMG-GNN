one sig util'language {
	...
	util'root : one type'State'class + (type'Synchronization'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Statechart'class + (type'Transition'class + (type'Region'class + (type'Vertex'class + (type'Pseudostate'class + (type'Entry'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + type'Choice'class))))))))))))),
	util'contains : (type'State'class + (type'Synchronization'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Statechart'class + (type'Transition'class + (type'Region'class + (type'Vertex'class + (type'Pseudostate'class + (type'Entry'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + type'Choice'class)))))))))))))) lone->set (type'State'class + (type'Synchronization'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Statechart'class + (type'Transition'class + (type'Region'class + (type'Vertex'class + (type'Pseudostate'class + (type'Entry'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + type'Choice'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'State'class + (type'Synchronization'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Statechart'class + (type'Transition'class + (type'Region'class + (type'Vertex'class + (type'Pseudostate'class + (type'Entry'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + type'Choice'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'State'class + (type'Synchronization'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Statechart'class + (type'Transition'class + (type'Region'class + (type'Vertex'class + (type'Pseudostate'class + (type'Entry'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + type'Choice'class))))))))))))) { child = util'language.util'root or (some parent: type'State'class + (type'Synchronization'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Statechart'class + (type'Transition'class + (type'Region'class + (type'Vertex'class + (type'Pseudostate'class + (type'Entry'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + type'Choice'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'State'class + (type'Synchronization'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Statechart'class + (type'Transition'class + (type'Region'class + (type'Vertex'class + (type'Pseudostate'class + (type'Entry'class + (type'FinalState'class + (type'CompositeElement'class + (type'State'class + type'Choice'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
