one sig util'language {
	...
	util'root : one type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'Vertex'class + (type'Entry'class + (type'Transition'class + (type'Choice'class + (type'State'class + (type'Region'class + (type'Statechart'class + (type'Pseudostate'class + (type'Synchronization'class + (type'CompositeElement'class + type'State'class))))))))))))),
	util'contains : (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'Vertex'class + (type'Entry'class + (type'Transition'class + (type'Choice'class + (type'State'class + (type'Region'class + (type'Statechart'class + (type'Pseudostate'class + (type'Synchronization'class + (type'CompositeElement'class + type'State'class)))))))))))))) lone->set (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'Vertex'class + (type'Entry'class + (type'Transition'class + (type'Choice'class + (type'State'class + (type'Region'class + (type'Statechart'class + (type'Pseudostate'class + (type'Synchronization'class + (type'CompositeElement'class + type'State'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'Vertex'class + (type'Entry'class + (type'Transition'class + (type'Choice'class + (type'State'class + (type'Region'class + (type'Statechart'class + (type'Pseudostate'class + (type'Synchronization'class + (type'CompositeElement'class + type'State'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'Vertex'class + (type'Entry'class + (type'Transition'class + (type'Choice'class + (type'State'class + (type'Region'class + (type'Statechart'class + (type'Pseudostate'class + (type'Synchronization'class + (type'CompositeElement'class + type'State'class))))))))))))) { child = util'language.util'root || (some parent: type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'Vertex'class + (type'Entry'class + (type'Transition'class + (type'Choice'class + (type'State'class + (type'Region'class + (type'Statechart'class + (type'Pseudostate'class + (type'Synchronization'class + (type'CompositeElement'class + type'State'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'Vertex'class + (type'Entry'class + (type'Transition'class + (type'Choice'class + (type'State'class + (type'Region'class + (type'Statechart'class + (type'Pseudostate'class + (type'Synchronization'class + (type'CompositeElement'class + type'State'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
