one sig util'language {
	...
	util'root : one type'Statechart'class + (type'Synchronization'class + (type'Exit'class + (type'Choice'class + (type'Pseudostate'class + (type'Vertex'class + (type'Transition'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Region'class + type'Entry'class))))))))))))),
	util'contains : (type'Statechart'class + (type'Synchronization'class + (type'Exit'class + (type'Choice'class + (type'Pseudostate'class + (type'Vertex'class + (type'Transition'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Region'class + type'Entry'class)))))))))))))) lone->set (type'Statechart'class + (type'Synchronization'class + (type'Exit'class + (type'Choice'class + (type'Pseudostate'class + (type'Vertex'class + (type'Transition'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Region'class + type'Entry'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Statechart'class + (type'Synchronization'class + (type'Exit'class + (type'Choice'class + (type'Pseudostate'class + (type'Vertex'class + (type'Transition'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Region'class + type'Entry'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Statechart'class + (type'Synchronization'class + (type'Exit'class + (type'Choice'class + (type'Pseudostate'class + (type'Vertex'class + (type'Transition'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Region'class + type'Entry'class))))))))))))) { child = util'language.util'root || (some parent: type'Statechart'class + (type'Synchronization'class + (type'Exit'class + (type'Choice'class + (type'Pseudostate'class + (type'Vertex'class + (type'Transition'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Region'class + type'Entry'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Statechart'class + (type'Synchronization'class + (type'Exit'class + (type'Choice'class + (type'Pseudostate'class + (type'Vertex'class + (type'Transition'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Region'class + type'Entry'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
