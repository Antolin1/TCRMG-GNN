one sig util'language {
	...
	util'root : one type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Statechart'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Region'class + (type'Transition'class + (type'Synchronization'class + (type'Entry'class + (type'Vertex'class + (type'Exit'class + type'Choice'class))))))))))))),
	util'contains : (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Statechart'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Region'class + (type'Transition'class + (type'Synchronization'class + (type'Entry'class + (type'Vertex'class + (type'Exit'class + type'Choice'class)))))))))))))) lone->set (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Statechart'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Region'class + (type'Transition'class + (type'Synchronization'class + (type'Entry'class + (type'Vertex'class + (type'Exit'class + type'Choice'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Statechart'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Region'class + (type'Transition'class + (type'Synchronization'class + (type'Entry'class + (type'Vertex'class + (type'Exit'class + type'Choice'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Statechart'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Region'class + (type'Transition'class + (type'Synchronization'class + (type'Entry'class + (type'Vertex'class + (type'Exit'class + type'Choice'class))))))))))))) { child = util'language.util'root || (some parent: type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Statechart'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Region'class + (type'Transition'class + (type'Synchronization'class + (type'Entry'class + (type'Vertex'class + (type'Exit'class + type'Choice'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Statechart'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Region'class + (type'Transition'class + (type'Synchronization'class + (type'Entry'class + (type'Vertex'class + (type'Exit'class + type'Choice'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
