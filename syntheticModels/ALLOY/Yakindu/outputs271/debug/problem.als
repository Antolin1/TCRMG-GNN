one sig util'language {
	...
	util'root : one type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Choice'class + (type'State'class + (type'Statechart'class + (type'Transition'class + (type'FinalState'class + (type'Pseudostate'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Region'class + type'Entry'class))))))))))))),
	util'contains : (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Choice'class + (type'State'class + (type'Statechart'class + (type'Transition'class + (type'FinalState'class + (type'Pseudostate'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Region'class + type'Entry'class)))))))))))))) lone->set (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Choice'class + (type'State'class + (type'Statechart'class + (type'Transition'class + (type'FinalState'class + (type'Pseudostate'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Region'class + type'Entry'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Choice'class + (type'State'class + (type'Statechart'class + (type'Transition'class + (type'FinalState'class + (type'Pseudostate'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Region'class + type'Entry'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Choice'class + (type'State'class + (type'Statechart'class + (type'Transition'class + (type'FinalState'class + (type'Pseudostate'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Region'class + type'Entry'class))))))))))))) { child = util'language.util'root || (some parent: type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Choice'class + (type'State'class + (type'Statechart'class + (type'Transition'class + (type'FinalState'class + (type'Pseudostate'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Region'class + type'Entry'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Choice'class + (type'State'class + (type'Statechart'class + (type'Transition'class + (type'FinalState'class + (type'Pseudostate'class + (type'Exit'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Region'class + type'Entry'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
