one sig util'language {
	...
	util'root : one type'Statechart'class + (type'Entry'class + (type'Transition'class + (type'Region'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + (type'FinalState'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + type'Vertex'class))))))))))))),
	util'contains : (type'Statechart'class + (type'Entry'class + (type'Transition'class + (type'Region'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + (type'FinalState'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + type'Vertex'class)))))))))))))) lone->set (type'Statechart'class + (type'Entry'class + (type'Transition'class + (type'Region'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + (type'FinalState'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + type'Vertex'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Statechart'class + (type'Entry'class + (type'Transition'class + (type'Region'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + (type'FinalState'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + type'Vertex'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Statechart'class + (type'Entry'class + (type'Transition'class + (type'Region'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + (type'FinalState'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + type'Vertex'class))))))))))))) { child = util'language.util'root || (some parent: type'Statechart'class + (type'Entry'class + (type'Transition'class + (type'Region'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + (type'FinalState'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + type'Vertex'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Statechart'class + (type'Entry'class + (type'Transition'class + (type'Region'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + (type'FinalState'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + type'Vertex'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
