one sig util'language {
	...
	util'root : one type'Vertex'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'Exit'class + (type'Synchronization'class + (type'Choice'class + (type'State'class + type'Pseudostate'class))))))))))))),
	util'contains : (type'Vertex'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'Exit'class + (type'Synchronization'class + (type'Choice'class + (type'State'class + type'Pseudostate'class)))))))))))))) lone->set (type'Vertex'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'Exit'class + (type'Synchronization'class + (type'Choice'class + (type'State'class + type'Pseudostate'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Vertex'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'Exit'class + (type'Synchronization'class + (type'Choice'class + (type'State'class + type'Pseudostate'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Vertex'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'Exit'class + (type'Synchronization'class + (type'Choice'class + (type'State'class + type'Pseudostate'class))))))))))))) { child = util'language.util'root or (some parent: type'Vertex'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'Exit'class + (type'Synchronization'class + (type'Choice'class + (type'State'class + type'Pseudostate'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Vertex'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'Exit'class + (type'Synchronization'class + (type'Choice'class + (type'State'class + type'Pseudostate'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
