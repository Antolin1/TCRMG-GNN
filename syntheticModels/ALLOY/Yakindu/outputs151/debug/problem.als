one sig util'language {
	...
	util'root : one type'Vertex'class + (type'Region'class + (type'Entry'class + (type'Pseudostate'class + (type'Statechart'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + type'Transition'class))))))))))))),
	util'contains : (type'Vertex'class + (type'Region'class + (type'Entry'class + (type'Pseudostate'class + (type'Statechart'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + type'Transition'class)))))))))))))) lone->set (type'Vertex'class + (type'Region'class + (type'Entry'class + (type'Pseudostate'class + (type'Statechart'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + type'Transition'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Vertex'class + (type'Region'class + (type'Entry'class + (type'Pseudostate'class + (type'Statechart'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + type'Transition'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Vertex'class + (type'Region'class + (type'Entry'class + (type'Pseudostate'class + (type'Statechart'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + type'Transition'class))))))))))))) { child = util'language.util'root || (some parent: type'Vertex'class + (type'Region'class + (type'Entry'class + (type'Pseudostate'class + (type'Statechart'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + type'Transition'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Vertex'class + (type'Region'class + (type'Entry'class + (type'Pseudostate'class + (type'Statechart'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + type'Transition'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
