one sig util'language {
	...
	util'root : one type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Pseudostate'class + (type'Entry'class + (type'Region'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'State'class + (type'Vertex'class + (type'Statechart'class + type'Transition'class))))))))))))),
	util'contains : (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Pseudostate'class + (type'Entry'class + (type'Region'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'State'class + (type'Vertex'class + (type'Statechart'class + type'Transition'class)))))))))))))) lone->set (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Pseudostate'class + (type'Entry'class + (type'Region'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'State'class + (type'Vertex'class + (type'Statechart'class + type'Transition'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Pseudostate'class + (type'Entry'class + (type'Region'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'State'class + (type'Vertex'class + (type'Statechart'class + type'Transition'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Pseudostate'class + (type'Entry'class + (type'Region'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'State'class + (type'Vertex'class + (type'Statechart'class + type'Transition'class))))))))))))) { child = util'language.util'root || (some parent: type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Pseudostate'class + (type'Entry'class + (type'Region'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'State'class + (type'Vertex'class + (type'Statechart'class + type'Transition'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Pseudostate'class + (type'Entry'class + (type'Region'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'State'class + (type'Vertex'class + (type'Statechart'class + type'Transition'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
