one sig util'language {
	...
	util'root : one type'Synchronization'class + (type'Entry'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Vertex'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Pseudostate'class + type'Exit'class))))))))))))),
	util'contains : (type'Synchronization'class + (type'Entry'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Vertex'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Pseudostate'class + type'Exit'class)))))))))))))) lone->set (type'Synchronization'class + (type'Entry'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Vertex'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Pseudostate'class + type'Exit'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Synchronization'class + (type'Entry'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Vertex'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Pseudostate'class + type'Exit'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Synchronization'class + (type'Entry'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Vertex'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Pseudostate'class + type'Exit'class))))))))))))) { child = util'language.util'root || (some parent: type'Synchronization'class + (type'Entry'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Vertex'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Pseudostate'class + type'Exit'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Synchronization'class + (type'Entry'class + (type'Region'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Vertex'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Transition'class + (type'FinalState'class + (type'Pseudostate'class + type'Exit'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
