one sig util'language {
	...
	util'root : one type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + (type'Exit'class + (type'Vertex'class + (type'Region'class + (type'Pseudostate'class + (type'Choice'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'State'class + type'Transition'class))))))))))))),
	util'contains : (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + (type'Exit'class + (type'Vertex'class + (type'Region'class + (type'Pseudostate'class + (type'Choice'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'State'class + type'Transition'class)))))))))))))) lone->set (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + (type'Exit'class + (type'Vertex'class + (type'Region'class + (type'Pseudostate'class + (type'Choice'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'State'class + type'Transition'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + (type'Exit'class + (type'Vertex'class + (type'Region'class + (type'Pseudostate'class + (type'Choice'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'State'class + type'Transition'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + (type'Exit'class + (type'Vertex'class + (type'Region'class + (type'Pseudostate'class + (type'Choice'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'State'class + type'Transition'class))))))))))))) { child = util'language.util'root or (some parent: type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + (type'Exit'class + (type'Vertex'class + (type'Region'class + (type'Pseudostate'class + (type'Choice'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'State'class + type'Transition'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + (type'Exit'class + (type'Vertex'class + (type'Region'class + (type'Pseudostate'class + (type'Choice'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'State'class + type'Transition'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
