one sig util'language {
	...
	util'root : one type'Region'class + (type'FinalState'class + (type'Synchronization'class + (type'Statechart'class + (type'Pseudostate'class + (type'Exit'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Transition'class + (type'State'class + (type'RegularState'class + (type'State'class + type'Entry'class))))))))))))),
	util'contains : (type'Region'class + (type'FinalState'class + (type'Synchronization'class + (type'Statechart'class + (type'Pseudostate'class + (type'Exit'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Transition'class + (type'State'class + (type'RegularState'class + (type'State'class + type'Entry'class)))))))))))))) lone->set (type'Region'class + (type'FinalState'class + (type'Synchronization'class + (type'Statechart'class + (type'Pseudostate'class + (type'Exit'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Transition'class + (type'State'class + (type'RegularState'class + (type'State'class + type'Entry'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Region'class + (type'FinalState'class + (type'Synchronization'class + (type'Statechart'class + (type'Pseudostate'class + (type'Exit'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Transition'class + (type'State'class + (type'RegularState'class + (type'State'class + type'Entry'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Region'class + (type'FinalState'class + (type'Synchronization'class + (type'Statechart'class + (type'Pseudostate'class + (type'Exit'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Transition'class + (type'State'class + (type'RegularState'class + (type'State'class + type'Entry'class))))))))))))) { child = util'language.util'root || (some parent: type'Region'class + (type'FinalState'class + (type'Synchronization'class + (type'Statechart'class + (type'Pseudostate'class + (type'Exit'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Transition'class + (type'State'class + (type'RegularState'class + (type'State'class + type'Entry'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Region'class + (type'FinalState'class + (type'Synchronization'class + (type'Statechart'class + (type'Pseudostate'class + (type'Exit'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Choice'class + (type'Transition'class + (type'State'class + (type'RegularState'class + (type'State'class + type'Entry'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
