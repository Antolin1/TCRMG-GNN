one sig util'language {
	...
	util'root : one type'Synchronization'class + (type'Choice'class + (type'Entry'class + (type'Pseudostate'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + (type'Statechart'class + (type'Exit'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + type'State'class))))))))))))),
	util'contains : (type'Synchronization'class + (type'Choice'class + (type'Entry'class + (type'Pseudostate'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + (type'Statechart'class + (type'Exit'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + type'State'class)))))))))))))) lone->set (type'Synchronization'class + (type'Choice'class + (type'Entry'class + (type'Pseudostate'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + (type'Statechart'class + (type'Exit'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + type'State'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Synchronization'class + (type'Choice'class + (type'Entry'class + (type'Pseudostate'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + (type'Statechart'class + (type'Exit'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + type'State'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Synchronization'class + (type'Choice'class + (type'Entry'class + (type'Pseudostate'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + (type'Statechart'class + (type'Exit'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + type'State'class))))))))))))) { child = util'language.util'root || (some parent: type'Synchronization'class + (type'Choice'class + (type'Entry'class + (type'Pseudostate'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + (type'Statechart'class + (type'Exit'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + type'State'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Synchronization'class + (type'Choice'class + (type'Entry'class + (type'Pseudostate'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + (type'Statechart'class + (type'Exit'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'CompositeElement'class + (type'State'class + type'State'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
