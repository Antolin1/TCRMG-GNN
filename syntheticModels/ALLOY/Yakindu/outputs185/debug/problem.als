one sig util'language {
	...
	util'root : one type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Choice'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + type'Region'class))))))))))))),
	util'contains : (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Choice'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + type'Region'class)))))))))))))) lone->set (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Choice'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + type'Region'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Choice'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + type'Region'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Choice'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + type'Region'class))))))))))))) { child = util'language.util'root || (some parent: type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Choice'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + type'Region'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Choice'class + (type'Transition'class + (type'Statechart'class + (type'Synchronization'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Pseudostate'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + type'Region'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
...
run { } for exactly 14 util'Object , 2 Int , exactly 0 String