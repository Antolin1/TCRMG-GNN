one sig util'language {
	...
	util'root : one type'State'class + (type'Exit'class + (type'Pseudostate'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Vertex'class + (type'Choice'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + type'Region'class))))))))))))),
	util'contains : (type'State'class + (type'Exit'class + (type'Pseudostate'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Vertex'class + (type'Choice'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + type'Region'class)))))))))))))) lone->set (type'State'class + (type'Exit'class + (type'Pseudostate'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Vertex'class + (type'Choice'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + type'Region'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'State'class + (type'Exit'class + (type'Pseudostate'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Vertex'class + (type'Choice'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + type'Region'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'State'class + (type'Exit'class + (type'Pseudostate'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Vertex'class + (type'Choice'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + type'Region'class))))))))))))) { child = util'language.util'root || (some parent: type'State'class + (type'Exit'class + (type'Pseudostate'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Vertex'class + (type'Choice'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + type'Region'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'State'class + (type'Exit'class + (type'Pseudostate'class + (type'Synchronization'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Vertex'class + (type'Choice'class + (type'FinalState'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + type'Region'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
