one sig util'language {
	...
	util'root : one type'RegularState'class + (type'State'class + (type'Choice'class + (type'Synchronization'class + (type'Entry'class + (type'Pseudostate'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Vertex'class + (type'Statechart'class + (type'Transition'class + type'Region'class))))))))))))),
	util'contains : (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Synchronization'class + (type'Entry'class + (type'Pseudostate'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Vertex'class + (type'Statechart'class + (type'Transition'class + type'Region'class)))))))))))))) lone->set (type'RegularState'class + (type'State'class + (type'Choice'class + (type'Synchronization'class + (type'Entry'class + (type'Pseudostate'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Vertex'class + (type'Statechart'class + (type'Transition'class + type'Region'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'RegularState'class + (type'State'class + (type'Choice'class + (type'Synchronization'class + (type'Entry'class + (type'Pseudostate'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Vertex'class + (type'Statechart'class + (type'Transition'class + type'Region'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'RegularState'class + (type'State'class + (type'Choice'class + (type'Synchronization'class + (type'Entry'class + (type'Pseudostate'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Vertex'class + (type'Statechart'class + (type'Transition'class + type'Region'class))))))))))))) { child = util'language.util'root or (some parent: type'RegularState'class + (type'State'class + (type'Choice'class + (type'Synchronization'class + (type'Entry'class + (type'Pseudostate'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Vertex'class + (type'Statechart'class + (type'Transition'class + type'Region'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'RegularState'class + (type'State'class + (type'Choice'class + (type'Synchronization'class + (type'Entry'class + (type'Pseudostate'class + (type'State'class + (type'FinalState'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Vertex'class + (type'Statechart'class + (type'Transition'class + type'Region'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
