one sig util'language {
	...
	util'root : one type'Choice'class + (type'Exit'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'Pseudostate'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + type'FinalState'class))))))))))))),
	util'contains : (type'Choice'class + (type'Exit'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'Pseudostate'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + type'FinalState'class)))))))))))))) lone->set (type'Choice'class + (type'Exit'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'Pseudostate'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + type'FinalState'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Choice'class + (type'Exit'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'Pseudostate'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + type'FinalState'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Choice'class + (type'Exit'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'Pseudostate'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + type'FinalState'class))))))))))))) { child = util'language.util'root || (some parent: type'Choice'class + (type'Exit'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'Pseudostate'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + type'FinalState'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Choice'class + (type'Exit'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Region'class + (type'Pseudostate'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + type'FinalState'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
