one sig util'language {
	...
	util'root : one type'FinalState'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'Vertex'class + (type'Choice'class + (type'Exit'class + type'Region'class))))))))))))),
	util'contains : (type'FinalState'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'Vertex'class + (type'Choice'class + (type'Exit'class + type'Region'class)))))))))))))) lone->set (type'FinalState'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'Vertex'class + (type'Choice'class + (type'Exit'class + type'Region'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'FinalState'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'Vertex'class + (type'Choice'class + (type'Exit'class + type'Region'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'FinalState'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'Vertex'class + (type'Choice'class + (type'Exit'class + type'Region'class))))))))))))) { child = util'language.util'root or (some parent: type'FinalState'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'Vertex'class + (type'Choice'class + (type'Exit'class + type'Region'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'FinalState'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'Transition'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Entry'class + (type'Statechart'class + (type'Vertex'class + (type'Choice'class + (type'Exit'class + type'Region'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
