one sig util'language {
	...
	util'root : one type'Transition'class + (type'Statechart'class + (type'State'class + (type'Vertex'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + (type'Entry'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + type'Choice'class))))))))))))),
	util'contains : (type'Transition'class + (type'Statechart'class + (type'State'class + (type'Vertex'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + (type'Entry'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + type'Choice'class)))))))))))))) lone->set (type'Transition'class + (type'Statechart'class + (type'State'class + (type'Vertex'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + (type'Entry'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + type'Choice'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Transition'class + (type'Statechart'class + (type'State'class + (type'Vertex'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + (type'Entry'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + type'Choice'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Transition'class + (type'Statechart'class + (type'State'class + (type'Vertex'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + (type'Entry'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + type'Choice'class))))))))))))) { child = util'language.util'root || (some parent: type'Transition'class + (type'Statechart'class + (type'State'class + (type'Vertex'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + (type'Entry'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + type'Choice'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Transition'class + (type'Statechart'class + (type'State'class + (type'Vertex'class + (type'Region'class + (type'RegularState'class + (type'State'class + (type'Synchronization'class + (type'FinalState'class + (type'Entry'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + type'Choice'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
