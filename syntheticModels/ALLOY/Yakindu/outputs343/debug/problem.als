one sig util'language {
	...
	util'root : one type'RegularState'class + (type'State'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Region'class + (type'Choice'class + (type'Exit'class + (type'Vertex'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'FinalState'class + type'Transition'class))))))))))))),
	util'contains : (type'RegularState'class + (type'State'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Region'class + (type'Choice'class + (type'Exit'class + (type'Vertex'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'FinalState'class + type'Transition'class)))))))))))))) lone->set (type'RegularState'class + (type'State'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Region'class + (type'Choice'class + (type'Exit'class + (type'Vertex'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'FinalState'class + type'Transition'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'RegularState'class + (type'State'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Region'class + (type'Choice'class + (type'Exit'class + (type'Vertex'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'FinalState'class + type'Transition'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'RegularState'class + (type'State'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Region'class + (type'Choice'class + (type'Exit'class + (type'Vertex'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'FinalState'class + type'Transition'class))))))))))))) { child = util'language.util'root or (some parent: type'RegularState'class + (type'State'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Region'class + (type'Choice'class + (type'Exit'class + (type'Vertex'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'FinalState'class + type'Transition'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'RegularState'class + (type'State'class + (type'State'class + (type'Synchronization'class + (type'Entry'class + (type'Region'class + (type'Choice'class + (type'Exit'class + (type'Vertex'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'FinalState'class + type'Transition'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
