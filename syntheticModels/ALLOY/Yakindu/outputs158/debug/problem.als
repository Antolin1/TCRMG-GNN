one sig util'language {
	...
	util'root : one type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Vertex'class + (type'Pseudostate'class + (type'Statechart'class + (type'State'class + (type'Region'class + (type'Exit'class + (type'Transition'class + type'Choice'class))))))))))))),
	util'contains : (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Vertex'class + (type'Pseudostate'class + (type'Statechart'class + (type'State'class + (type'Region'class + (type'Exit'class + (type'Transition'class + type'Choice'class)))))))))))))) lone->set (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Vertex'class + (type'Pseudostate'class + (type'Statechart'class + (type'State'class + (type'Region'class + (type'Exit'class + (type'Transition'class + type'Choice'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Vertex'class + (type'Pseudostate'class + (type'Statechart'class + (type'State'class + (type'Region'class + (type'Exit'class + (type'Transition'class + type'Choice'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Vertex'class + (type'Pseudostate'class + (type'Statechart'class + (type'State'class + (type'Region'class + (type'Exit'class + (type'Transition'class + type'Choice'class))))))))))))) { child = util'language.util'root or (some parent: type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Vertex'class + (type'Pseudostate'class + (type'Statechart'class + (type'State'class + (type'Region'class + (type'Exit'class + (type'Transition'class + type'Choice'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Vertex'class + (type'Pseudostate'class + (type'Statechart'class + (type'State'class + (type'Region'class + (type'Exit'class + (type'Transition'class + type'Choice'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
