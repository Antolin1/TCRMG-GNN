one sig util'language {
	...
	util'root : one type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Choice'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Transition'class + (type'Entry'class + (type'Region'class + type'Synchronization'class))))))))))))),
	util'contains : (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Choice'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Transition'class + (type'Entry'class + (type'Region'class + type'Synchronization'class)))))))))))))) lone->set (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Choice'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Transition'class + (type'Entry'class + (type'Region'class + type'Synchronization'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Choice'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Transition'class + (type'Entry'class + (type'Region'class + type'Synchronization'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Choice'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Transition'class + (type'Entry'class + (type'Region'class + type'Synchronization'class))))))))))))) { child = util'language.util'root || (some parent: type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Choice'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Transition'class + (type'Entry'class + (type'Region'class + type'Synchronization'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Choice'class + (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'State'class + (type'Exit'class + (type'FinalState'class + (type'Transition'class + (type'Entry'class + (type'Region'class + type'Synchronization'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
