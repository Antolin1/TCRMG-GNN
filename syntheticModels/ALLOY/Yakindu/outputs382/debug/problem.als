one sig util'language {
	...
	util'root : one type'Region'class + (type'Synchronization'class + (type'FinalState'class + (type'Entry'class + (type'Exit'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'Choice'class + type'Pseudostate'class))))))))))))),
	util'contains : (type'Region'class + (type'Synchronization'class + (type'FinalState'class + (type'Entry'class + (type'Exit'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'Choice'class + type'Pseudostate'class)))))))))))))) lone->set (type'Region'class + (type'Synchronization'class + (type'FinalState'class + (type'Entry'class + (type'Exit'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'Choice'class + type'Pseudostate'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Region'class + (type'Synchronization'class + (type'FinalState'class + (type'Entry'class + (type'Exit'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'Choice'class + type'Pseudostate'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Region'class + (type'Synchronization'class + (type'FinalState'class + (type'Entry'class + (type'Exit'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'Choice'class + type'Pseudostate'class))))))))))))) { child = util'language.util'root or (some parent: type'Region'class + (type'Synchronization'class + (type'FinalState'class + (type'Entry'class + (type'Exit'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'Choice'class + type'Pseudostate'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Region'class + (type'Synchronization'class + (type'FinalState'class + (type'Entry'class + (type'Exit'class + (type'State'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Statechart'class + (type'Choice'class + type'Pseudostate'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
