one sig util'language {
	...
	util'root : one type'FinalState'class + (type'Transition'class + (type'Choice'class + (type'Region'class + (type'State'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'Vertex'class + type'Statechart'class))))))))))))),
	util'contains : (type'FinalState'class + (type'Transition'class + (type'Choice'class + (type'Region'class + (type'State'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'Vertex'class + type'Statechart'class)))))))))))))) lone->set (type'FinalState'class + (type'Transition'class + (type'Choice'class + (type'Region'class + (type'State'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'Vertex'class + type'Statechart'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'FinalState'class + (type'Transition'class + (type'Choice'class + (type'Region'class + (type'State'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'Vertex'class + type'Statechart'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'FinalState'class + (type'Transition'class + (type'Choice'class + (type'Region'class + (type'State'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'Vertex'class + type'Statechart'class))))))))))))) { child = util'language.util'root || (some parent: type'FinalState'class + (type'Transition'class + (type'Choice'class + (type'Region'class + (type'State'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'Vertex'class + type'Statechart'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'FinalState'class + (type'Transition'class + (type'Choice'class + (type'Region'class + (type'State'class + (type'Entry'class + (type'CompositeElement'class + (type'State'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Exit'class + (type'Vertex'class + type'Statechart'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
