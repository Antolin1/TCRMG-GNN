one sig util'language {
	...
	util'root : one type'Vertex'class + (type'FinalState'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Region'class + (type'Entry'class + (type'Choice'class + (type'Statechart'class + (type'Pseudostate'class + (type'CompositeElement'class + type'State'class))))))))))))),
	util'contains : (type'Vertex'class + (type'FinalState'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Region'class + (type'Entry'class + (type'Choice'class + (type'Statechart'class + (type'Pseudostate'class + (type'CompositeElement'class + type'State'class)))))))))))))) lone->set (type'Vertex'class + (type'FinalState'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Region'class + (type'Entry'class + (type'Choice'class + (type'Statechart'class + (type'Pseudostate'class + (type'CompositeElement'class + type'State'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Vertex'class + (type'FinalState'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Region'class + (type'Entry'class + (type'Choice'class + (type'Statechart'class + (type'Pseudostate'class + (type'CompositeElement'class + type'State'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Vertex'class + (type'FinalState'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Region'class + (type'Entry'class + (type'Choice'class + (type'Statechart'class + (type'Pseudostate'class + (type'CompositeElement'class + type'State'class))))))))))))) { child = util'language.util'root or (some parent: type'Vertex'class + (type'FinalState'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Region'class + (type'Entry'class + (type'Choice'class + (type'Statechart'class + (type'Pseudostate'class + (type'CompositeElement'class + type'State'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Vertex'class + (type'FinalState'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Region'class + (type'Entry'class + (type'Choice'class + (type'Statechart'class + (type'Pseudostate'class + (type'CompositeElement'class + type'State'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
