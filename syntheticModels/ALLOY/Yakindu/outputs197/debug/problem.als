one sig util'language {
	...
	util'root : one type'Exit'class + (type'Transition'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Region'class + (type'FinalState'class + (type'Statechart'class + (type'Synchronization'class + (type'Vertex'class + (type'Entry'class + (type'RegularState'class + (type'State'class + type'Choice'class))))))))))))),
	util'contains : (type'Exit'class + (type'Transition'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Region'class + (type'FinalState'class + (type'Statechart'class + (type'Synchronization'class + (type'Vertex'class + (type'Entry'class + (type'RegularState'class + (type'State'class + type'Choice'class)))))))))))))) lone->set (type'Exit'class + (type'Transition'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Region'class + (type'FinalState'class + (type'Statechart'class + (type'Synchronization'class + (type'Vertex'class + (type'Entry'class + (type'RegularState'class + (type'State'class + type'Choice'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Exit'class + (type'Transition'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Region'class + (type'FinalState'class + (type'Statechart'class + (type'Synchronization'class + (type'Vertex'class + (type'Entry'class + (type'RegularState'class + (type'State'class + type'Choice'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Exit'class + (type'Transition'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Region'class + (type'FinalState'class + (type'Statechart'class + (type'Synchronization'class + (type'Vertex'class + (type'Entry'class + (type'RegularState'class + (type'State'class + type'Choice'class))))))))))))) { child = util'language.util'root || (some parent: type'Exit'class + (type'Transition'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Region'class + (type'FinalState'class + (type'Statechart'class + (type'Synchronization'class + (type'Vertex'class + (type'Entry'class + (type'RegularState'class + (type'State'class + type'Choice'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Exit'class + (type'Transition'class + (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Region'class + (type'FinalState'class + (type'Statechart'class + (type'Synchronization'class + (type'Vertex'class + (type'Entry'class + (type'RegularState'class + (type'State'class + type'Choice'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
