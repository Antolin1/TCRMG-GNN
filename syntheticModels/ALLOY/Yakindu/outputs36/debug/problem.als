one sig util'language {
	...
	util'root : one type'Choice'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Region'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Vertex'class + (type'FinalState'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Entry'class + type'Statechart'class))))))))))))),
	util'contains : (type'Choice'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Region'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Vertex'class + (type'FinalState'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Entry'class + type'Statechart'class)))))))))))))) lone->set (type'Choice'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Region'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Vertex'class + (type'FinalState'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Entry'class + type'Statechart'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Choice'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Region'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Vertex'class + (type'FinalState'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Entry'class + type'Statechart'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Choice'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Region'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Vertex'class + (type'FinalState'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Entry'class + type'Statechart'class))))))))))))) { child = util'language.util'root or (some parent: type'Choice'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Region'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Vertex'class + (type'FinalState'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Entry'class + type'Statechart'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Choice'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'Region'class + (type'Pseudostate'class + (type'Synchronization'class + (type'Vertex'class + (type'FinalState'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'Transition'class + (type'Entry'class + type'Statechart'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
