one sig util'language {
	...
	util'root : one type'RegularState'class + (type'State'class + (type'State'class + (type'Vertex'class + (type'Choice'class + (type'Entry'class + (type'Synchronization'class + (type'Exit'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Region'class + (type'Statechart'class + type'FinalState'class))))))))))))),
	util'contains : (type'RegularState'class + (type'State'class + (type'State'class + (type'Vertex'class + (type'Choice'class + (type'Entry'class + (type'Synchronization'class + (type'Exit'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Region'class + (type'Statechart'class + type'FinalState'class)))))))))))))) lone->set (type'RegularState'class + (type'State'class + (type'State'class + (type'Vertex'class + (type'Choice'class + (type'Entry'class + (type'Synchronization'class + (type'Exit'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Region'class + (type'Statechart'class + type'FinalState'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'RegularState'class + (type'State'class + (type'State'class + (type'Vertex'class + (type'Choice'class + (type'Entry'class + (type'Synchronization'class + (type'Exit'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Region'class + (type'Statechart'class + type'FinalState'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'RegularState'class + (type'State'class + (type'State'class + (type'Vertex'class + (type'Choice'class + (type'Entry'class + (type'Synchronization'class + (type'Exit'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Region'class + (type'Statechart'class + type'FinalState'class))))))))))))) { child = util'language.util'root || (some parent: type'RegularState'class + (type'State'class + (type'State'class + (type'Vertex'class + (type'Choice'class + (type'Entry'class + (type'Synchronization'class + (type'Exit'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Region'class + (type'Statechart'class + type'FinalState'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'RegularState'class + (type'State'class + (type'State'class + (type'Vertex'class + (type'Choice'class + (type'Entry'class + (type'Synchronization'class + (type'Exit'class + (type'Transition'class + (type'CompositeElement'class + (type'State'class + (type'Pseudostate'class + (type'Region'class + (type'Statechart'class + type'FinalState'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
