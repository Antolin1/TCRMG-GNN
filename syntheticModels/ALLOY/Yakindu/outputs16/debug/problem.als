one sig util'language {
	...
	util'root : one type'State'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Region'class + (type'Pseudostate'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Entry'class + type'Choice'class))))))))))))),
	util'contains : (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Region'class + (type'Pseudostate'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Entry'class + type'Choice'class)))))))))))))) lone->set (type'State'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Region'class + (type'Pseudostate'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Entry'class + type'Choice'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'State'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Region'class + (type'Pseudostate'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Entry'class + type'Choice'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'State'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Region'class + (type'Pseudostate'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Entry'class + type'Choice'class))))))))))))) { child = util'language.util'root || (some parent: type'State'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Region'class + (type'Pseudostate'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Entry'class + type'Choice'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'State'class + (type'CompositeElement'class + (type'State'class + (type'Exit'class + (type'Synchronization'class + (type'Region'class + (type'Pseudostate'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Statechart'class + (type'Entry'class + type'Choice'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
...
run { } for exactly 9 util'Object , 2 Int , exactly 0 String