one sig util'language {
	...
	util'root : one type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + (type'Exit'class + (type'State'class + (type'Statechart'class + type'Synchronization'class))))))))))))),
	util'contains : (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + (type'Exit'class + (type'State'class + (type'Statechart'class + type'Synchronization'class)))))))))))))) lone->set (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + (type'Exit'class + (type'State'class + (type'Statechart'class + type'Synchronization'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + (type'Exit'class + (type'State'class + (type'Statechart'class + type'Synchronization'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + (type'Exit'class + (type'State'class + (type'Statechart'class + type'Synchronization'class))))))))))))) { child = util'language.util'root || (some parent: type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + (type'Exit'class + (type'State'class + (type'Statechart'class + type'Synchronization'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'Pseudostate'class + (type'Choice'class + (type'FinalState'class + (type'Transition'class + (type'Region'class + (type'Exit'class + (type'State'class + (type'Statechart'class + type'Synchronization'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
