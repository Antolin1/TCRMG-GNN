one sig util'language {
	...
	util'root : one type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'Choice'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'Vertex'class + (type'Synchronization'class + type'Entry'class))))))))))))),
	util'contains : (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'Choice'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'Vertex'class + (type'Synchronization'class + type'Entry'class)))))))))))))) lone->set (type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'Choice'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'Vertex'class + (type'Synchronization'class + type'Entry'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'Choice'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'Vertex'class + (type'Synchronization'class + type'Entry'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'Choice'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'Vertex'class + (type'Synchronization'class + type'Entry'class))))))))))))) { child = util'language.util'root || (some parent: type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'Choice'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'Vertex'class + (type'Synchronization'class + type'Entry'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Pseudostate'class + (type'CompositeElement'class + (type'State'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Region'class + (type'Statechart'class + (type'Choice'class + (type'State'class + (type'Exit'class + (type'Transition'class + (type'Vertex'class + (type'Synchronization'class + type'Entry'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
