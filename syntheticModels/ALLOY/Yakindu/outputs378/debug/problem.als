one sig util'language {
	...
	util'root : one type'CompositeElement'class + (type'State'class + (type'Region'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Choice'class + (type'Entry'class + (type'FinalState'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + type'Statechart'class))))))))))))),
	util'contains : (type'CompositeElement'class + (type'State'class + (type'Region'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Choice'class + (type'Entry'class + (type'FinalState'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + type'Statechart'class)))))))))))))) lone->set (type'CompositeElement'class + (type'State'class + (type'Region'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Choice'class + (type'Entry'class + (type'FinalState'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + type'Statechart'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'CompositeElement'class + (type'State'class + (type'Region'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Choice'class + (type'Entry'class + (type'FinalState'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + type'Statechart'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'CompositeElement'class + (type'State'class + (type'Region'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Choice'class + (type'Entry'class + (type'FinalState'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + type'Statechart'class))))))))))))) { child = util'language.util'root or (some parent: type'CompositeElement'class + (type'State'class + (type'Region'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Choice'class + (type'Entry'class + (type'FinalState'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + type'Statechart'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'CompositeElement'class + (type'State'class + (type'Region'class + (type'Transition'class + (type'Vertex'class + (type'RegularState'class + (type'State'class + (type'State'class + (type'Choice'class + (type'Entry'class + (type'FinalState'class + (type'Exit'class + (type'Synchronization'class + (type'Pseudostate'class + type'Statechart'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
