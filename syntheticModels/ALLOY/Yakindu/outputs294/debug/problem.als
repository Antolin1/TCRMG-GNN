one sig util'language {
	...
	util'root : one type'Choice'class + (type'Synchronization'class + (type'Transition'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Vertex'class + (type'Pseudostate'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Region'class + type'State'class))))))))))))),
	util'contains : (type'Choice'class + (type'Synchronization'class + (type'Transition'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Vertex'class + (type'Pseudostate'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Region'class + type'State'class)))))))))))))) lone->set (type'Choice'class + (type'Synchronization'class + (type'Transition'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Vertex'class + (type'Pseudostate'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Region'class + type'State'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Choice'class + (type'Synchronization'class + (type'Transition'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Vertex'class + (type'Pseudostate'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Region'class + type'State'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Choice'class + (type'Synchronization'class + (type'Transition'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Vertex'class + (type'Pseudostate'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Region'class + type'State'class))))))))))))) { child = util'language.util'root or (some parent: type'Choice'class + (type'Synchronization'class + (type'Transition'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Vertex'class + (type'Pseudostate'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Region'class + type'State'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Choice'class + (type'Synchronization'class + (type'Transition'class + (type'Exit'class + (type'CompositeElement'class + (type'State'class + (type'FinalState'class + (type'Vertex'class + (type'Pseudostate'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'Entry'class + (type'Region'class + type'State'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
