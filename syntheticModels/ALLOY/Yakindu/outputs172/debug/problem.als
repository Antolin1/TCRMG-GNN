one sig util'language {
	...
	util'root : one type'Choice'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Region'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Synchronization'class + (type'Transition'class + (type'State'class + (type'Exit'class + type'Pseudostate'class))))))))))))),
	util'contains : (type'Choice'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Region'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Synchronization'class + (type'Transition'class + (type'State'class + (type'Exit'class + type'Pseudostate'class)))))))))))))) lone->set (type'Choice'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Region'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Synchronization'class + (type'Transition'class + (type'State'class + (type'Exit'class + type'Pseudostate'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Choice'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Region'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Synchronization'class + (type'Transition'class + (type'State'class + (type'Exit'class + type'Pseudostate'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Choice'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Region'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Synchronization'class + (type'Transition'class + (type'State'class + (type'Exit'class + type'Pseudostate'class))))))))))))) { child = util'language.util'root || (some parent: type'Choice'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Region'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Synchronization'class + (type'Transition'class + (type'State'class + (type'Exit'class + type'Pseudostate'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Choice'class + (type'Vertex'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'Region'class + (type'Statechart'class + (type'RegularState'class + (type'State'class + (type'FinalState'class + (type'Synchronization'class + (type'Transition'class + (type'State'class + (type'Exit'class + type'Pseudostate'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
