one sig util'language {
	...
	util'root : one type'Exit'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Synchronization'class + (type'Region'class + (type'FinalState'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'State'class + (type'Pseudostate'class + type'Transition'class))))))))))))),
	util'contains : (type'Exit'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Synchronization'class + (type'Region'class + (type'FinalState'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'State'class + (type'Pseudostate'class + type'Transition'class)))))))))))))) lone->set (type'Exit'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Synchronization'class + (type'Region'class + (type'FinalState'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'State'class + (type'Pseudostate'class + type'Transition'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Exit'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Synchronization'class + (type'Region'class + (type'FinalState'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'State'class + (type'Pseudostate'class + type'Transition'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Exit'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Synchronization'class + (type'Region'class + (type'FinalState'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'State'class + (type'Pseudostate'class + type'Transition'class))))))))))))) { child = util'language.util'root || (some parent: type'Exit'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Synchronization'class + (type'Region'class + (type'FinalState'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'State'class + (type'Pseudostate'class + type'Transition'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Exit'class + (type'Choice'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Synchronization'class + (type'Region'class + (type'FinalState'class + (type'Statechart'class + (type'CompositeElement'class + (type'State'class + (type'Entry'class + (type'State'class + (type'Pseudostate'class + type'Transition'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
