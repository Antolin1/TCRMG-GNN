one sig util'language {
	...
	util'root : one type'Synchronization'class + (type'Transition'class + (type'State'class + (type'Region'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Exit'class + (type'Pseudostate'class + type'FinalState'class))))))))))))),
	util'contains : (type'Synchronization'class + (type'Transition'class + (type'State'class + (type'Region'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Exit'class + (type'Pseudostate'class + type'FinalState'class)))))))))))))) lone->set (type'Synchronization'class + (type'Transition'class + (type'State'class + (type'Region'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Exit'class + (type'Pseudostate'class + type'FinalState'class))))))))))))))
}
...
fact util'noParentForRoot {
	no parent: type'Synchronization'class + (type'Transition'class + (type'State'class + (type'Region'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Exit'class + (type'Pseudostate'class + type'FinalState'class))))))))))))) { parent->(util'language.util'root) in util'language.util'contains }
}
fact util'atLeastOneParent {
	all child: type'Synchronization'class + (type'Transition'class + (type'State'class + (type'Region'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Exit'class + (type'Pseudostate'class + type'FinalState'class))))))))))))) { child = util'language.util'root or (some parent: type'Synchronization'class + (type'Transition'class + (type'State'class + (type'Region'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Exit'class + (type'Pseudostate'class + type'FinalState'class))))))))))))) { parent->child in util'language.util'contains }) }
}
fact util'noCircularContainment {
	no circle: type'Synchronization'class + (type'Transition'class + (type'State'class + (type'Region'class + (type'Choice'class + (type'CompositeElement'class + (type'State'class + (type'Statechart'class + (type'Entry'class + (type'RegularState'class + (type'State'class + (type'Vertex'class + (type'Exit'class + (type'Pseudostate'class + type'FinalState'class))))))))))))) { circle->circle in ^ (util'language.util'contains) }
}
